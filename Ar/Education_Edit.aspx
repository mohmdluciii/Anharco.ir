<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Education_Edit.aspx.vb" Inherits="W_ISM.Education_Edit" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
       <div class="titleForm"><a href="#">مدیریت همکار</a><i class="fa fa-chevron-left arrow"></i><a href="#">آموزش</a><i class="fa fa-chevron-left arrow"></i><a>ویرایش</a></div>
            ...
            <div class="containerForm">
                ...
                <div class="DeleteBoxContainer" id="DeleteBoxContainer" onclick="closeDeleteDialog();">
                    <div class ="DeleteBox" id="DeleteBox">
                       <iframe src="Education_Delete.aspx?RowID_Education=<%=request.QueryString("RowID_Education") %>" frameborder="0"></iframe>
                    </div>
                </div>
                <div class="InterBoxFormLeft">
                    <ul>
                        <li>
                            <a class ="LinkIcon" href="Education_List.aspx?f1=<%=request.QueryString("f1") %>"><i class="fa  fa-pencil"></i></a>
                            <ul>
                ...
                <div class="InterBoxFormRight" >
                    ...
                    <div class="bodyForm">
                       ...
                       <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption">گروه&nbsp; *<asp:Label id="lblGroupEducation" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_GroupEducation"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">گروه قواعد و مقرراتی است که قواعد و مقررات جدید در آن قرار دارد.</div></li></ul></a></li>
                                    <li><asp:DropDownList  id="cmb_GroupEducation" tabindex="1" runat ="server"  onfocus="GraphicalBorder('container_GroupEducation');" onblur="GraphicalBorderRemove('container_GroupEducation');"></asp:DropDownList></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption">عنوان &nbsp; *<asp:Label id="lbltitle_Education" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_title_Education"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">نام قانون و مقررات است که باید منحصر باشد</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="2"  onfocus="GraphicalBorder('container_title_Education');" onblur="GraphicalBorderRemove('container_title_Education');" ID="title_Education" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        
                     <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption">خلاصه&nbsp; *<asp:Label id="lblshort_Education" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_short_Service"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">خلاصه ای از قواعد و مقررات است که قصد تعریف آنرا دارید</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="2"  onfocus="GraphicalBorder('container_short_Education');" onblur="GraphicalBorderRemove('container_short_Education');" ID="short_Education" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
