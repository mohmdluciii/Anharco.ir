<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Certificates.aspx.vb" Inherits="Safe_Certificates1" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" lang="ar" dir="rtl">
<head id="Head1" runat="server">
    <title>شهادات الصلاحیة </title>
      <link href="graphic/BodyGraphic.css?v=cropFrame1" rel="stylesheet" />
    ...
    <script src="scrollMainPage/js/scroll_herbs.js?v=certFix2"></script>
     ...
     <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" TargetControlID="txt_Search" ServiceMethod="Buscar" ServicePath="AutoCompletar.asmx" MinimumPrefixLength="2" CompletionInterval="1000" EnableCaching="true" CompletionSetCount="12"   CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"></asp:AutoCompleteExtender>  
        ...
        <div class ="backMobileMenu" id="mobileMenu4"  style ="display:none;">
           ...
           <div class ="mainScreenLayer">    
            ...
            <div class ="MessageCEO_SlideContainer" style="<%=SiteStudioStore.BgStyle("hero_Certificates")%>">
            ...
            <div class ="MessageCEO_HeaderTextContainer"><h1 class="<%=SiteStudioStore.AlignClass("copy_Certificates_h1")%>"><%=SiteStudioStore.Copy("copy_Certificates_h1", "شهادات الصلاحیة")%></h1> </div>
            <div class ="MessageCEO_topTextContainer">
                <p>
                    حصلت شركة أنهار الإنشائية خلال سنوات متواصلة من العمل الدؤوب علی شهادة صلاحیة تنفیذ أعمال المقاولة من مؤسسة التخطیط والمیزانیة الوطنیة في المجالات التالیة :
               
                </p>
                <p style="text-align :right;font-size :16pt;font-weight:700;">
                    <i class ="fa fa-arrow-left" style="font-size :16pt;"></i>
                    (الدرجة الأولی) في حقل النفط والغاز والبتروكيماويات والبناء 
                </p>
                <p style="text-align :right;font-size :16pt;font-weight:700;">
                    <i class ="fa fa-arrow-left" style="font-size :16pt;"></i>
                    (الدرجة الثالثة) في حقل الأجهزة والمنشآت  
                </p>
                
                <p style="text-align :right;font-size :16pt;font-weight:700;">
                    <i class ="fa fa-arrow-left" style="font-size :16pt;"></i>
                    (الدرجة الرابعة) في حقل المیاه 
                </p>
                
                <p style="text-align :right;font-size :16pt;font-weight:700;">
                    <i class ="fa fa-arrow-left" style="font-size :16pt;"></i>
                    (الدرجة الخامسة) في حقل الطرق والمواصلات والصناعة والمناجم 
                </p>
                <p style="text-align :right;">کما حازت علی شهادة تأهیل السلامة والأمان للمقاولین من قبل وزارة التعاون والعمل والرفاة الإجتماعي .</p>
                <p style="text-align :right;">بالإضافة الی ذلك ، حصلت الشرکة علی بعض الشهادات الدولیة وعلی النحو التالي :</p>
                <p style="text-align :right;">ـ شهادة نظام الإدارة المتکامل IMS من قبل شرکة SGS الدولیة </p>
                <p style="text-align :right;">ـ شهادة تحسین إدارة لحام خطوط الأنابیب ISO3834-2:2021</p>
                <p style="text-align :right;">وتنتمي شركة أنهار الإنشائية لعضویة إتحاد الشرکات الهندسیة والمقاولات العاملة في حقل النفط والغاز والبتروکیمیاویات APEC بسبب مشارکته المتمیزة والنشیطة والمستمرة في تنفیذ العدید من مشاریع النفط والغاز والبتروکیمیاویات منذ عام 2004 حتی الآن .
کما تنتمي الشرکة لعضویة غرفة التجارة والصناعة والمناجم والزراعة فرع طهران .
</p>
            </div>
            ...
            <div class ="MessageCEO_Box5Container certGalleryWrap">
                    <div class ="Certificates_Container">
                        <section class="certSlider slider" dir="ltr">
                            <%=Session("initCertificates") %>
                        </section> 
                    </div>
            </div>
...
<script src="https://code.jquery.com/jquery-2.2.0.min.js" type="text/javascript"></script>
  ...
  <script src="JS/cert-slider.js?v=certView1" type="text/javascript"></script>
  <script type="text/javascript">
    $(document).on('ready', function() {
