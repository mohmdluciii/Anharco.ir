...
<head id="Head1" runat="server">
    <title>اعضای . أعضاء مجلس إدارة الشرکة شركة أنهار الإنشائية </title>
     ...
     <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" TargetControlID="txt_Search" ServiceMethod="Buscar" ServicePath="AutoCompletar.asmx" MinimumPrefixLength="2" CompletionInterval="1000" EnableCaching="true" CompletionSetCount="12"   CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"></asp:AutoCompleteExtender>  
        ...
        <div class ="backMobileMenu" id="mobileMenu4"  style ="display:none;">
           ...
           <div class ="mainScreenLayer">    
            ...
            <div class ="MessageCEO_HeaderTextContainer"><h1 class="<%=SiteStudioStore.AlignClass("copy_leadership_h1")%>"><%=SiteStudioStore.Copy("copy_leadership_h1", "اعضاء مجلس إدارة الشرکة")%></h1> </div>
            <div class ="leadershipMainpage">
               ...
               <div class="swiper-slide">
                    ...
                    <div class ="boxText">
                        <p class="leadName <%=SiteStudioStore.AlignClass("copy_leadership_1_name")%>"><%=SiteStudioStore.Copy("copy_leadership_1_name", "مسعود معظمي")%></p>
                        <p class="leadRole <%=SiteStudioStore.AlignClass("copy_leadership_1_role")%>"><%=SiteStudioStore.Copy("copy_leadership_1_role", "الهندسة المدنية والتاريخ")%></p>
                    </div>
                    </div>
               </div>
               <div class="swiper-slide">
                    ...
                    <div class ="boxText">
                        <p class="leadName <%=SiteStudioStore.AlignClass("copy_leadership_2_name")%>"><%=SiteStudioStore.Copy("copy_leadership_2_name", "ستار عزیزیان تفتي")%></p>
                        <p class="leadRole <%=SiteStudioStore.AlignClass("copy_leadership_2_role")%>"><%=SiteStudioStore.Copy("copy_leadership_2_role", "هندسة المواد")%></p>
                    </div>
                    </div>
               </div>
               <div class="swiper-slide">
                    ...
                    <div class ="boxText">
                        <p class="leadName <%=SiteStudioStore.AlignClass("copy_leadership_3_name")%>"><%=SiteStudioStore.Copy("copy_leadership_3_name", "أکبر إشراقي")%></p>
                        <p class="leadRole <%=SiteStudioStore.AlignClass("copy_leadership_3_role")%>"><%=SiteStudioStore.Copy("copy_leadership_3_role", "المحاسبة والإدارة المالية")%></p>
                    </div>
                    </div>
               </div>
               <div class="swiper-slide">
                    ...
                    <div class ="boxText">
                        <p class="leadName <%=SiteStudioStore.AlignClass("copy_leadership_4_name")%>"><%=SiteStudioStore.Copy("copy_leadership_4_name", "مجتبی معظمي")%></p>
                        <p class="leadRole <%=SiteStudioStore.AlignClass("copy_leadership_4_role")%>"><%=SiteStudioStore.Copy("copy_leadership_4_role", "الفيزياء وMBA")%></p>
                    </div>
                    </div>
               </div>
               <div class="swiper-slide">
                    ...
                    <div class ="boxText">
                        <p class="leadName <%=SiteStudioStore.AlignClass("copy_leadership_5_name")%>"><%=SiteStudioStore.Copy("copy_leadership_5_name", "نکار معظمي")%></p>
                        <p class="leadRole <%=SiteStudioStore.AlignClass("copy_leadership_5_role")%>"><%=SiteStudioStore.Copy("copy_leadership_5_role", "الهندسة المدنية/هندسة الإنشاءات")%></p>
                    </div>
                    </div>
               </div>
               <div class="swiper-slide">
                    ...
                    <div class ="boxText">
                        <p class="leadName <%=SiteStudioStore.AlignClass("copy_leadership_6_name")%>"><%=SiteStudioStore.Copy("copy_leadership_6_name", "مهدیار شریف")%></p>
                        <p class="leadRole <%=SiteStudioStore.AlignClass("copy_leadership_6_role")%>"><%=SiteStudioStore.Copy("copy_leadership_6_role", "الهندسة المدنية")%></p>
                    </div>
                    </div>
               </div>
               </div>
