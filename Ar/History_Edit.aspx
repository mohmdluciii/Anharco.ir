<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="History_Edit.aspx.vb" Inherits="W_ISM.History_Edit" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><a href="#">درباره ما</a><i class="fa fa-chevron-left arrow"></i><a href="#">تاریخچه</a><i class="fa fa-chevron-left arrow"></i><a>ویرایش</a></div>
        ...
        <div class="formBox">
            ...
            <div class="containerForm">
                ...
                <div class="DeleteBoxContainer" id="DeleteBoxContainer" onclick="closeDeleteDialog();">
                    <div class ="DeleteBox" id="DeleteBox">
                       <iframe src="History_Delete.aspx?rowID_History=<%=request.QueryString("rowID_History") %>" frameborder="0"></iframe>
                    </div>
                </div>
                ...
                <div class="InterBoxFormLeft">
                    <ul>
                        <li>
                            <a class ="LinkIcon" href="History_List.aspx"><i class="fa  fa-pencil"></i></a>
                            <ul>
                ...
                <div class="InterBoxFormRight" >
                    ...
                    <div class="bodyForm">
                       <div class ="ContainerTextBoxObject">       
                            <div class="ContainerTextBoxCaption">سال&nbsp;* <asp:Label id="lblyear_History" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_year_History"></div>
                                <ul class="ContainerQuotation" >
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">سالی که رویداد در آن رخ داده است با 13 درج شود</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="1"    onfocus="GraphicalBorder('container_year_History');" onblur="GraphicalBorderRemove('container_year_History');" ID="year_History"  onkeydown="checkValue()" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        <div class ="ContainerTextBoxObject">       
                            <div class="ContainerTextBoxCaption">عنوان&nbsp;* <asp:Label id="lbltitle_History" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle" style="height:88px">
                                <div class="effectContainerDiv"  id="container_title_History"></div>
                                <ul class="ContainerQuotation" >
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">عنوان رویداد تاریخچه می باشد</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="1" style="height:80px" TextMode ="MultiLine"  onfocus="GraphicalBorder('container_title_History');" onblur="GraphicalBorderRemove('container_title_History');" ID="title_History" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        <div class ="ContainerTextBoxObject" style="width :100%;">
                            <div class="ContainerTextBoxCaption"><asp:Label id="lbltext_HistoryIT" runat ="server"  class="errStyle" ></asp:Label></div>
                        ...
                        <div class ="ContainerTextBoxObject" >
                            <div class="ContainerTextBoxCaption">تصویر  &nbsp;  <asp:Label id="lblPic_History" runat ="server"  class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_pic_HistoryIT"></div>
                                <ul class="ContainerQuotation">
            ...
            <div class="containerForm_Left">
                <asp:Image ID="img_pic_History" runat="server" Style="position: relative; top: 0px;left: 0px; width: 100%;" BorderStyle="Groove" BorderWidth="2px" />
            </div>
        </div>
...
<script  type ="text/javascript" >
    document.getElementById("pic_History").onchange = function() {
