...
<head id="Head1" runat="server">
    <title>خط مشی سازمان - شركة أنهار الإنشائية </title>
     ...
     <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" TargetControlID="txt_Search" ServiceMethod="Buscar" ServicePath="AutoCompletar.asmx" MinimumPrefixLength="2" CompletionInterval="1000" EnableCaching="true" CompletionSetCount="12"   CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"></asp:AutoCompleteExtender>  
        ...
        <div class ="backMobileMenu" id="mobileMenu4"  style ="display:none;">
           ...
           <div class ="mainScreenLayer">    
            ...
            <div class ="MessageCEO_HeaderTextContainer"><h1 class="<%=SiteStudioStore.AlignClass("copy_OrganizationPolicy_h1")%>"><%=SiteStudioStore.Copy("copy_OrganizationPolicy_h1", "سیاسات الشرکة")%></h1> </div>
            <div class ="MessageCEO_topTextContainer">
                <p>
                    سياسة الشرکة هي وثيقة استراتيجية يتم تحديدها والموافقة عليها من قبل الإدارة العليا للشركة ، إن سياسة الجودة التي ترمي الی تحقیقها الشرکة ترتبط إرتباطاً وثیقاً مع إلتزامات الجودة والمتطلبات المطابقة لمعاییر الجودة والتحسين المستمر لعملیة الإنتاج ، والتي تتماشى مع رؤية الشركة ورسالتها وتوفر إطاراً لتحديد أهداف الجودة . تلتزم الشرکة برعایة الصحة السلامة وحمایة البيئة أيضاً عبر الامتثال بالمتطلبات القانونية، ومنع تلوث الهواء، والقضاء على المخاطر، وتقليل مخاطر الصحة والسلامة وحمایة البیئة ، بالإضافة الی التحسين المستمر ومشاركة العمال في تطبیق الأهداف الرئیسیة للشرکة من أجل تحدید الأهداف المتعلقة بالصحة والسلامة وحمایة البیئة .
