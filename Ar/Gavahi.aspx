<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Gavahi.aspx.vb" Inherits="W_ISM.Gavahi" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><i class="fa fa-address-book  icon"></i><a href="#"> گواهی اشتغال</a><i class="fa fa-chevron-left arrow"></i><a href="#">درخواست صدور گواهی اشتغال بکار</a><i class="fa fa-chevron-left arrow"></i><a>درج</a></div>
                ...
                <div class="InterBoxFormRight" >
                    ...
                    <div class="bodyForm">
                        <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption"> نوع گواهی&nbsp; *<asp:Label id="lblRowID_TypeGavahi" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_TypeGavahi"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">نوع گواهی است که قصد درخواست صدور آنرا دارید.</div></li></ul></a></li>
                                    <li><asp:DropDownList  id="cmb_TypeGavahi" tabindex="1" runat ="server"  onfocus="GraphicalBorder('container_TypeGavahi');" onblur="GraphicalBorderRemove('container_TypeGavahi');"></asp:DropDownList></li>
                                </ul>
                            </div>
                        </div>
                    
                        <div class ="ContainerTextBoxObject">       
                            <div class="ContainerTextBoxCaption"> منطقه&nbsp;* <asp:Label id="lblmodiriat_Gavahi" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle" >
                                <div class="effectContainerDiv"  id="container_modiriat_Gavahi"></div>
                                <ul class="ContainerQuotation" >
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">در کدام مدیریت شاغل هستید را درج نمائید</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="1"  onfocus="GraphicalBorder('container_modiriat_Gavahi');" onblur="GraphicalBorderRemove('container_modiriat_Gavahi');" ID="modiriat_Gavahi" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        <div class ="ContainerTextBoxObject">       
                            <div class="ContainerTextBoxCaption">واحد&nbsp;* <asp:Label id="lblshobe_Gavahi" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle" >
                                <div class="effectContainerDiv"  id="container_shobe_Gavahi"></div>
                                <ul class="ContainerQuotation" >
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">شعبه ای است که در آن شاغل هستید</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="1"  onfocus="GraphicalBorder('container_shobe_Gavahi');" onblur="GraphicalBorderRemove('container_shobe_Gavahi');" ID="shobe_Gavahi" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        <div class ="ContainerTextBoxObject">       
                            <div class="ContainerTextBoxCaption">جهت ارائه&nbsp;* <asp:Label id="lbleraeh_Gavahi" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle" >
                                <div class="effectContainerDiv"  id="container_eraeh_Gavahi"></div>
                                <ul class="ContainerQuotation" >
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">جهت ارائه به کدام سازمان قصد دارید گواهی صادر شود را درج کنید</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="1"  onfocus="GraphicalBorder('container_eraeh_Gavahi');" onblur="GraphicalBorderRemove('container_eraeh_Gavahi');" ID="eraeh_Gavahi" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
