<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="User_SelectGroupService.aspx.vb" Inherits="W_ISM.User_SelectGroupService" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><i class="fa fa-address-book  icon"></i><a href="#"> درخواست تعمیر و نگهداری</a><i class="fa fa-chevron-left arrow"></i><a href="#">انتخاب گروه سرویس</a><i class="fa fa-chevron-left arrow"></i><a>ثبت</a></div>
                ...
                <div class="InterBoxFormRight" >
                    ...
                    <div class="bodyForm">
                        <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption">سرویس درخواستی&nbsp; *<asp:Label id="lblGroupService" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_GroupService"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">سرویسی است که قصد دارید درخواست را در مورد آن ارسال فرمائید</div></li></ul></a></li>
