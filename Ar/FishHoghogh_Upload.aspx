<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FishHoghogh_Upload.aspx.vb" Inherits="W_ISM.FishHoghogh_Upload" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><a href="#">عملیات پایه</a><i class="fa fa-chevron-left arrow"></i><a href="#">ارسال فایل فیش های حقوقی</a><i class="fa fa-chevron-left arrow"></i><a>درج</a></div>
                ...
                <div class="InterBoxFormRight" >
                    ...
                    <div class="bodyForm">
                        ...
                        <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption">فیش حقوقی افتتاح شده&nbsp; *<asp:Label id="lblOpenHoghogh" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_OpenHoghogh"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">انتخاب فیش حقوقی که قصد ارسال فایل های آنرا دارید.</div></li></ul></a></li>
                                    <li><asp:DropDownList  id="cmb_OpenHoghogh" tabindex="1" runat ="server"  onfocus="GraphicalBorder('container_OpenHoghogh');" onblur="GraphicalBorderRemove('container_OpenHoghogh');"></asp:DropDownList></li>
                                </ul>
                            </div>
                        </div>
                    
                         <div class ="ContainerTextBoxObject" >
                            <div class="ContainerTextBoxCaption">انتخاب فایل  &nbsp;  *<asp:Label id="lblFileUpload1" runat ="server"  class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_FileUpload1"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">فایل اکسل که در صورت وجود باید از هارد کامپیوتر انتخاب شود</div></li></ul></a></li>
                       ...
                       <div class ="ContainerTextBoxObject" style="width :100%;">
                        ...
                        <div class="containerButton">
                            <asp:Button ID="btnNewForm" OnClientClick="StartProgressBar()"  runat ="server" Text ="جدید" />&nbsp;<asp:Button ID="btnSaveForm" OnClientClick="StartProgressBar();"  runat ="server" Text ="ارسال فایل" />
                        </div>
