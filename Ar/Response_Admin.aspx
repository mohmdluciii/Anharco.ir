<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Response_Admin.aspx.vb" Inherits="W_ISM.Response_Admin" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><a href="#">مدیریت پیام</a><i class="fa fa-chevron-left arrow"></i><i class="fa fa-comment-o icon"></i><a href="#">ارسال پاسخ پیام</a><i class="fa fa-chevron-left arrow"></i><a><asp:Label ID="lblMarketer" runat ="server" ></asp:Label> </a></div>
            ...
            <div class="containerForm">
                <div class="SaveBoxContainer" id="saveContainer">
                    <div class ="SaveBox" id="saveDialog">
                        ...
                        <input type="button" value="تایید" onclick="location.href='Message_ListAdmin.aspx'" /> 
                    </div>
                </div>
                ...
                <div class="InterBoxFormRight" >
                    ...
                    <div class="bodyForm">
                        ...
                        <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption">عنوان&nbsp; *<asp:Label id="lbltitle_Response" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_Name_Ostan"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">عنوان پاسخ پیام را درج نمائید</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="1"  onfocus="GraphicalBorder('container_title_Response');" onblur="GraphicalBorderRemove('container_title_Response');" ID="title_Response" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        
                        <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption">پاسخ&nbsp; *<asp:Label id="lbltext_Response" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle" style ="height:88px;">
                                <div class="effectContainerDiv"  id="container_text_Response"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">متن پاسخ پیام را درج نمائید</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="1"  onfocus="GraphicalBorder('container_text_Response');" onblur="GraphicalBorderRemove('container_text_Response');" ID="text_Response" AutoComplete="off" runat ="server"  TextMode ="MultiLine" Height="80px"   ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
