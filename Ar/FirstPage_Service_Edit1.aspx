<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FirstPage_Service_Edit1.aspx.vb" Inherits="W_ISM.FirstPage_Service_Edit1" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><a href="#">تنظیمات صفحه اول</a><i class="fa fa-chevron-left arrow"></i><a href="#">خدمات</a><i class="fa fa-chevron-left arrow"></i><a>ویرایش</a></div>
            ...
            <div class="containerForm">
                ...
                <div class="DeleteBoxContainer" id="DeleteBoxContainer" onclick="closeDeleteDialog();">
                    <div class ="DeleteBox" id="DeleteBox">
                       <iframe src="FirstPage_Service_Delete1.aspx?rowID_FirstPage_Service=<%=request.QueryString("rowID_FirstPage_Service") %>" frameborder="0"></iframe>
                    </div>
                </div>
                <div class="InterBoxFormLeft">
                    <ul>
                        <li>
                            <a class ="LinkIcon" href="FirstPage_Service_List1.aspx"><i class="fa  fa-pencil"></i></a>
                            <ul>
