<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TopMenu_Frm.aspx.vb" Inherits="W_ISM.TopMenu_Frm" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><a href="#">راه اندازی سامانه</a><i class="fa fa-chevron-left arrow"></i><a href="#">مدیریت منو</a><i class="fa fa-chevron-left arrow"></i><a>درج</a></div>
        ...
        <div class="formBox">
            ...
            <div class="containerForm">
                ...
                <div class="InterBoxFormLeft">
                    <ul>
                        <li>
                            <a class ="LinkIcon" href="TopMenu_List.aspx"><i class="fa  fa-pencil"></i></a>
                            <ul>
                    ...
                    <ul>
                        <li>
                            <a class ="LinkIcon" href="TopMenu_List.aspx"><i class="fa  fa-trash"></i></a>
                            <ul>
                ...
                <div class="InterBoxFormRight" >
                    ...
                    <div class="bodyForm">
                        ...
                        <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption">نام &nbsp; *<asp:Label id="lblname_TopMenu" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle" >
                                <div class="effectContainerDiv"  id="container_name_TopMenu"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">نام منو اصلی است</div></li></ul></a></li>
                                    <li> <asp:TextBox   tabindex="1"  onfocus="GraphicalBorder('container_name_TopMenu');" onblur="GraphicalBorderRemove('container_name_TopMenu');" ID="name_TopMenu" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        
                        <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption">کد &nbsp; *<asp:Label id="lblcode_TopMenu" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle" >
                                <div class="effectContainerDiv"  id="container_code_TopMenu"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">کد منو اصلی است که ترتیب نمایش منو را نمایش می دهد</div></li></ul></a></li>
                                    <li> <asp:TextBox   tabindex="1"  onfocus="GraphicalBorder('container_code_TopMenu');" onblur="GraphicalBorderRemove('container_code_TopMenu');" ID="code_TopMenu" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption">منبع &nbsp; <asp:Label id="lblsource_TopMenu" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle" >
                                <div class="effectContainerDiv"  id="container_source_TopMenu"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">کد منو اصلی است که ترتیب نمایش منو را نمایش می دهد</div></li></ul></a></li>
                                    <li><asp:DropDownList  tabindex="1"  onfocus="GraphicalBorder('container_source_TopMenu');" onblur="GraphicalBorderRemove('container_source_TopMenu');" ID="cmb_source_TopMenu"  runat ="server"  ></asp:DropDownList></li>
                                </ul>
                            </div>
                        </div>
                        <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption">عنوان &nbsp; *<asp:Label id="lblTitle_TopMenu" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle" >
                                <div class="container_Title_TopMenu"  id="container_Title_TopMenu"></div>
                                <ul class="ContainerQuotation">
                                    ...
                                    <li> <asp:TextBox   tabindex="1"  onfocus="GraphicalBorder('container_Title_TopMenu');" onblur="GraphicalBorderRemove('container_Title_TopMenu');" ID="Title_TopMenu" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        
                        <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption"> متاتگ کلمات کلیدی &nbsp; <asp:Label id="lblkeyword_TopMenu" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle"  style="height:108px" >
                                <div class="effectContainerDiv"  id="container_keyword_TopMenu"></div>
                                <ul class="ContainerQuotation">
                                    ...
                                    <li> <asp:TextBox   tabindex="1" style="height:100px" TextMode ="MultiLine"  onfocus="GraphicalBorder('container_keyword_TopMenu');" onblur="GraphicalBorderRemove('container_keyword_TopMenu');" ID="keyword_TopMenu" AutoComplete="off" runat ="server"   MaxLength="256"  ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption"> &nbsp;متاتگ توصیفات <asp:Label id="lbldescription_TopMenu" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle" style="height:108px" >
                                <div class="effectContainerDiv"  id="container_description_TopMenu"></div>
                                <ul class="ContainerQuotation">
                                    ...
                                    <li> <asp:TextBox   tabindex="1" style="height:100px"   TextMode ="MultiLine"   onfocus="GraphicalBorder('container_description_TopMenu');" onblur="GraphicalBorderRemove('container_description_TopMenu');" ID="description_TopMenu" AutoComplete="off" runat ="server"  MaxLength="256"  ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption"><asp:CheckBox ID="chk_status_topMenu" runat ="server" Text ="غیر فعال" /></div>
                        </div>
                        
                         <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption"><asp:RadioButtonList ID="opt_sp_topMenu" runat ="server"  ><asp:ListItem Text ="قوانین و مقررات"  Value ="1"></asp:ListItem><asp:ListItem Text ="گالری" value="2"></asp:ListItem><asp:ListItem Text ="خدمات" value="3"></asp:ListItem></asp:RadioButtonList></div>
                        </div>
            ...
            <div class="containerForm_Left"><iframe src="Calender.aspx" style ="position:relative ;top:0px;left:0px;width :100%;min-height:250px" frameborder ="0" scrolling ="no" ></iframe>
