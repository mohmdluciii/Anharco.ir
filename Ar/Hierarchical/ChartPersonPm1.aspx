<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ChartPersonPm1.aspx.vb" Inherits="W_ISM.ChartPersonPm1" %>
    ...
    <div class="memberPanel_TopBox" id="test">
        ...
        <div class="memberPanel_Logout" >
            ...
            <%If Session("numberBox") = 0 Then%>
                <div class="memberPanel_ContanerLogin" ><a href="#" style="height:60px;width :60px;"><i class="fa fa-bell-o memberPanel_LogOut_Icon"></i></a> </div>
            <%Else%>
                <div class="memberPanel_ContanerLogin" ><a href="#"  style="height:60px;width :60px;"><i class="fa fa-bell-o memberPanel_LogOut_Icon"></i></a><div class="boxMeessageAlert"><p><%=Session("numberBox")%></p></div> </div>
            <%End If%>
        ...
        <div class="titleForm"><a href="#">درباره ما</a><i class="fa fa-chevron-left arrow"></i><a href="#">چارت سازمانی</a><i class="fa fa-chevron-left arrow"></i><a>لیست</a></div>
    ...
    <div class="formBox" >    
            ...
            <div class="containerForm" style ="width :100%;">
                ...
                <div class="InterBoxFormLeft">
                    ...
                    <ul>
                        <li>
                            <a class ="LinkIcon" href="../PersonPM_frm1.aspx?new=1"><i class="fa  fa-pencil"></i></a>
                            <ul>
                                <li><a  class="bubbleLink" >ایجاد</a></li>
                            </ul>
                        </li>
                    </ul>
