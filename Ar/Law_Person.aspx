<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Law_Person.aspx.vb" Inherits="W_ISM.Law_Person" %>
            ...
            <div class="containerForm"  style ="width:100%;">
                ...
                <div class="InterBoxFormRight" >
                    <div class="headForm_List" >
                       <a class="ExcelIcon" href="showExcel.aspx?page=Law_Person" target="_blank" title ="خروجی اکسل"><i class="fa fa-file-excel-o"></i></a>
                    </div>
                    
                    <div class="bodyForm">
                        <p style="position :relative ;top:0px;left:0px;width :100%;float:right ;direction:rtl;font-size:10pt;font-family:yekan,arial;text-align :right;padding-right :20px;">گروه قوانین &nbsp;<asp:DropDownList class="Combo_InList" runat ="server" dir="rtl" ID="cmb_LawGroup" width="200" AutoPostBack="True"></asp:DropDownList></p>
