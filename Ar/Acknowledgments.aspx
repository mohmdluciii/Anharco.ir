...
<head id="Head1" runat="server">
    <title>خطابات الشکر والتقدیر شركة أنهار الإنشائية </title>
     ...
     <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" TargetControlID="txt_Search" ServiceMethod="Buscar" ServicePath="AutoCompletar.asmx" MinimumPrefixLength="2" CompletionInterval="1000" EnableCaching="true" CompletionSetCount="12"   CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"></asp:AutoCompleteExtender>  
        ...
        <div class ="backMobileMenu" id="mobileMenu4"  style ="display:none;">
           ...
           <div class ="mainScreenLayer">    
            ...
            <div class ="MessageCEO_HeaderTextContainer"><h1 class="<%=SiteStudioStore.AlignClass("copy_Acknowledgments_h1")%>"><%=SiteStudioStore.Copy("copy_Acknowledgments_h1", "خطابات الشکر والتقدیر")%></h1> </div>
            <div class ="MessageCEO_topTextContainer">
                <p class="<%=SiteStudioStore.AlignClass("copy_Acknowledgments_p1")%>"><%=SiteStudioStore.Copy("copy_Acknowledgments_p1", "حصلت شركة أنهار الإنشائية علی عدد من خطابات الشکر والتقدیر بسبب نشاطاتها القدیرة في تنفیذ المشاریع الإنشائیة وفي مجال الإعمار والبناء وکذلك في حقل النفط والغاز والبتروکیمیاویات نذکر بعض منها علی سبیل المثال ولیس للحصر :")%></p>
            </div>
