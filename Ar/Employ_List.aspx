<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Employ_List.aspx.vb" Inherits="W_ISM.Employ_List" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm">درخواست ها</a><i class="fa fa-chevron-left arrow"></i><a href="#">استخدامی</a><i class="fa fa-chevron-left arrow"></i><a>لیست</a></div>
            ...
            <div class="containerForm" style="width:100%;">
                ...
                <div class="SaveBoxContainer" id="saveContainer">
                    <div class ="SaveBox" id="saveDialog" style="top:5%">
                        ...
                        <input type="button" value="تایید" onclick="window.open('Employ_List.aspx','_top');" /> 
                    </div>
                  </div>
                    <div class="headForm_List" >
                       <a class="ExcelIcon" href="showExcel.aspx?page=Employ_List" target="_blank" title ="خروجی اکسل"><i class="fa fa-file-excel-o"></i></a>
                    </div>
                    <div class="headForm_List" style ="font-size :10pt;" >
                        <p style="padding :0; padding-right :20px;width:90%;position:relative ;top:0px;margin :0;height:60px;">از تاریخ : <asp:TextBox ID="sDate" AutoComplete="off" runat ="server"   width="80" ></asp:TextBox> تا <asp:TextBox ID="eDate"  AutoComplete="off" width="80" runat ="server"  ></asp:TextBox></p>
                        <p style="padding :0;padding-right :20px;width:90%;position:relative ;top:0px;margin :0;height:60px;">جنسیت : <asp:RadioButtonList RepeatLayout="Flow"    RepeatDirection ="Horizontal"  ID="opt_sex_Employ" runat ="server"  ><asp:ListItem Text="مرد" Value="1"></asp:ListItem><asp:ListItem Text="زن" Value="2"></asp:ListItem></asp:RadioButtonList></p>
                        <p style="padding :0;padding-right :20px;width:90%;position:relative ;top:0px;margin :0;height:60px;">وضعیت تاهل : <asp:RadioButtonList RepeatLayout="Flow"  RepeatDirection ="Horizontal"  ID="opt_tahol_Employ" runat ="server"  ><asp:ListItem Text="مجرد" Value="1"></asp:ListItem><asp:ListItem Text="متاهل" Value="2"></asp:ListItem></asp:RadioButtonList></p>
                        <p style="padding :0;padding-right :20px;width:90%;position:relative ;top:0px;margin :0;height:60px;">شغل درخواستی : <asp:DropDownList id="cmb_Job" Font-Size ="9pt" Font-Names ="yekan" runat ="server" Width="200"></asp:DropDownList><asp:Button ID="btnSearch" runat ="server" Text ="جستجو" style="background:orange;cursor:pointer ;font-size :9pt;font-family:Yekan;color:#fff;border:0;margin-right:20px;" /></p>
