...
<head id="Head1" runat="server">
    <title>Strategic Pillars - ANHAR Company</title>
     ...
     <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" TargetControlID="txt_Search" ServiceMethod="Buscar" ServicePath="AutoCompletar.asmx" MinimumPrefixLength="2" CompletionInterval="1000" EnableCaching="true" CompletionSetCount="12"   CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"></asp:AutoCompleteExtender>  
        ...
        <div class ="backMobileMenu" id="mobileMenu4"  style ="display:none;">
           ...
           <div class ="mainScreenLayer">    
            ...
            <div class ="MessageCEO_HeaderTextContainer"><h1 class="<%=SiteStudioStore.AlignClass("copy_Pillars_h1")%>"><%=SiteStudioStore.Copy("copy_Pillars_h1", "Strategic Pillars")%></h1> </div>
            <div class ="MessageCEO_topTextContainer">
                <p class="<%=SiteStudioStore.AlignClass("copy_Pillars_h2")%>" style="text-align :left;font-size :16pt;font-weight:700;"><i class ="fa fa-arrow-right" style="font-size :16pt;"></i><%=SiteStudioStore.Copy("copy_Pillars_h2", "Vision:")%></p>
                <p style ="text-align :left;">
                     Increasing the capability and becoming a reliable company in providing engineering, purchasing and implementation services in the oil, gas, petrochemical and water industries in the next 5 years
                </p>
                
                <p class="<%=SiteStudioStore.AlignClass("copy_Pillars_h3")%>" style="text-align :left;font-size :16pt;font-weight:700;"><i class ="fa fa-arrow-right" style="font-size :16pt;"></i><%=SiteStudioStore.Copy("copy_Pillars_h3", "Mission:")%></p>
                
                <p style ="text-align :left;">
                    Playing an admirable and respectable role in value creation and sustainable development
                </p>
            </div>
