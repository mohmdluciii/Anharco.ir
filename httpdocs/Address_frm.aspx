<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Address_frm.aspx.vb" Inherits="W_ISM.Address_frm" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><a href="#">صفحه اصلی</a><i class="fa fa-chevron-left arrow"></i><a href="#">آدرس </a><i class="fa fa-chevron-left arrow"></i><a>درج</a></div>
                ...
                <div class="InterBoxFormRight" >
                    ...
                    <div class="bodyForm">
                        ...
                        <div class ="ContainerTextBoxObject">       
                            <div class="ContainerTextBoxCaption">مشخصات آدرس &nbsp; <asp:Label id="lblText_Address" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle" style="height:107px;">
                                <div class="effectContainerDiv"  id="container_Text_Address"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">لطفا آدرس را درج نمائید</div></li></ul></a></li>
                                    <li> <asp:TextBox TextMode ="MultiLine"   contenteditable="true" style="height:100px;"  tabindex="1"  onfocus="GraphicalBorder('container_Text_Address');" onblur="GraphicalBorderRemove('container_Text_Address');" ID="Text_Address" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        
                        <div class ="ContainerTextBoxObject">       
                            <div class="ContainerTextBoxCaption">کد پستی &nbsp; <asp:Label id="lblpostCode_Address" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_postCode_Address"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">لطفا آدرس را درج نمائید</div></li></ul></a></li>
                                    <li> <asp:TextBox  contenteditable="true"  tabindex="1"  onfocus="GraphicalBorder('container_postCode_Address');" onblur="GraphicalBorderRemove('container_postCode_Address');" ID="postCode_Address" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        
                        <div class ="ContainerTextBoxObject">       
                            <div class="ContainerTextBoxCaption">تلفن &nbsp; <asp:Label id="lblphone_address" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_phone_address"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">لطفا آدرس را درج نمائید</div></li></ul></a></li>
                                    <li> <asp:TextBox  contenteditable="true"  tabindex="1"  onfocus="GraphicalBorder('container_phone_address');" onblur="GraphicalBorderRemove('container_phone_address');" ID="phone_address" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        
                        <div class ="ContainerTextBoxObject">       
                            <div class="ContainerTextBoxCaption">فکس &nbsp; <asp:Label id="lblfax_address" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_fax_address"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">لطفا آدرس را درج نمائید</div></li></ul></a></li>
                                    <li> <asp:TextBox  contenteditable="true"  tabindex="1"  onfocus="GraphicalBorder('container_fax_address');" onblur="GraphicalBorderRemove('container_fax_address');" ID="fax_address" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
