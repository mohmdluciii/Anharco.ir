<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Project_Edit.aspx.vb" Inherits="W_ISM.Project_Edit" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><a href="#">پروژه ها</a><i class="fa fa-chevron-left arrow"></i><a href="#">اخبار و رویدادها</a><i class="fa fa-chevron-left arrow"></i><a>ویرایش</a></div>
            ...
            <div class="containerForm">
                ...
                <div class="DeleteBoxContainer" id="DeleteBoxContainer" onclick="closeDeleteDialog();">
                    <div class ="DeleteBox" id="DeleteBox">
                       <iframe src="Project_Delete.aspx?rowID_Project=<%=request.QueryString("rowID_Project") %>" frameborder="0"></iframe>
                    </div>
                </div>
                ...
                <div class="InterBoxFormLeft">
                    <ul>
                        <li>
                            <a class ="LinkIcon" href="Project_List.aspx"><i class="fa  fa-pencil"></i></a>
                            <ul>
                ...
                <div class="InterBoxFormRight" >
                    ...
                    <div class="bodyForm">
                        ...
                        <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption">گروه &nbsp; *<asp:Label id="lblrowID_GroupProject" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_rowID_GroupProject"></div>
                                <ul class="ContainerQuotation">
                                    ...
                                    <li><asp:DropDownList  id="cmb_rowID_GroupProject" tabindex="1" runat ="server"  onfocus="GraphicalBorder('container_rowID_GroupProject');" onblur="GraphicalBorderRemove('container_rowID_GroupProject');"></asp:DropDownList></li>
                                </ul>
                            </div>
                        </div>
                    
                        <div class ="ContainerTextBoxObject">       
                            <div class="ContainerTextBoxCaption">عنوان&nbsp;* <asp:Label id="lblName_Project" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle" style="height:88px">
                                <div class="effectContainerDiv"  id="container_Name_Project"></div>
                                <ul class="ContainerQuotation" >
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">عنوان پروژه می باشد که حتما باید درج شود</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="1" style="height:80px" TextMode ="MultiLine"  onfocus="GraphicalBorder('container_Name_Project');" onblur="GraphicalBorderRemove('container_Name_Project');" ID="Name_Project" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        <div class ="ContainerTextBoxObject">       
                            <div class="ContainerTextBoxCaption">کارفرما&nbsp;* <asp:Label id="lblBoss_Project" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle" >
                                <div class="effectContainerDiv"  id="container_Boss_Project"></div>
                                <ul class="ContainerQuotation" >
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">نام کارفرما می باشد که حتما باید درج شود</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="1"  onfocus="GraphicalBorder('container_Boss_Project');" onblur="GraphicalBorderRemove('container_Boss_Project');" ID="Boss_Project" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        <div class ="ContainerTextBoxObject">       
                            <div class="ContainerTextBoxCaption">تاریخ پروژه&nbsp;* <asp:Label id="lblDate_Project" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle" >
                                <div class="effectContainerDiv"  id="container_Date_Project"></div>
                                <ul class="ContainerQuotation" >
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">تاریخ پروژه شروع می باشد</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="1"  onfocus="GraphicalBorder('container_Date_Project');" onblur="GraphicalBorderRemove('container_Date_Project');" ID="Date_Project" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        <div class ="ContainerTextBoxObject" style="width :100%;">
                            <div class="ContainerTextBoxCaption"><asp:Label id="lblText_Project" runat ="server"  class="errStyle" ></asp:Label></div>
                       ...
                       <div class ="ContainerTextBoxObject" >
                            <div class="ContainerTextBoxCaption">تصویر  &nbsp;  <asp:Label id="lblPic_Project" runat ="server"  class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_Pic_Project"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">تصویر پروژه است که در صورت وجود باید از هارد کامپیوتر انتخاب شود</div></li></ul></a></li>
                                    <li><input id="uploadFile" tabindex="7"  placeholder="انتخاب فایل" disabled="disabled" class="fileUpload_Style" /><div class="upload-btn-wrapper"><a href="#"  class="btn" style="height :38px;position:relative ;top:2px;left:0px;margin :0;"><i class="fa  fa-upload"></i></a><asp:FileUpload  type="file" name="myfile" runat ="server"  id="Pic_Project" /></div> </li>
                                </ul>
                            </div>
                        </div>
...
<script  type ="text/javascript" >
    document.getElementById("Pic_Project").onchange = function() {
...
<link rel="stylesheet" href="Calender/jquery.calendars.picker.css">
    ...
    <script>
        $(function() {
            ...
            $('#expireDate_Project').calendarsPicker({ calendar: calendar });
        });
