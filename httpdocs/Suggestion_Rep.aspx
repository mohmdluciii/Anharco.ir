<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Suggestion_Rep.aspx.vb" Inherits="W_ISM.Suggestion_Rep" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm">درخواست ها</a><i class="fa fa-chevron-left arrow"></i><a href="#">گزارش پیشنهادات</a><i class="fa fa-chevron-left arrow"></i><a>لیست</a></div>
            ...
            <div class="containerForm" style="width:100%;">
                ...
                <div class="SaveBoxContainer" id="saveContainer">
                    <div class ="SaveBox" id="saveDialog" style="top:5%">
                        ...
                        <input type="button" value="تایید" onclick="window.open('Suggestion_Rep.aspx','_top');" /> 
                    </div>
                  </div>
                    <div class="headForm_List" >
                       <a class="ExcelIcon" href="showExcel.aspx?page=Suggestion_Rep" target="_blank" title ="خروجی اکسل"><i class="fa fa-file-excel-o"></i></a>
                    </div>
            
                    <div class="bodyForm">
                        <p style="position :relative ;top:0px;left:0px;width :100%;float:right ;direction:rtl;font-size:10pt;font-family:yekan,arial;text-align :right;padding-right :20px;margin :0;margin-top :10px"><a style ="width :90px;display:inline-block ">ار تاریخ </a> &nbsp;<asp:TextBox  Height ="30" ID="sDate" runat ="server" Width ="80" Font-Names ="tahoma" Font-Size ="8pt" style="border:1px solid #ccc;height:25px;width:100px;font-size:9pt;font-family:yekan,arial;padding-right :5px;" AutoComplete="off" ></asp:TextBox>&nbsp;تا <asp:TextBox  Height ="30" ID="eDate" runat ="server" Width ="80" Font-Names ="tahoma" Font-Size ="8pt" style="border:1px solid #ccc;height:25px;width:100px;font-size:9pt;font-family:yekan,arial;padding-right :5px;" AutoComplete="off" ></asp:TextBox>&nbsp;<asp:Button class="Button_InList" ID="btnSearch" runat ="server" Text ="جستجو" Font-Names ="tahoma" Font-Size ="8pt" /></p>
