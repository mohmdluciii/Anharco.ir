<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Session_Edit1.aspx.vb" Inherits="W_ISM.Session_Edit1" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><a href="#">مدیریت همکار</a><i class="fa fa-chevron-left arrow"></i><a href="#">ثبت زمانبندی جلسات</a><i class="fa fa-chevron-left arrow"></i><a>ویرایش</a></div>
                ...
                <div class="SaveBoxContainer" id="saveContainer">
                 ...
                 <div class="DeleteBoxContainer" id="DeleteBoxContainer" onclick="closeDeleteDialog();">
                    <div class ="DeleteBox" id="DeleteBox">
                       <iframe src="Session_Delete1.aspx?rowID_Session=<%=request.QueryString("rowID_Session") %>" frameborder="0"></iframe>
                    </div>
                </div>
                <div class="InterBoxFormLeft">
                    <ul>
                        <li>
                            <a class ="LinkIcon" href="Session_List1.aspx"><i class="fa  fa-pencil"></i></a>
                            <ul>
                ...
                <div class="InterBoxFormRight" >
                    ...
                    <div class="bodyForm">
                        ...
                        <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption">تاریخ جلسه&nbsp; *<asp:Label id="lblDate_Session" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_Date_Session"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">تاریخ برگزاری جلسه است</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="1"  onfocus="GraphicalBorder('container_Date_Session');" onblur="GraphicalBorderRemove('container_Date_Session');" ID="Date_Session" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption">ساعت جلسه&nbsp; *<asp:Label id="lblTime_Session" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_Time_Session"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">ساعت برگزاری جلسه است</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="1"  onfocus="GraphicalBorder('container_Time_Session');" onblur="GraphicalBorderRemove('container_Time_Session');" ID="Time_Session" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        
                            <div class ="ContainerTextBoxObject" >
                            <div class="ContainerTextBoxCaption">موضوع جلسه&nbsp;*  <asp:Label id="lblTitle_Session" runat ="server"  class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle ContainerTextBoxStyleTextEditor" style="height:108px;">
                                <div class="effectContainerDiv"  id="container_Title_Session"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">موضوعی است که جلسه برا آن برگزار می شود.</div></li></ul></a></li>
                                    <li> <asp:TextBox tabindex="2" style="height:100px;" class="ContainerTextBoxObjectTextEditor"   TextMode ="MultiLine" onfocus="GraphicalBorder('container_Title_Session');" onblur="GraphicalBorderRemove('container_Title_Session');" ID="Title_Session" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class ="ContainerTextBoxObject" >
                            <div class="ContainerTextBoxCaption">شرح کار جلسه  &nbsp;  <asp:Label id="lblDes_Session" runat ="server"  class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle ContainerTextBoxStyleTextEditor" style="height:108px;">
                                <div class="effectContainerDiv"  id="container_Des_Session"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">شرح کار جلسه ای است که قرار است تشکیل شود</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="4"  style="height:100px;" class="ContainerTextBoxObjectTextEditor" TextMode ="MultiLine"  onfocus="GraphicalBorder('container_Des_Session');" onblur="GraphicalBorderRemove('container_Des_Session');" ID="Des_Session" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                       
                       <div class ="ContainerTextBoxObject" >
                            <div class="ContainerTextBoxCaption">مکان جلسه  &nbsp;  <asp:Label id="lblplace_session" runat ="server"  class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_place_session"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">آدرس مکانی است که جلسه در آن برگزار می شود</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="4"  class="ContainerTextBoxObjectTextEditor"   onfocus="GraphicalBorder('container_place_session');" onblur="GraphicalBorderRemove('container_place_session');" ID="place_session" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        
                        <div class ="ContainerTextBoxObject" style ="width :100%;" >
                            <div class="ContainerTextBoxCaption">صورت جلسه &nbsp;  <asp:Label id="lblFinalDoc_Session" runat ="server"  class="errStyle" ></asp:Label></div>
                             <div class ="ContainerTextBoxObject" style="width :100%;">
                        ...
                        <div class ="ContainerTextBoxObject" >
                            <div class="ContainerTextBoxCaption">حاضرین جلسه&nbsp;  <asp:Label id="lblPersons_Session" runat ="server"  class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle ContainerTextBoxStyleTextEditor">
                                <div class="effectContainerDiv"  id="container_Persons_Session"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">حاضرین در جلسه می باشد</div></li></ul></a></li>
                                    <li> <asp:TextBox tabindex="2" TextMode ="MultiLine"   class="ContainerTextBoxObjectTextEditor" onfocus="GraphicalBorder('container_Persons_Session');" onblur="GraphicalBorderRemove('container_Persons_Session');" ID="Persons_Session" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
