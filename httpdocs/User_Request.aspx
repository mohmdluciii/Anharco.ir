<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="User_Request.aspx.vb" Inherits="W_ISM.User_Request" %>
...
<body style ="margin :0">
    ...
    <div class="SaveBoxContainer" id="saveContainer">
                    <div class ="SaveBox" id="saveDialog">
                        <p><i class='fa fa-floppy-o'></i> &nbsp;<asp:Label ID="lblMessage" runat ="server"  ></asp:Label></p>
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><i class="fa fa-address-book  icon"></i><a href="#"> درخواست تعمیر و نگهداری</a><i class="fa fa-chevron-left arrow"></i><a href="#">درخواست</a><i class="fa fa-chevron-left arrow"></i><a>ثبت</a></div>
        ...
        <div class="formBox">
            ...
            <div class="containerForm" style="width:100%;">
                ...
                <div class="InterBoxFormLeft">
                    <ul>
                        <li>
                            <a class ="LinkIcon" href="User_StatusRequest.aspx"   ><i class="fa  fa-file-text"></i></a>
                            <ul>
                                <li><a  class="bubbleLink2" >وضعیت</a></li>
                            </ul>
                        </li>
                    </ul>
           ...
           <div class ="ContainerTextBoxObject">
                       <div class="ContainerTextBoxCaption">گروه تجهیزات&nbsp; *<asp:Label id="lblrowID_Group" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                ...
                                <ul class="ContainerQuotation">
                                    ...
                                    <li><asp:DropDownList  id="cmb_Group" tabindex="3" runat ="server"  onfocus="GraphicalBorder('container_cmb_Group');" onblur="GraphicalBorderRemove('container_cmb_Group');" AutoPostBack ="true" ></asp:DropDownList></li>
                                    
                                </ul>
                            </div>
                        </div>
                          <div style="position:relative ; width :100%;height:20px;float:right ;"></div> 
                        <div class ="ContainerTextBoxObject" style="display:none;">
                            <div class="ContainerTextBoxCaption"> تجهیز&nbsp; *<asp:Label id="lblrowID_Tajhizat" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_rowID_Tajhizat"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">تجهیزی است که قصد درج قطعه آنرا دارید</div></li></ul></a></li>
                                    <li><asp:DropDownList  id="cmb_rowID_Tajhizat" tabindex="3" runat ="server"  onfocus="GraphicalBorder('container_rowID_Tajhizat');" onblur="GraphicalBorderRemove('container_rowID_Tajhizat');"></asp:DropDownList></li>
                                    
                                </ul>
                            </div>
                        </div>
                        
                        <div class="ContainerTextBoxCaption"><asp:Label ID="lblList" runat ="server"  ></asp:Label> </div>
                        
                         <div class="ContainerTextBoxCaption"><asp:Label ID="lblCaptionMain" runat ="server"  ></asp:Label> &nbsp; <asp:Label id="lblMainRequest" runat ="server" class="errStyle" ></asp:Label></div>
                        
                       
                         

                         <div class ="ContainerTextBoxObject" >
                         <div class="ContainerTextBoxCaption">شرح درخواست&nbsp; *<asp:Label id="lbltext_Request" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle ContainerTextBoxStyleTextEditor"    style="height:210px;" >
                                <div class="effectContainerDiv"  id="container_text_Request"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">متن کامل درخواست خود را در این بخش درج نمائید.</div></li></ul></a></li>
                                    <li><asp:TextBox TextMode ="MultiLine" style="height:200px;" class="ContainerTextBoxObjectTextEditor"  ID="text_Request" runat ="server"   tabindex="4"  onfocus="GraphicalBorder('container_text_Request');" onblur="GraphicalBorderRemove('container_text_Request');"></asp:TextBox> </li>
                                </ul>
                            </div>
                        </div>
                       ...
                       <div style="position:relative ; width :100%;height:20px;float:right ;"></div> 
                     <div class ="ContainerTextBoxObject" >
                            <div class="ContainerTextBoxCaption">ضمیمه درخواست   &nbsp;  <asp:Label id="lblfile_Request" runat ="server"  class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="file_Request"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">فایل ضمیمه است که در صورت وجود باید از هارد تجهیز انتخاب شود</div></li></ul></a></li>
                                    <li><input id="uploadFile" tabindex="7"  placeholder="انتخاب فایل" disabled="disabled" class="fileUpload_Style" /><div class="upload-btn-wrapper"><a href="#"  class="btn" style="height :38px;position:relative ;top:2px;left:0px;margin :0;"><i class="fa  fa-upload"></i></a><asp:FileUpload  type="file" name="myfile" runat ="server"  id="file_Request" /></div> </li>
                                </ul>
                            </div>
                        </div>
