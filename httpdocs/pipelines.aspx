<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="pipelines.aspx.vb" Inherits="Safe_pipelines" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" lang="en" dir="ltr">
<head id="Head1" runat="server">
    <title>Oil and gas pipelines - ANHAR Company</title>
     ...
     <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" TargetControlID="txt_Search" ServiceMethod="Buscar" ServicePath="AutoCompletar.asmx" MinimumPrefixLength="2" CompletionInterval="1000" EnableCaching="true" CompletionSetCount="12"   CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"></asp:AutoCompleteExtender>  
        ...
        <div class ="backMobileMenu" id="mobileMenu4"  style ="display:none;">
           ...
           <div class ="mainScreenLayer">    
            ...
            <div class ="MessageCEO_SlideContainer" style="<%=SiteStudioStore.BgStyle("hero_pipelines")%>">
            ...
            <div class ="MessageCEO_HeaderTextContainer"><h1 class="<%=SiteStudioStore.AlignClass("copy_pipelines_h1")%>"><%=SiteStudioStore.Copy("copy_pipelines_h1", "Oil and gas pipelines")%></h1> </div>
            <div class ="MessageCEO_topTextContainer">
                <p class="<%=SiteStudioStore.AlignClass("copy_pipelines_p1")%>"><%=SiteStudioStore.Copy("copy_pipelines_p1", "In general, the implementation of pipelines is the most economical way to transfer significant amounts of oil, refined oil and natural gas through the ground. Oil pipelines are made of steel or polyethylene with an inner diameter of 4 to 50 inches, and gas pipelines are made of steel with an inner diameter of 2 to 56 inches. Our country, Iran, having vast resources of oil and gas, needs the establishment of many pipelines to transport oil as well as oil and gas products. Anhar Co. has implemented many projects in this direction by using the technical knowledge of experienced and skillful human resources as well as up-to-date and appropriate equipment and machinery.")%></p>
            </div>
