<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Poll_Person.aspx.vb" Inherits="W_ISM.Poll_Person" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><i class="fa fa-bar-chart icon"></i><a href="#">  پیشنهادات</a><i class="fa fa-chevron-left arrow"></i><a href="#">   پیگیری پیشنهاد و انتقاد</a><i class="fa fa-chevron-left arrow"></i><a>لیست</a></div>
        <%=Session("scriptSave1")%>
        <div class="formBox">
            ...
            <div class="containerForm" style="width:100%;">
                ...
                <div class="InterBoxFormRight" >
                    ...
                    <div class="headForm_List" >
                       <%--<a class="ExcelIcon" href="showExcel.aspx?page=Suggestion_Paygiri" target="_blank" title ="خروجی اکسل"><i class="fa fa-file-excel-o"></i></a>--%>
                    </div>
                    ...
                    <div class="bodyForm">
                       ...
                       <table style ="width:95%" dir="rtl"  >
                                <tr>
                                    <td align ="center" >
                                        <table style ="position :relative ;top:0px;left:0px;width :100%;" dir="rtl">
                                            <tr>
                                              <td width="60%" valign="top"  align ="right"  >
                                                    <asp:Label ID="lblshow_form" runat ="server" ></asp:Label>    
                                                </td>
