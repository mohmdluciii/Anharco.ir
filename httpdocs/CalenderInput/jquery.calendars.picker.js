 ...
 $(selector).calendarsPicker({minDate: 0, maxDate: '+1m +1w'}) */
	...
	picker.append('&lt;button type="button">Hi&lt;/button>').
		...
		/** Localisations for the plugin.
			...
			@property [prevText='&lt;بعدی'] {string} Text for the previous month command.
			@property [prevStatus='Show the previous month'] {string} Status text for the previous month command.
			@property [prevJumpText='&lt;&lt;'] {string} Text for the previous year command.
			@property [prevJumpStatus='Show the previous year'] {string} Status text for the previous year command.
			@property [nextText='بعدی&gt;'] {string} Text for the next month command.
			@property [nextStatus='Show the next month'] {string} Status text for the next month command.
			@property [nextJumpText='&gt;&gt;'] {string} Text for the next year command.
			@property [nextJumpStatus='Show the next year'] {string} Status text for the next year command.
			@property [currentText='Current'] {string} Text for the current month command.
			@property [currentStatus='Show the current month'] {string} Status text for the current month command.
			@property [todayText='امروز'] {string} Text for the today's month command.
			@property [todayStatus='Show today\'s month'] {string} Status text for the today's month command.
			@property [clearText='Clear'] {string} Text for the clear command.
			@property [clearStatus='Clear all the dates'] {string} Status text for the clear command.
			@property [closeText='بستن'] {string} Text for the close command.
		...
		regionalOptions: { // Available regional settings, indexed by language/country code
			'': { // Default regional settings - English/US
				...
				prevText: '&lt;قبلی',
				prevStatus: 'مشاهده ماه قبلی',
				prevJumpText: '&lt;&lt;',
				prevJumpStatus: 'مشاهده سال قبلی',
				nextText: 'بعدی&gt;',
				nextStatus: 'مشاهده ماه بعدی',
				nextJumpText: '&gt;&gt;',
				nextJumpStatus: 'مشاهده سال بعدی',
				currentText: 'جاری',
				currentStatus: 'مشاهده ماه جاری',
				todayText: 'امروز',
				todayStatus: 'مشاهده روز جاری',
				clearText: 'پاک کردن',
				clearStatus: 'پاک کردن تمام داده ها',
				closeText: 'بستن',
