<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Essay_Edit.aspx.vb" Inherits="W_ISM.Essay_Edit" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        ...
        <div class="titleForm"><a href="#">اطلاع رسانی</a><i class="fa fa-chevron-left arrow"></i><a href="#">مقاله ها</a><i class="fa fa-chevron-left arrow"></i><a>ویرایش</a></div>
            ...
            <div class="containerForm">
                ...
                <div class="DeleteBoxContainer" id="DeleteBoxContainer" onclick="closeDeleteDialog();">
                    <div class ="DeleteBox" id="DeleteBox">
                       <iframe src="Essay_Delete.aspx?rowID_Essay=<%=request.QueryString("rowID_Essay") %>" frameborder="0"></iframe>
                    </div>
                </div>
                ...
                <div class="InterBoxFormLeft">
                    <ul>
                        <li>
                            <a class ="LinkIcon" href="Essay_List.aspx"><i class="fa  fa-pencil"></i></a>
                            <ul>
                ...
                <div class="InterBoxFormRight" >
                    ...
                    <div class="bodyForm">
                        <div class ="ContainerTextBoxObject">       
                            <div class="ContainerTextBoxCaption">عنوان مقاله&nbsp;* <asp:Label id="lbltitle_Essay" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle" style="height:88px">
                                <div class="effectContainerDiv"  id="container_title_Essay"></div>
                                <ul class="ContainerQuotation" >
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">عنوان مقاله است که باید درج شود و مقاله با آن عنوان معرفی می شود</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="1" style="height:80px" TextMode ="MultiLine"  onfocus="GraphicalBorder('container_title_Essay');" onblur="GraphicalBorderRemove('container_title_Essay');" ID="title_Essay" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        <div class ="ContainerTextBoxObject">       
                            <div class="ContainerTextBoxCaption">نویسنده&nbsp;* <asp:Label id="lblwriter_Essay" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle" style="height:88px">
                                <div class="effectContainerDiv"  id="container_writer_Essay"></div>
                                <ul class="ContainerQuotation" >
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">نویسنده یا نویسندگان مقاله در صورت وجود است </div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="1" style="height:80px" TextMode ="MultiLine"  onfocus="GraphicalBorder('container_writer_Essay');" onblur="GraphicalBorderRemove('container_writer_Essay');" ID="writer_Essay" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        <div class ="ContainerTextBoxObject">       
                            <div class="ContainerTextBoxCaption">مترجم&nbsp; <asp:Label id="lbltranslator_Essay" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle" style="height:88px">
                                <div class="effectContainerDiv"  id="container_translator_Essay"></div>
                                <ul class="ContainerQuotation" >
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">اگر مقاله ترجمه است مترجم یا مترجمین مقاله درج شود </div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="1" style="height:80px" TextMode ="MultiLine"  onfocus="GraphicalBorder('container_translator_Essay');" onblur="GraphicalBorderRemove('container_translator_Essay');" ID="translator_Essay" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        <div class ="ContainerTextBoxObject">       
                            <div class="ContainerTextBoxCaption">خلاصه مقاله&nbsp;* <asp:Label id="lblshort_Essay" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle" style="height:88px">
                                <div class="effectContainerDiv"  id="container_short_Essay"></div>
                                <ul class="ContainerQuotation" >
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">خلاصه مقاله در چند کلمه است که باید درج شود </div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="1" style="height:80px" TextMode ="MultiLine"  onfocus="GraphicalBorder('container_short_Essay');" onblur="GraphicalBorderRemove('container_short_Essay');" ID="short_Essay" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        <div class ="ContainerTextBoxObject" style="width :100%;">
                            <div class="ContainerTextBoxCaption"><asp:Label id="lbltext_Essay" runat ="server"  class="errStyle" ></asp:Label></div>
                        ...
                        <div class ="ContainerTextBoxObject" >
                            <div class="ContainerTextBoxCaption">ضمیمه  &nbsp;  <asp:Label id="lblfile_Essay" runat ="server"  class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_file_Essay"></div>
                                <ul class="ContainerQuotation">
...
<script  type ="text/javascript" >
    document.getElementById("pic_news").onchange = function() {
