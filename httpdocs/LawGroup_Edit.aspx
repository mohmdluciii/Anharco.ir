<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="LawGroup_Edit.aspx.vb" Inherits="W_ISM.LawGroup_Edit" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><a href="#">اطلاع رسانی</a><i class="fa fa-chevron-left arrow"></i><a href="#">گروه و مقررات</a><i class="fa fa-chevron-left arrow"></i><a>ویرایش</a></div>
            ...
            <div class="containerForm">
                ...
                <div class="DeleteBoxContainer" id="DeleteBoxContainer" onclick="closeDeleteDialog();">
                    <div class ="DeleteBox" id="DeleteBox">
                       <iframe src="LawGroup_Delete.aspx?rowID_LawGroup=<%=request.QueryString("rowID_LawGroup") %>" frameborder="0"></iframe>
                    </div>
                </div>
                        ...
                        <div class ="ContainerTextBoxObject">
                            ...
                            <div class="ContainerTextBoxStyle" >
                                ...
                                <ul class="ContainerQuotation">
                                    ...
                                    <li> <asp:TextBox   tabindex="1"  onfocus="GraphicalBorder('container_Name_LawGroup');" onblur="GraphicalBorderRemove('container_Name_LawGroup');" ID="Name_LawGroup" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
