<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="File_Attach_Edit.aspx.vb" Inherits="W_ISM.File_Attach_Edit" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
       <div class="titleForm"><a href="#">اطلاع رسانی</a><i class="fa fa-chevron-left arrow"></i><a href="#">فیلم و ویدئو</a><i class="fa fa-chevron-left arrow"></i><a>ویرایش</a></div>
            ...
            <div class="containerForm">
                ...
                <div class="DeleteBoxContainer" id="DeleteBoxContainer" onclick="closeDeleteDialog();">
                    <div class ="DeleteBox" id="DeleteBox">
                       <iframe src="File_Attach_Delete.aspx?rowID_File=<%=request.QueryString("rowID_File") %>" frameborder="0"></iframe>
                    </div>
                </div>
                <div class="InterBoxFormLeft">
                    <ul>
                        <li>
                            <a class ="LinkIcon" href="File_Attach_List.aspx?f1=<%=request.QueryString("f1") %>"><i class="fa  fa-pencil"></i></a>
                            <ul>
                ...
                <div class="InterBoxFormRight" >
                    ...
                    <div class="bodyForm">
                       ...
                       <div class ="ContainerTextBoxObject" >
                            <div class="ContainerTextBoxCaption">فایل  &nbsp;  <asp:Label id="lblname_File" runat ="server"  class="errStyle" ></asp:Label>&nbsp;<asp:Label runat ="server" ID="lblFileName" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                ...
                <asp:Image ID="img_File_Gallery" runat="server"  style="width:3cm;height:4cm;position:absolute;top:6.1cm; left:0.7cm"  />
            </div>    
