<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TypeGavahi_frm.aspx.vb" Inherits="W_ISM.TypeGavahi_frm" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><i class="fa a-address-book icon"></i><a href="#">مدیریت همکار</a><i class="fa fa-chevron-left arrow"></i><a href="#">نوع گواهی اشتغال</a><i class="fa fa-chevron-left arrow"></i><a>درج</a></div>
        ...
        <div class="formBox">
            ...
            <div class="containerForm">
                ...
                <div class="InterBoxFormLeft">
                    <ul>
                        <li>
                            <a class ="LinkIcon" href="TypeGavahi_List.aspx"><i class="fa  fa-pencil"></i></a>
                            <ul>
                    ...
                    <ul>
                        <li>
                            <a class ="LinkIcon" href="TypeGavahi_List.aspx"><i class="fa  fa-trash"></i></a>
                            <ul>
                ...
                <div class="InterBoxFormRight" >
                    ...
                    <div class="bodyForm">
                        ...
                        <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption">نام &nbsp; *<asp:Label id="lblName_TypeGavahi" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle" >
                                <div class="effectContainerDiv"  id="container_Name_TypeGavahi"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">نام استان است که باید منحصر وارد شود</div></li></ul></a></li>
                                    <li> <asp:TextBox   tabindex="1"  onfocus="GraphicalBorder('container_Name_TypeGavahi');" onblur="GraphicalBorderRemove('container_Name_TypeGavahi');" ID="Name_TypeGavahi" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        
                        <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption">بیشترین میزان صدور &nbsp; *<asp:Label id="lblmaxSodor_TypeGavahi" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle" >
                                <div class="effectContainerDiv"  id="container_maxSodor_TypeGavahi"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">بیشترین تعدادی که می توان برای هر شخص این گواهی اشتغال تعیین کرد </div></li></ul></a></li>
                                    <li> <asp:TextBox  onkeydown="checkValue()"    tabindex="1"  onfocus="GraphicalBorder('container_maxSodor_TypeGavahi');" onblur="GraphicalBorderRemove('container_maxSodor_TypeGavahi');" ID="maxSodor_TypeGavahi" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
