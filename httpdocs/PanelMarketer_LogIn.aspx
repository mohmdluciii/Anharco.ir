<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PanelMarketer_LogIn.aspx.vb" Inherits="W_ISM.PanelMarketer_LogIn" %>
                        ...
                        <div class ="loginBox">
                            ...
                            <div class ="titleBox">
                                <div class ="ContainerTextBoxObject" >
                                    <div class="ContainerTextBoxCaption">شناسه کاربری&nbsp;*  <asp:Label id="lblUID" runat ="server"  class="errStyle" ></asp:Label></div>
                                    <div class="ContainerTextBoxStyle">
                                        ...
                                        <ul class="ContainerQuotation">
                                            ...
                                            <li> <asp:TextBox tabindex="1"  onfocus="GraphicalBorder('container_UID');" onblur="GraphicalBorderRemove('container_UID');" ID="UID" AutoComplete="off" runat ="server"  MaxLength ="15"   ></asp:TextBox></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <div class ="titleBox">
                                <div class ="ContainerTextBoxObject" >
                                    <div class="ContainerTextBoxCaption">کلمه عبوری&nbsp;  <asp:Label id="lblPWD" runat ="server"  class="errStyle" ></asp:Label></div>
                                    <div class="ContainerTextBoxStyle">
                                        ...
                                        <ul class="ContainerQuotation">
                                            ...
                                            <li> <asp:TextBox tabindex="2"  onfocus="GraphicalBorder('container_PWD');" onblur="GraphicalBorderRemove('container_PWD');" ID="PWD" AutoComplete="off" runat ="server"  MaxLength ="15" TextMode="Password"   ></asp:TextBox></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <div class ="titleBox">
                                <div class="containerButton">
                                    <asp:Button ID="btnSaveForm" OnClientClick="StartProgressBar();"  runat ="server" Text ="ورود" style="width:200px;min-height:40px;margin-top:50px; " />
                                </div>
                            </div> 
                            <div class ="headerBox">
                                <a href="PanelMarketer_ForgetPassword.aspx" class ="link"><i class="fa fa-question"></i>رمز عبور را فراموش کرده ام</a>
                            </div>
                        </div>
                    </div>
                    <div class ="box">
                        <div class ="loginBox">
                            <div class ="headerBox">
                                <a><i class="fa fa-user-plus"></i>می خواهم در سامانه به عنوان همکار ثبت نام نمایم</a>
                            </div>
                            <div class ="titleBox">
                                متقاضی گرامی 
                                <br />
                                چنانچه قبلا در سامانه  به عنوان همکار ثبت نام نکرده اید ،  روی دکمه ثبت نام کلیک نمائید.

                            </div>
                            <div class ="titleBox">
                                <div class="containerButton">
                                    <asp:Button ID="btnAddMember" OnClientClick="StartProgressBar();"  runat ="server" Text ="ثبت نام" style="width:200px;min-height:40px;margin-top:50px; " />
                                </div>
                            </div> 
                        </div> 
                    </div> 
