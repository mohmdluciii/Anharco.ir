<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Goods_List1.aspx.vb" Inherits="W_ISM.Goods_List1" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><a href="#">تعمیر و نگهداری</a><i class="fa fa-chevron-left arrow"></i><a href="#">تجهیزات</a><i class="fa fa-chevron-left arrow"></i><a>ویرایش</a></div>
        ...
        <div class="formBox">
            ...
            <div class="containerForm" style="width:98%">
                ...
                <div class="InterBoxFormLeft">
                    <ul>
                        <li>
                            <a class ="LinkIcon" href="Goods_frm1.aspx"><i class="fa  fa-pencil"></i></a>
                            <ul>
                ...
                <div class="SaveBoxContainer" id="saveContainer">
                    <div class ="SaveBox" id="saveDialog" style="top:5%">
                        ...
                        <input type="button" value="تایید" onclick="window.open('goods_List1.aspx','_top');" /> 
                    </div>
                  </div>
                    <div class="headForm_List" >
                       <a class="ExcelIcon" href="showExcel.aspx?page=Goods_List1" target="_blank" title ="خروجی اکسل"><i class="fa fa-file-excel-o"></i></a>
                        <a class="ExcelIcon" href="Print.aspx?page=Goods_List1" target="_blank" title ="نسخه قابل چاپ"><i class="fa fa-print"></i></a>
                    </div>
                    
                    <div class="bodyFormEdit">
                        <p style="position :relative ;top:0px;left:0px;width :100%;float:right ;direction:rtl;font-size:10pt;font-family:yekan,arial;text-align :right;padding-right :20px;margin :0;margin-top :10px"><a style ="width :90px;display:inline-block ">گروه تجهیز</a> &nbsp;<asp:DropDownList class="Combo_InList" runat ="server" dir="rtl" ID="cmb_Group" width="200" AutoPostBack="True"></asp:DropDownList></p>
                        ...
                        <p style="position :relative ;top:0px;left:0px;width :100%;float:right ;direction:rtl;font-size:10pt;font-family:yekan,arial;text-align :right;padding-right :20px;margin :0;margin-top :10px"><a style ="width :90px;display:inline-block ">کد فنی </a> &nbsp;<asp:TextBox ID="Code_Tajhizat" runat ="server" width="100" style="height:30px;" ></asp:TextBox>&nbsp;<asp:Button class="Button_InList" ID="btnSearch" runat ="server" Text ="جستجو" Font-Names ="tahoma" Font-Size ="8pt" /></p>
