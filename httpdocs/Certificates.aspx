...
<head id="Head1" runat="server">
    <title>Certificates -  ANHAR Company</title>
     ...
     <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" TargetControlID="txt_Search" ServiceMethod="Buscar" ServicePath="AutoCompletar.asmx" MinimumPrefixLength="2" CompletionInterval="1000" EnableCaching="true" CompletionSetCount="12"   CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"></asp:AutoCompleteExtender>  
        ...
        <div class ="backMobileMenu" id="mobileMenu4"  style ="display:none;">
           ...
           <div class ="mainScreenLayer">    
            ...
            <div class ="MessageCEO_HeaderTextContainer"><h1 class="<%=SiteStudioStore.AlignClass("copy_Certificates_h1")%>"><%=SiteStudioStore.Copy("copy_Certificates_h1", "Certificates")%></h1> </div>
            <div class ="MessageCEO_topTextContainer">
                <p>
                    In pursuit of its strategic objectives and to enhance service quality, Anhar Company has successfully obtained the following prestigious certifications:<br>
                    •	Contractor Competency Certificate (Grade 1) in the Oil & Gas sector, based on the Engineering, Procurement, and Construction (EPC) delivery method.<br>
                    •	Contractor Competency Certificates in the following fields: Oil & Gas; Buildings & Structures; Installations & Equipment; Water; Roads & Transportation; and Industry—issued by the Plan and Budget Organization.<br>
                    •	Contractor Safety Competency Certificate issued by the Ministry of Cooperatives, Labor, and Social Welfare.<br>
                    The company has also secured Integrated Management System (IMS) certifications from the international firm DQS. Furthermore, to enhance the quality of execution in pipeline projects, it has obtained the ISO 3834-2:2021 Welding Management certification.
                </p>
            </div>
