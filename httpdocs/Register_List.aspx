<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Register_List.aspx.vb" Inherits="W_ISM.Register_List" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm">مدیریت </a><i class="fa fa-chevron-left arrow"></i><a href="#">مشتری</a><i class="fa fa-chevron-left arrow"></i><a>لیست</a></div>
        ...
        <div class="formBox">
            ...
            <div class="containerForm" style="width:100%;">
                ...
                <div class="InterBoxFormLeft">
                    <ul>
                        <li>
                            <a class ="LinkIcon" href="Marketer_frm.aspx"><i class="fa  fa-pencil"></i></a>
                            <ul>
                ...
                <div class="SaveBoxContainer" id="saveContainer">
                    <div class ="SaveBox" id="saveDialog" style="top:5%">
                        ...
                        <input type="button" value="تایید" onclick="window.open('Marketer_List.aspx','_top');" /> 
                    </div>
                  </div>
                    <div class="headForm_List" >
                       <a class="ExcelIcon" href="showExcel.aspx?page=Marketer_List1" target="_blank" title ="خروجی اکسل"><i class="fa fa-file-excel-o"></i></a>
                        <a class="ExcelIcon" href="Report.aspx?page=Marketer_List1" target="_blank" title ="نسخه قابل چاپ"><i class="fa fa-print"></i></a>
                    </div>
            
                    <div class="bodyForm">
                        <p style="position :relative ;top:0px;left:0px;width :100%;float:right ;direction:rtl;font-size:10pt;font-family:yekan,arial;text-align :right;padding-right :20px;margin :0;margin-top :10px"><a style ="width :90px;display:inline-block ">کد ملی </a> &nbsp;<asp:TextBox  Height ="30" ID="txtMeliCode" runat ="server" Width ="80" Font-Names ="tahoma" Font-Size ="8pt" style="border:1px solid #ccc;height:25px;width:100px;font-size:9pt;font-family:yekan,arial;padding-right :5px;" AutoComplete="off" ></asp:TextBox>&nbsp;<asp:Button class="Button_InList" ID="btnSearch" runat ="server" Text ="جستجو" Font-Names ="tahoma" Font-Size ="8pt" /></p>
                        <p style="position :relative ;top:0px;left:0px;width :100%;float:right ;direction:rtl;font-size:10pt;font-family:yekan,arial;text-align :right;padding-right :20px;margin :0;margin-top :10px"><a style ="width :90px;display:inline-block ">تاریخ ثبت </a> &nbsp;<asp:TextBox  Height ="30" ID="txtDate" runat ="server" Width ="80" Font-Names ="tahoma" Font-Size ="8pt" style="border:1px solid #ccc;height:25px;width:100px;font-size:9pt;font-family:yekan,arial;padding-right :5px;" AutoComplete="off" ></asp:TextBox>&nbsp;</p>
    ...
    <div class="memberPanel_LeftBox">
        ...
        <div class="memberPanel_leftBox_menuBox">
            <ul class="Myul">
               ...
               <%-- <li>
                    <a href="#"  id="myAccount2" ><i class="fa fa-list-alt"></i>کارتابل<i class="fa fa-caret-down"  style="font-size :12pt"></i></a>
                    <ul id="myAccountBox2"> 
                        <li><a href="BuyPackage_Change_Rep.aspx"><i class="fa fa-sticky-note"></i>کارتابل درخواست تغییرات</a></li>
                        <li><a href="BuyPackage_List_Rep.aspx"><i class="fa fa-dropbox"></i>پکیج های خریداری شده</a></li>
                        <li><a href="PanelAdmin_KartableMember.aspx"><i class="fa fa-user-circle-o"></i>کارتابل تایید مشتریان</a></li>
                        <li><a href="PanelAdmin_KartableMarketer.aspx" ><i class="fa fa-users"></i>کارتابل تایید همکاران</a></li>
                        <li><a href="BuyPackage_Film_Rep.aspx"><i class="fa fa-users"></i>کارتابل تایید ویدئو</a></li>
                        <li><a href="PanelAdmin_KartableInstagram.aspx"><i class="fa fa-users"></i>کارتابل تایید اینستاگرام/آپارات</a></li>
                        <li><a href="PanelAdmin_KartablePicture.aspx"><i class="fa fa-users"></i>کارتابل تایید تصاویر مشتری</a></li>
                        <li><a href="PanelMember_VideoCustomer.aspx"><i class="fa fa-users"></i>کارتابل تایید ویدئو مشتری</a></li>
                    </ul>
                </li>
                
                
                <li>
                    <a href="#"  id="myAccount3"  class="active"><i class="fa  fa-cog" ></i>مدیریت <i class="fa fa-caret-down"  style="font-size :12pt"></i></a>
                    <ul id="myAccountBox3"> 
                        <li><a href="Admin_frm1.aspx" ><i class="fa  fa-user-plus" ></i>کاربر مدیریتی</a></li>
                        
                        <li><a href="SettingFooter_frm.aspx"><i class="fa fa-sliders"></i>تنظیمات مدیریتی</a></li>
                        <li><a href="Member_List.aspx"><i class="fa fa-user-circle-o"></i>مشتری</a></li>
                        <li><a href="Marketer_list.aspx" class="activeSub"><i class="fa fa-users"></i>همکار</a></li>
                    </ul>
                </li>
                
                
                <li>
                    <a href="#"  id="myAccount4" ><i class="fa  fa-file-text-o" ></i>گزارش ها<i class="fa fa-caret-down"  style="font-size :12pt"></i></a>
                    <ul id="myAccountBox4"> 
                        <li><a href="PanelAdmin_MarketerHesab.aspx"><i class="fa  fa-search" ></i>وضعیت مالی همکاران</a></li>
                        <li><a href="PanelAdmin_MemberHesab.aspx"><i class="fa  fa-search" ></i>وضعیت مالی مشتریان</a></li>
                        <li><a href="PanelAdmin_Taraz.aspx"><i class="fa  fa-search" ></i>تراز آزمایشی</a></li>
                        <li><a href="PanelAdmin_Newsletters.aspx"><i class="fa fa-envelope-o"></i>لیست ایمیل های خبرنامه</a></li>
                        <li><a href="PanelAdmin_RequestCash.aspx"><i class="fa  fa-search" ></i>درخواست نقدی همکاران</a></li>
                        <li><a href="PanelAdmin_Click.aspx"><i class="fa  fa-search" ></i>آمار سامانه</a></li>
                    </ul>
                </li>--%>
