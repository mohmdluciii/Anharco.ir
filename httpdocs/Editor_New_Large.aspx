<%@ Page Language="vb" ValidateRequest ="false"   AutoEventWireup="false" CodeBehind="Editor_New_Large.aspx.vb" Inherits="W_ISM.Editor_New_Large" %>
...
<form name="compForm" method="post" action="Editor_New_large.aspx" onsubmit="if(validateMode()){this.myDoc.value=oDoc.innerHTML;return true;}return false;">
