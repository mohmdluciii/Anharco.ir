...
<head id="Head1" runat="server">
    <title>Facilities and equipment - ANHAR Company</title>
     ...
     <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" TargetControlID="txt_Search" ServiceMethod="Buscar" ServicePath="AutoCompletar.asmx" MinimumPrefixLength="2" CompletionInterval="1000" EnableCaching="true" CompletionSetCount="12"   CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"></asp:AutoCompleteExtender>  
        ...
        <div class ="backMobileMenu" id="mobileMenu4"  style ="display:none;">
           ...
           <div class ="mainScreenLayer">    
            ...
            <div class ="MessageCEO_HeaderTextContainer"><h1 class="<%=SiteStudioStore.AlignClass("copy_FacilitiesEquipment_h1")%>"><%=SiteStudioStore.Copy("copy_FacilitiesEquipment_h1", "Facilities and equipment")%></h1> </div>
            <div class ="MessageCEO_topTextContainer">
                <p class="<%=SiteStudioStore.AlignClass("copy_FacilitiesEquipment_p1")%>"><%=SiteStudioStore.Copy("copy_FacilitiesEquipment_p1", "Among other activities of Anhar company, we may refer to the participation in refinery construction operations, construction of urban network feeding lines and replacement of pipeline lining in different cities of the country.")%></p>
            </div>
