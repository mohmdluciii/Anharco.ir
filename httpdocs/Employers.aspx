...
<head id="Head1" runat="server">
    <title>Employers - ANHAR Company</title>
     ...
     <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" TargetControlID="txt_Search" ServiceMethod="Buscar" ServicePath="AutoCompletar.asmx" MinimumPrefixLength="2" CompletionInterval="1000" EnableCaching="true" CompletionSetCount="12"   CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"></asp:AutoCompleteExtender>  
        ...
        <div class ="backMobileMenu" id="mobileMenu4"  style ="display:none;">
           ...
           <div class ="mainScreenLayer">    
            ...
            <div class ="MessageCEO_HeaderTextContainer"><h1 class="<%=SiteStudioStore.AlignClass("copy_Employers_h1")%>"><%=SiteStudioStore.Copy("copy_Employers_h1", "Employers")%></h1> </div>
            <div class ="MessageCEO_topTextContainer">
                ...
                <div style="position:relative ;top:-150px;float:none;margin-left :auto ;margin-right :auto ;width :60%;min-height:400px;display:inline-block;text-align :center ; ">
                    <div style="position:relative ;top:0px;float:left ;width :100%;min-height:200px;text-align :left;"><img src="<%=SiteStudioStore.Asset("pic_nioc")%>"  /></div>
                    <div style="position:relative ;top:0px;float:left ;width :100%;min-height:300px;">
                        <p class="<%=SiteStudioStore.AlignClass("copy_Employers_1_name")%>" style="font-weight:900;font-size:18pt;position:relative ;top:0px;width :100%;text-align :left ;"><%=SiteStudioStore.Copy("copy_Employers_1_name", "National Iranian Oil Company")%></p>
                        <p style="position:relative ;top:0px;width :100%;text-align :left ;"><i class ="fa fa-arrow-right"></i>CEO: Hamid Bovard</p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_Employers_1_addr")%>" style="position:relative ;top:0px;width :100%;text-align :left ;"><i class ="fa fa-arrow-right"></i><%=SiteStudioStore.Copy("copy_Employers_1_addr", "Hafez St., corner of Rudsartmas St. with National Iranian Oil Company: 021-61651")%></p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_Employers_1_web")%>" style="position:relative ;top:0px;width :100%;text-align :left ;"><i class ="fa fa-arrow-left"></i><%=SiteStudioStore.Copy("copy_Employers_1_web", "Website")%></p>
                    </div>
               </div>
            
             <div style="position:relative ;top:-150px;float:none;margin-left :auto ;margin-right :auto ;width :60%;min-height:400px;display:inline-block;text-align :center ; ">
                    <div style="position:relative ;top:0px;float:left ;width :100%;min-height:200px;text-align :left;"><img src="<%=SiteStudioStore.Asset("pic_logogz")%>"  /></div>
                    <div style="position:relative ;top:0px;float:left ;width :100%;min-height:300px;">
                        <p style="font-weight:900;font-size:18pt;position:relative ;top:0px;width :100%;text-align :left ;">Iran National Gas Company</p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_Employers_2_ceo")%>" style="position:relative ;top:0px;width :100%;text-align :left ;"><i class ="fa fa-arrow-right"></i><%=SiteStudioStore.Copy("copy_Employers_2_ceo", "CEO: Dr. Saeed Tavakoli")%></p>
                        <p style="position:relative ;top:0px;width :100%;text-align :left ;"><i class ="fa fa-arrow-right"></i>No. 29, Azdi Street (Aban), Tehran</p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_Employers_2_web")%>" style="position:relative ;top:0px;width :100%;text-align :left ;"><i class ="fa fa-arrow-left"></i><%=SiteStudioStore.Copy("copy_Employers_2_web", "Website")%></p>
                    </div>
               </div>
