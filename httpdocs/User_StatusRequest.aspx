<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="User_StatusRequest.aspx.vb" Inherits="W_ISM.User_StatusRequest" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><i class="fa fa-address-book  icon"></i><a href="#"> درخواست تعمیر و نگهداری</a><i class="fa fa-chevron-left arrow"></i><a href="#">وضعیت درخواست ها</a><i class="fa fa-chevron-left arrow"></i><a>لیست</a></div>
        ...
        <div class="formBox">
            ...
            <div class="containerForm" style="width:100%;">
                ...
                <div class="InterBoxFormRight" >
                    ...
                    <div class="bodyForm">
                        <div  style="position:relative ;top:0px;left:0px;width:100%;min-height:800px;">
                            <p style="position:relative ;top:0px;float:none;margin-left :auto ;margin-right :auto ; width :98%"><asp:Label id="lblPaging" runat ="server" ></asp:Label></p>
                            <p style="position:relative ;top:0px;float:none;margin-left :auto ;margin-right :auto ; width :98%"><asp:Label ID="lblList" runat ="server"  ></asp:Label></p>
                            <p style="position:relative ;top:0px;float:none;margin-left :auto ;margin-right :auto ; width :98%"><asp:Label ID="lblOldRequest" runat ="server"  ></asp:Label></p>
                        </div>
