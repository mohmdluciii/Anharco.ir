<%@ Page Language="vb" ValidateRequest="false"  AutoEventWireup="false" CodeBehind="File_Attach_frm.aspx.vb" Inherits="W_ISM.File_Attach_frm" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><a href="#">اطلاع رسانی</a><i class="fa fa-chevron-left arrow"></i><a href="#">فیلم و ویدئو</a><i class="fa fa-chevron-left arrow"></i><a>درج</a></div>
        ...
        <div class="formBox">
            ...
            <div class="containerForm">
                ...
                <div class="InterBoxFormLeft">
                    <ul>
                        <li>
                            <a class ="LinkIcon" href="File_Attach_list.aspx"><i class="fa  fa-pencil"></i></a>
                            <ul>
                    ...
                    <ul>
                        <li>
                            <a class ="LinkIcon" href="File_Attach_list.aspx"><i class="fa  fa-trash"></i></a>
                            <ul>
                ...
                <div class="InterBoxFormRight" >
                    ...
                    <div class="bodyForm">
                       ...
                       <%-- <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption">گروه &nbsp; *<asp:Label id="lblGroupFile" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_GroupFile"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">گروهی است که تصویر در آن گروه بارگزاری می شود.</div></li></ul></a></li>
                                    <li><asp:DropDownList  id="cmb_GroupFile" tabindex="1" runat ="server"  onfocus="GraphicalBorder('container_GroupFile');" onblur="GraphicalBorderRemove('container_GroupFile');"></asp:DropDownList></li>
                                </ul>
                            </div>
                        </div>--%>
                    
                        <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption">گروه &nbsp; *<asp:Label id="lblGroupGallery" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_GroupGallery"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">گروهی است که فایل در آن گروه بارگزاری می شود.</div></li></ul></a></li>
                                    <li><asp:DropDownList  id="cmb_GroupGallery" tabindex="1" runat ="server"  onfocus="GraphicalBorder('container_GroupGallery');" onblur="GraphicalBorderRemove('container_GroupGallery');"></asp:DropDownList></li>
                                </ul>
                            </div>
                        </div>                    
                        <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption">عنوان&nbsp; *<asp:Label id="lbltitle_file" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_title_file"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">عنوان ویدئوی است که در گالری بارگزاری می شود</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="2"  onfocus="GraphicalBorder('container_title_file');" onblur="GraphicalBorderRemove('container_title_file');" ID="title_file" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        <div class ="ContainerTextBoxObject" >
                            <div class="ContainerTextBoxCaption">تصویر  &nbsp;  <asp:Label id="lblPic_File" runat ="server"  class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_Pic_File"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">تصویر بند انگشتی گالری است که در صورت وجود باید از هارد کامپیوتر انتخاب شود</div></li></ul></a></li>
                                    <li><input id="uploadFile1" tabindex="7"  placeholder="انتخاب فایل" disabled="disabled" class="fileUpload_Style" /><div class="upload-btn-wrapper"><a href="#"  class="btn" style="height :38px;position:relative ;top:2px;left:0px;margin :0;"><i class="fa  fa-upload"></i></a><asp:FileUpload  type="file" name="myfile1" runat ="server"  id="Pic_File" /></div> </li>
                                </ul>
                            </div>
                        </div>
                     
                       <div class ="ContainerTextBoxObject" >
                            <div class="ContainerTextBoxCaption">فایل  &nbsp;  <asp:Label id="lblname_File" runat ="server"  class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_name_File"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">فایل گالری است که در صورت وجود باید از هارد کامپیوتر انتخاب شود</div></li></ul></a></li>
                                    <li><input id="uploadFile" tabindex="7"  placeholder="انتخاب فایل" disabled="disabled" class="fileUpload_Style" /><div class="upload-btn-wrapper"><a href="#"  class="btn" style="height :38px;position:relative ;top:2px;left:0px;margin :0;"><i class="fa  fa-upload"></i></a><asp:FileUpload  type="file" name="myfile" runat ="server"  id="name_File" /></div> </li>
                                </ul>
                            </div>
                        </div>
                        <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption">لینک آپارات&nbsp; <asp:Label id="lblAparat_File" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle" style="height:90px">
                                <div class="effectContainerDiv"  id="container_Aparat_File"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">اگر ویدئو در آپارات بارگزاری شده است لینک Embed آنرا درج نمائید</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="2" Height ="80" TextMode ="MultiLine"   onfocus="GraphicalBorder('container_Aparat_File');" onblur="GraphicalBorderRemove('container_Aparat_File');" ID="Aparat_File" AutoComplete="off" runat ="server"  style="direction:ltr;text-align :left ;" ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
...
<script  type ="text/javascript" >
    document.getElementById("name_File").onchange = function() {
...
<script  type ="text/javascript" >
    document.getElementById("Pic_File").onchange = function() {
