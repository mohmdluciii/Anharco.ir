<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WateTransmissionPipelines.aspx.vb" Inherits="Safe_WateTransmissionPipelines" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" lang="en" dir="ltr">
<head id="Head1" runat="server">
    <title>Water Transmission Pipelines Projects - ANHAR Company</title>
     ...
     <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" TargetControlID="txt_Search" ServiceMethod="Buscar" ServicePath="AutoCompletar.asmx" MinimumPrefixLength="2" CompletionInterval="1000" EnableCaching="true" CompletionSetCount="12"   CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"></asp:AutoCompleteExtender>  
        ...
        <div class ="backMobileMenu" id="mobileMenu4"  style ="display:none;">
           ...
           <div class ="mainScreenLayer">    
            ...
            <div class ="MessageCEO_SlideContainer" style="<%=SiteStudioStore.BgStyle("hero_WateTransmissionPipelines")%>">
                         ...
                         <ul>
                            ...
                            <li><a onmouseover ="showBoxBackMenu();">Projects</a>
                                <ul  id="obj-m-2">
                                    ...
                                    <li><a href="WateTransmissionPipelines.aspx">Water Transmission Pipelines</a></li>
                                </ul>
                            </li>
            ...
            <div class ="MessageCEO_HeaderTextContainer"><h1 class="<%=SiteStudioStore.AlignClass("copy_WateTransmissionPipelines_h1")%>"><%=SiteStudioStore.Copy("copy_WateTransmissionPipelines_h1", "Water Transmission Pipelines")%></h1> </div>
            <div class ="MessageCEO_topTextContainer">
                <p class="<%=SiteStudioStore.AlignClass("copy_WateTransmissionPipelines_p1")%>"><%=SiteStudioStore.Copy("copy_WateTransmissionPipelines_p1", "Considering the vital role of water in human life and the lack of this life liquid in the new century, the process of transferring and purifying it up to the stage of reaching the consumer is one of the important and strategic projects of every country. Transmission lines and water distribution networks refer to a set of facilities, including pipes, fittings and valves, which are built to transfer fluids from one point to another. The most important parts of a distribution network or water transmission lines include pipes of different materials, pumping stations to provide line pressure, and faucets to control and operate the transmission line.")%></p>
            </div>
           ...
           <%=Session("initWateTransmissionPipelines")%>
           </div>
  ...
  <div class ="footerMainPage">
    <div class ="footerContainer">
        ...
        <div class ="boxFooterMenu">
            ...
            <ul><li><a href="building.aspx">Construction and building</a></li></ul><ul><li><a href="FacilitiesEquipment.aspx">Facilities and equipment</a></li></ul><ul><li><a href="WateTransmissionPipelines.aspx">Water Transmission Pipelines</a></li></ul>
            <ul><li><a href="#"></a></li></ul>
