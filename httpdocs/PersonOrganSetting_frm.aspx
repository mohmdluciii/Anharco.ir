<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PersonOrganSetting_frm.aspx.vb" Inherits="W_ISM.PersonOrganSetting_frm" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><a href="#">راه اندازی سامانه</a><i class="fa fa-chevron-left arrow"></i><a href="#">تنظیمات اکسل پرسنل </a><i class="fa fa-chevron-left arrow"></i><a>درج</a></div>
                    ...
                    <div class="bodyForm">
                        ...
                        <div class ="ContainerTextBoxObject">       
                            ...
                            <div class="ContainerTextBoxStyle">
                                ...
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">لطفا عنوان ستون ردیف اول اکسل برای فیلد مورد نظر را عینا با کپی آن عنوان درج نمائید</div></li></ul></a></li>
                                    <li> <asp:TextBox contenteditable="true"   tabindex="1"  onfocus="GraphicalBorder('container_name_Person');" onblur="GraphicalBorderRemove('container_name_Person');" ID="name_Person" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class ="ContainerTextBoxObject">       
                            ...
                            <div class="ContainerTextBoxStyle">
                                ...
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">لطفا عنوان ستون ردیف اول اکسل برای فیلد مورد نظر را عینا با کپی آن عنوان درج نمائید</div></li></ul></a></li>
                                    <li> <asp:TextBox contenteditable="true"   tabindex="1"  onfocus="GraphicalBorder('container_lname_Person');" onblur="GraphicalBorderRemove('container_lname_Person');" ID="lname_Person" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class ="ContainerTextBoxObject">       
                            ...
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_fname_Person"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">لطفا عنوان ستون ردیف اول اکسل برای فیلد مورد نظر را عینا با کپی آن عنوان درج نمائید</div></li></ul></a></li>
                                    <li> <asp:TextBox contenteditable="true"   tabindex="1"  onfocus="GraphicalBorder('container_fname_Person');" onblur="GraphicalBorderRemove('container_fname_Person');" ID="fname_Person" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class ="ContainerTextBoxObject">       
                            ...
                            <div class="ContainerTextBoxStyle">
                                ...
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">لطفا عنوان ستون ردیف اول اکسل برای فیلد مورد نظر را عینا با کپی آن عنوان درج نمائید</div></li></ul></a></li>
                                    <li> <asp:TextBox contenteditable="true"   tabindex="1"  onfocus="GraphicalBorder('container_ID_Person');" onblur="GraphicalBorderRemove('container_ID_Person');" ID="ID_Person" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        
                        <div class ="ContainerTextBoxObject">       
                            <div class="ContainerTextBoxCaption">وضعیت تاهل &nbsp; *<asp:Label id="lblTahol_Person" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_Tahol_Person"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">لطفا عنوان ستون ردیف اول اکسل برای فیلد مورد نظر را عینا با کپی آن عنوان درج نمائید</div></li></ul></a></li>
                                    <li> <asp:TextBox contenteditable="true"   tabindex="1"  onfocus="GraphicalBorder('container_Tahol_Person');" onblur="GraphicalBorderRemove('container_Tahol_Person');" ID="Tahol_Person" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        
                        <div class ="ContainerTextBoxObject">       
                            <div class="ContainerTextBoxCaption">مقدار مجرد &nbsp; *<asp:Label id="lblmojarad_person" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_mojarad_person"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">در فایل اکسل مقدار درج شده برای این فیلد است</div></li></ul></a></li>
                                    <li> <asp:TextBox contenteditable="true"   tabindex="1"  onfocus="GraphicalBorder('container_mojarad_person');" onblur="GraphicalBorderRemove('container_mojarad_person');" ID="mojarad_person" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        
                        <div class ="ContainerTextBoxObject">       
                            <div class="ContainerTextBoxCaption">مقدار متاهل &nbsp; *<asp:Label id="lblmotaahel_person" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_motaahel_person"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">در فایل اکسل مقدار درج شده برای این فیلد است</div></li></ul></a></li>
                                    <li> <asp:TextBox contenteditable="true"   tabindex="1"  onfocus="GraphicalBorder('container_motaahel_person');" onblur="GraphicalBorderRemove('container_motaahel_person');" ID="motaahel_person" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class ="ContainerTextBoxObject">       
                            ...
                            <div class="ContainerTextBoxStyle">
                                ...
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">لطفا عنوان ستون ردیف اول اکسل برای فیلد مورد نظر را عینا با کپی آن عنوان درج نمائید</div></li></ul></a></li>
                                    <li> <asp:TextBox contenteditable="true"   tabindex="1"  onfocus="GraphicalBorder('container_birthdate_Person');" onblur="GraphicalBorderRemove('container_birthdate_Person');" ID="birthdate_Person" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class ="ContainerTextBoxObject">       
                            ...
                            <div class="ContainerTextBoxStyle">
                                ...
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">لطفا عنوان ستون ردیف اول اکسل برای فیلد مورد نظر را عینا با کپی آن عنوان درج نمائید</div></li></ul></a></li>
                                    <li> <asp:TextBox contenteditable="true"   tabindex="1"  onfocus="GraphicalBorder('container_pleaceSodor_Person');" onblur="GraphicalBorderRemove('container_pleaceSodor_Person');" ID="pleaceSodor_Person" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        
                        <div class ="ContainerTextBoxObject">       
                            <div class="ContainerTextBoxCaption"> مدرک تحصیلی &nbsp; <asp:Label id="lbldoc_Person" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_doc_Person"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">لطفا عنوان ستون ردیف اول اکسل برای فیلد مورد نظر را عینا با کپی آن عنوان درج نمائید</div></li></ul></a></li>
                                    <li> <asp:TextBox contenteditable="true"   tabindex="1"  onfocus="GraphicalBorder('container_doc_Person');" onblur="GraphicalBorderRemove('container_doc_Person');" ID="doc_Person" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class ="ContainerTextBoxObject">       
                            ...
                            <div class="ContainerTextBoxStyle">
                                ...
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">لطفا عنوان ستون ردیف اول اکسل برای فیلد مورد نظر را عینا با کپی آن عنوان درج نمائید</div></li></ul></a></li>
                                    <li> <asp:TextBox contenteditable="true"   tabindex="1"  onfocus="GraphicalBorder('container_meli_Person');" onblur="GraphicalBorderRemove('container_meli_Person');" ID="meli_Person" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class ="ContainerTextBoxObject">       
                            ...
                            <div class="ContainerTextBoxStyle">
                                ...
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">لطفا عنوان ستون ردیف اول اکسل برای فیلد مورد نظر را عینا با کپی آن عنوان درج نمائید</div></li></ul></a></li>
                                    <li> <asp:TextBox contenteditable="true"   tabindex="1"  onfocus="GraphicalBorder('container_no_Person');" onblur="GraphicalBorderRemove('container_no_Person');" ID="no_Person" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class ="ContainerTextBoxObject">       
                            ...
                            <div class="ContainerTextBoxStyle">
                                ...
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">لطفا عنوان ستون ردیف اول اکسل برای فیلد مورد نظر را عینا با کپی آن عنوان درج نمائید</div></li></ul></a></li>
                                    <li> <asp:TextBox contenteditable="true"   tabindex="1"  onfocus="GraphicalBorder('container_rowID_CostCenter');" onblur="GraphicalBorderRemove('container_rowID_CostCenter');" ID="rowID_CostCenter" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        
                        <div class ="ContainerTextBoxObject">       
                            <div class="ContainerTextBoxCaption"> آدرس &nbsp; <asp:Label id="lbladdress_Person" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_address_Person"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">لطفا عنوان ستون ردیف اول اکسل برای فیلد مورد نظر را عینا با کپی آن عنوان درج نمائید</div></li></ul></a></li>
                                    <li> <asp:TextBox contenteditable="true"   tabindex="1"  onfocus="GraphicalBorder('container_address_Person');" onblur="GraphicalBorderRemove('container_address_Person');" ID="address_Person" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class ="ContainerTextBoxObject">       
                            ...
                            <div class="ContainerTextBoxStyle">
                                ...
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">لطفا عنوان ستون ردیف اول اکسل برای فیلد مورد نظر را عینا با کپی آن عنوان درج نمائید</div></li></ul></a></li>
                                    <li> <asp:TextBox contenteditable="true"   tabindex="1"  onfocus="GraphicalBorder('container_phone_Person');" onblur="GraphicalBorderRemove('container_phone_Person');" ID="phone_Person" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class ="ContainerTextBoxObject">       
                            ...
                            <div class="ContainerTextBoxStyle">
                                ...
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">لطفا عنوان ستون ردیف اول اکسل برای فیلد مورد نظر را عینا با کپی آن عنوان درج نمائید</div></li></ul></a></li>
                                    <li> <asp:TextBox contenteditable="true"   tabindex="1"  onfocus="GraphicalBorder('container_mobile_Person');" onblur="GraphicalBorderRemove('container_mobile_Person');" ID="mobile_Person" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class ="ContainerTextBoxObject">       
                            ...
                            <div class="ContainerTextBoxStyle">
                                ...
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">لطفا عنوان ستون ردیف اول اکسل برای فیلد مورد نظر را عینا با کپی آن عنوان درج نمائید</div></li></ul></a></li>
                                    <li> <asp:TextBox contenteditable="true"   tabindex="1"  onfocus="GraphicalBorder('container_uid_Person');" onblur="GraphicalBorderRemove('container_uid_Person');" ID="uid_Person" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        
                        <div class ="ContainerTextBoxObject">       
                            <div class="ContainerTextBoxCaption">پسورد &nbsp; *<asp:Label id="lblpwd_Person" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_pwd_Person"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">لطفا عنوان ستون ردیف اول اکسل برای فیلد مورد نظر را عینا با کپی آن عنوان درج نمائید</div></li></ul></a></li>
                                    <li> <asp:TextBox contenteditable="true"   tabindex="1"  onfocus="GraphicalBorder('container_pwd_Person');" onblur="GraphicalBorderRemove('container_pwd_Person');" ID="pwd_Person" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class ="ContainerTextBoxObject">       
                            ...
                            <div class="ContainerTextBoxStyle">
                                ...
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">لطفا عنوان ستون ردیف اول اکسل برای فیلد مورد نظر را عینا با کپی آن عنوان درج نمائید</div></li></ul></a></li>
                                    <li> <asp:TextBox contenteditable="true"   tabindex="1"  onfocus="GraphicalBorder('container_email_Person');" onblur="GraphicalBorderRemove('container_email_Person');" ID="email_Person" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
...
<script  type ="text/javascript" >
    document.getElementById("Pic_ContactUs").onchange = function() {
