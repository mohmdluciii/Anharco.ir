...
<head id="Head1" runat="server">
    <title>Design services - ANHAR Company</title>
     ...
     <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" TargetControlID="txt_Search" ServiceMethod="Buscar" ServicePath="AutoCompletar.asmx" MinimumPrefixLength="2" CompletionInterval="1000" EnableCaching="true" CompletionSetCount="12"   CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"></asp:AutoCompleteExtender>  
        ...
        <div class ="backMobileMenu" id="mobileMenu4"  style ="display:none;">
           ...
           <div class ="mainScreenLayer">    
            ...
            <div class ="MessageCEO_HeaderTextContainer"><h1 class="<%=SiteStudioStore.AlignClass("copy_DesignServices_h1")%>"><%=SiteStudioStore.Copy("copy_DesignServices_h1", "Engineering services")%></h1> </div>
            <div class ="MessageCEO_Box5Container" style="top:-250px;background :#fff;margin-top :0;margin-bottom :0;margin :0;">
                <div class ="MessageCEO_inner" style="top:0px;bmargin-top:0px;margin :0;">
                    
                    <div class ="box" style="top:-10px;">
                        <img src="<%=SiteStudioStore.Asset("pic_DesignInner")%>" />
                    </div>
                    <div class ="box">  
                        <p class="<%=SiteStudioStore.AlignClass("copy_DesignServices_p1")%>" style ="color:#000;"><%=SiteStudioStore.Copy("copy_DesignServices_p1", "Engineering phase:")%></p>
                        <p style ="color:#000;"><i class ="fa fa-chevron-right" style="font-size:14pt;color:#000;margin-right :10px;"></i>Designing documents documents and maps needed for future designs</p>
                        <p style ="color:#000;"><i class ="fa fa-chevron-right" style="font-size:14pt;color:#000;margin-right :10px;"></i>Preparation of requests and purchase documents for equipment goods and materials</p>
                        <p style ="color:#000;"><i class ="fa fa-chevron-right" style="font-size:14pt;color:#000;margin-right :10px;"></i>Designing documents and technical drawings related to the installation of equipment</p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_DesignServices_p5")%>" style ="color:#000;"><i class ="fa fa-chevron-right" style="font-size:14pt;color:#000;margin-right :10px;"></i><%=SiteStudioStore.Copy("copy_DesignServices_p5", "Designing technical documents and maps related to the implementation of activities")%></p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_DesignServices_p6")%>" style ="color:#000;"><%=SiteStudioStore.Copy("copy_DesignServices_p6", "In the engineering phase the progress of the project is usually planned and controlled based on the design stages and the number of man-hours required to complete the design. pointed out")%></p>
                    </div>
                </div>
            </div>
