<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="sessionPerson_frm1.aspx.vb" Inherits="W_ISM.sessionPerson_frm1" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><i class="fa fa-chevron-left arrow"></i><a href="#">درباره ما</a><i class="fa fa-chevron-left arrow"></i><a href="#">پرسنل جلسه</a><i class="fa fa-chevron-left arrow"></i><a>درج</a></div>
        ...
        <div class="formBox">
            ...
            <div class="containerForm">
                ...
                <div class="InterBoxFormLeft">
                    <ul>
                        <li>
                            <a class ="LinkIcon" href="sessionPerson_list1.aspx?rowID_Session=<%=request.QueryString("rowID_Session") %>"><i class="fa  fa-pencil"></i></a>
                            <ul>
                ...
                <div class="InterBoxFormRight" >
                    ...
                    <div class="bodyForm">
                        ...
                        <div class ="ContainerTextBoxObject" style="width:100%;text-align :right ;">
                            <div class="ContainerTextBoxCaption"><asp:Label id="lblPerson" runat ="server" class="errStyle" ></asp:Label></div>
