<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Card_Rep.aspx.vb" Inherits="W_ISM.Card_Rep" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><a href="#">تماس با ما</a><i class="fa fa-chevron-left arrow"></i><a href="#">گزارش صدور کارت</a><i class="fa fa-chevron-left arrow"></i><a>لیست</a></div>
        
        <div class="formBox">
            
            <div class="containerForm" style="position:relative ;left:0px;width:100%;">
                ...
                <div class="InterBoxFormRight" >
                  ...
                  <div class="SaveBoxContainer" id="saveContainer">
                    <div class ="SaveBox" id="saveDialog" style="top:5%">
                        ...
                        <input type="button" value="تایید" onclick="window.open('Card_Rep.aspx','_top');" /> 
                    </div>
                  </div>
                    <div class="headForm_List" >
                       <a class="ExcelIcon" href="showExcel.aspx?page=Card_Rep" target="_blank" title ="خروجی اکسل"><i class="fa fa-file-excel-o"></i></a>
                        
                    </div>
                    
                    <div class="bodyForm">
                        <p style="position :relative ;top:0px;left:0px;width :100%;float:right ;direction:rtl;font-size:10pt;font-family:yekan,arial;text-align :right;padding-right :20px;margin-top :10px"><a style ="width :50px;display:inline-block "> </a> &nbsp;<asp:Button ID="btnShow" style="position:relative ;float:left;margin-left :40px;" runat ="server" Font-Names ="tahoma" Height ="30" Width ="180" Text ="نمایش در اکسل" OnClientClick ="window.open('showExcel.aspx','_blank')" /></p>
