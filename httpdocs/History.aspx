...
<head id="Head1" runat="server">
    <title>History- ANHAR Company</title>
           ...
           <div class ="mainScreenLayer">    
            ...
            <div class ="MessageCEO_Box1Container">
                <div class ="MessageCEO_inner">
                    <div class ="box">
                        <p>Currently, after half a century of tireless efforts in the development and progress of our beloved country, Iran, this company has become a great honor for Anhar family, and it is hoped that with the support of this family’s efforts, such a great family will change from a private company to a company with many shareholders and become a public joint stock Co.</p>
                    </div>
                    <div class ="box">
            ...
            <div class ="MessageCEO_Box5Container">
                <div class ="MessageCEO_inner">
                    ...
                    <div class ="box">  
                        <p>The vision of this company is to increase its capabilities and become a reliable company in the export of engineering, purchasing and implementation services in the oil, gas, petrochemical and water industries in the next 5 years, and in this regard, it will provide a wide range of the following services:</p>
                        <p><i class ="fa fa-chevron-right" style="font-size:14pt;color:#fff;margin-right :10px;"></i>Management and implementation of construction projects</p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_History_p5")%>"><i class ="fa fa-chevron-right" style="font-size:14pt;color:#fff;margin-right :10px;"></i><%=SiteStudioStore.Copy("copy_History_p5", "Participation in the implementation, installation and commissioning of EPC projects")%></p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_History_p6")%>"><i class ="fa fa-chevron-right" style="font-size:14pt;color:#fff;margin-right :10px;"></i><%=SiteStudioStore.Copy("copy_History_p6", "Engineering management, and supply and procurement of projects")%></p>
                        <p><i class ="fa fa-chevron-right" style="font-size:14pt;color:#fff;margin-right :10px;"></i>Providing technical and engineering services as a strategic goal</p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_History_p8")%>"><%=SiteStudioStore.Copy("copy_History_p8", "ANHAR, as an executive and engineering company in the fields of oil, gas and petrochemicals, water, construction and infrastructure, and road, has carried out plenty of projects in all parts of the country in the field of design, implementation, supply of goods and installation and operation of Gas pressure booster stations has completed the repair yards between oil and gas transmission lines and pipelines and is trusted by many employers active in these fields.")%></p>
                    </div>
                </div>
            </div>
            ...
            <div class ="MessageCEO_Box2Container">
                <div class ="MessageCEO_inner">
                    ...
                    <div class ="box">  
                        <p class="<%=SiteStudioStore.AlignClass("copy_History_p9")%>"><%=SiteStudioStore.Copy("copy_History_p9", "It is hoped that in the future, the third generation of managers of Anhar Company, like the managers of the second generation, who with great ideas and motivations migrated the company from a regional firm to a company with high executive power throughout Iran, by expanding the geographical scope of the company’s activities, guide the activities of the company beyond the national borders and towards the presence in international arenas.")%></p>
                    </div>
                </div>
            </div>
