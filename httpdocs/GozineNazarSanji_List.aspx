<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GozineNazarSanji_List.aspx.vb" Inherits="W_ISM.GozineNazarSanji_List" %>
...
<head id="Head1" runat="server">
   ...
   <script type="text/javascript" src="JS/1.6.2/jquery.min.js"></script>
    ...
    .ModalBackground
    {
	    ...
	    filter:alpha(opaGozineNazarSanji=50);
	    -moz-opaGozineNazarSanji:0.5;
	    -khtml-opaGozineNazarSanji: 0.5;
	    opaGozineNazarSanji: 0.5;
    }
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><a href="#">تماس با ما</a><i class="fa fa-chevron-left arrow"></i><a href="#">گزینه های نظر سنجی</a><i class="fa fa-chevron-left arrow"></i><a>لیست</a></div>
        ...
        <div class="formBox">
            ...
            <div class="containerForm">
                ...
                <div class="InterBoxFormLeft">
                    <ul>
                        <li>
                            <a class ="LinkIcon" href="GozineNazarSanji_frm.aspx"><i class="fa  fa-pencil"></i></a>
                            <ul>
                ...
                <div class="InterBoxFormRight" >
                  ...
                  <div class="SaveBoxContainer" id="saveContainer">
                    <div class ="SaveBox" id="saveDialog" style="top:5%">
                        ...
                        <input type="button" value="تایید" onclick="window.open('GozineNazarSanji_List.aspx','_top');" /> 
                    </div>
                  </div>
                    <div class="headForm_List" >
                        <a class="ExcelIcon" href="showExcel.aspx?page=GozineNazarSanji_List" target="_blank" title ="خروجی اکسل"><i class="fa fa-file-excel-o"></i></a>
                    </div>
                    
                    <div class="bodyForm">
                        <p style="position :relative ;top:0px;left:0px;width :100%;float:right ;direction:rtl;font-size:10pt;font-family:yekan,arial;text-align :right;padding-right :20px;margin-top :10px"><a style ="width :50px;display:inline-block ">سوال </a> &nbsp;<asp:DropDownList class="Combo_InList" runat ="server" dir="rtl" ID="cmb_rowID_NazarSanji" width="200" AutoPostBack="True"></asp:DropDownList></p>
                        <p style="position :relative ;top:0px;left:0px;width :100%;float:right ;direction:rtl;font-size:10pt;font-family:yekan,arial;text-align :right;padding-right :20px;margin-top :10px"><asp:Label Font-Names="tahoma" Font-Size="8pt"   runat ="server" ID="showQuestion" style="text-align:right" dir="rtl"></asp:Label></p> 
