<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="InternationalArena.aspx.vb" Inherits="W_ISM.InternationalArena" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" dir="ltr">
<head id="Head1" runat="server">
    <title>Presence at International Arena - ANHAR Company</title>
     ...
     <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" TargetControlID="txt_Search" ServiceMethod="Buscar" ServicePath="AutoCompletar.asmx" MinimumPrefixLength="2" CompletionInterval="1000" EnableCaching="true" CompletionSetCount="12"   CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"></asp:AutoCompleteExtender>  
        ...
        <div class ="backMobileMenu" id="mobileMenu4"  style ="display:none;">
           ...
           <div class ="mainScreenLayer">    
            ...
            <div class ="MessageCEO_SlideContainer" style="<%=SiteStudioStore.BgStyle("hero_InternationalArena")%>">
            ...
            <div class ="MessageCEO_HeaderTextContainer"><h1 class="<%=SiteStudioStore.AlignClass("copy_InternationalArena_h1")%>"><%=SiteStudioStore.Copy("copy_InternationalArena_h1", "Presence at International Arena")%></h1> </div>
            <div class ="MessageCEO_topTextContainer">
                <p class="<%=SiteStudioStore.AlignClass("copy_InternationalArena_p1")%>"><%=SiteStudioStore.Copy("copy_InternationalArena_p1", "One of the aspects of the excellence of companies active in the field of oil, gas and petrochemicals is the development of scientific and economic relations in the international arena. " & Environment.NewLine & "In this regard, as some of Anhar company’s presences in the international arena, this company has considered attending international exhibitions and establishing representative offices in the countries of the Middle East. " & Environment.NewLine & "Participation in oil and gas and petrochemical exhibitions in Tehran, participation in the exhibition of Iranian production and industrial capabilities in Turkmenistan, participation in the international exhibition of oil, gas and petrochemical and refinery industries in Pakistan (which is one of the crude oil producing countries in the western Asia region) as per the invitation of National Iranian Gas Engineering and Development Company (NIGEC) in 2022.")%></p>
            </div>
            <div class ="MessageCEO_TopLogoType">
                <img src="<%=SiteStudioStore.Asset("pic_ApexLogo")%>" alt="Apex Group Co" />
            </div>
            
            <div class ="MessageCEO_Box1Container">
                <div class ="MessageCEO_inner">
                    <div class ="box">
                        <p> In addition, Anhar Co. has registered and set up a branch in the UAE in order to strengthen the supply of goods and equipment in the company's projects. With the establishment of this branch, it has been possible to supply specialized goods for projects from international companies. NOVOIL TRADING Co. Registered in the UAE, it is one of the subsidiary companies of Anhar Co. to carry out cross-border commercial activities, which has so far concluded several contracts with foreign manufacturers/suppliers.</p>
                    </div>
                    <div class ="box">
                        <img src="<%=SiteStudioStore.Asset("pic_International1")%>" />
                    </div>
                </div>
            </div>
            ...
            <div class ="MessageCEO_Box5Container">
                <div class ="MessageCEO_inner">
                    ...
                    <div class ="box">
                        <img src="<%=SiteStudioStore.Asset("pic_International2")%>" />
                    </div>
                    <div class ="box">  
                        <p class="<%=SiteStudioStore.AlignClass("copy_InternationalArena_p3")%>"><%=SiteStudioStore.Copy("copy_InternationalArena_p3", "During the measures taken, Anhar Co. has succeeded in obtaining its qualifications in the Iraqi Companies Registration Office and the Iraqi Ministry of Oil, and by reopening its office in Baghdad and using active human forces, this company is taking construction projects in the neighboring country Iraq.")%></p>
                    </div>
                </div>
            </div>
