<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CustomerSP_Edit.aspx.vb" Inherits="W_ISM.CustomerSP_Edit" %>
   ...
   <script type="text/javascript" src="JS/1.6.2/jquery.min.js"></script>
    ...
    <script>
        $(function() {
            ...
            $('#sdate_CustomerSp').calendarsPicker({ calendar: calendar });
            $('#edate_CustomerSp').calendarsPicker({ calendar: calendar });
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        ...
        <div class="titleForm"><i class="fa fa-user-circle-o icon"></i><a href="#">مشتری</a><i class="fa fa-chevron-left arrow"></i><i class="fa fa-pencil-square icon"></i><a href="#">تبلیغات مشتریان</a><i class="fa fa-chevron-left arrow"></i><a>ویرایش</a></div>
            ...
            <div class="containerForm">
                ...
                <div class="DeleteBoxContainer" id="DeleteBoxContainer" onclick="closeDeleteDialog();">
                    <div class ="DeleteBox" id="DeleteBox">
                       <iframe src="Company_Delete.aspx?rowID_Company=<%=request.QueryString("rowID_Company") %>" frameborder="0"></iframe>
                    </div>
                </div>
                ...
                <div class="InterBoxFormLeft">
                    <ul>
                        <li>
                            <a class ="LinkIcon" href="Company_List.aspx"><i class="fa  fa-pencil"></i></a>
                            <ul>
                ...
                <div class="InterBoxFormRight" >
                    <div class="headForm" >
                        ...
                        <a href="#" onclick="ShowDelete();" title ="حذف اطلاعات" id="btnNew_top" runat ="server" ><i class="fa fa-trash-o"></i></a>
                    </div>
            
                    <div class="bodyForm">
                       
                       <div class ="ContainerTextBoxObject" >
                            <div class="ContainerTextBoxCaption">عنوان&nbsp;*  <asp:Label id="lblname_CustomerSp" runat ="server"  class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_name_CustomerSp"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">لطفا عنوانی که قصد دارید تبلیغ شما نمایش داده شود را درج نمائید.</div></li></ul></a></li>
                                    <li> <asp:TextBox tabindex="1"  onfocus="GraphicalBorder('container_name_CustomerSp');" onblur="GraphicalBorderRemove('container_name_CustomerSp');" ID="name_CustomerSp" AutoComplete="off" runat ="server"  MaxLength="100"  ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                    
                        <div class ="ContainerTextBoxObject" >
                            <div class="ContainerTextBoxCaption">خلاصه&nbsp;*  <asp:Label id="lblshort_CustomerSp" runat ="server"  class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_short_CustomerSp"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">خلاصه ای در خصوص مورد تبلیغی شما در یک خط که باید درج شود. </div></li></ul></a></li>
                                    <li> <asp:TextBox tabindex="2"  onfocus="GraphicalBorder('container_short_CustomerSp');" onblur="GraphicalBorderRemove('container_short_CustomerSp');" ID="short_CustomerSp" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                    
                        <div class ="ContainerTextBoxObject" >
                            <div class="ContainerTextBoxCaption">لینک&nbsp;*  <asp:Label id="lbllink_CustomerSp" runat ="server"  class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_link_CustomerSp"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">لینک کاملی است که بازدیدکننده تبلیغ با کلیک به آن ارجاع می شود. </div></li></ul></a></li>
                                    <li> <asp:TextBox tabindex="2"  onfocus="GraphicalBorder('container_link_CustomerSp');" onblur="GraphicalBorderRemove('container_link_CustomerSp');" ID="link_CustomerSp" AutoComplete="off" runat ="server"  style="text-align :left ;direction:ltr;"  ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        
                        <div class ="ContainerTextBoxObject" >
                            <div class="ContainerTextBoxCaption">تاریخ شروع &nbsp;*  <asp:Label id="lblsdate_CustomerSp" runat ="server"  class="errStyle" ></asp:Label></div>
                            
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_sdate_CustomerSp"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">تاریخی است که در آن تاریخ تبلیغ در سایت شروع به نمایش می شود</div></li></ul></a></li>
                                    <li> <asp:TextBox tabindex="3"  onfocus="GraphicalBorder('container_sdate_CustomerSp');" onblur="GraphicalBorderRemove('container_sdate_CustomerSp');" ID="sdate_CustomerSp" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        <div class ="ContainerTextBoxObject" >
                            <div class="ContainerTextBoxCaption">تاریخ پایان &nbsp;*  <asp:Label id="lbledate_CustomerSp" runat ="server"  class="errStyle" ></asp:Label></div>
                            
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_edate_CustomerSp"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">تاریخی است که در آن تاریخ تبلیغ در سایت پایان می یابد</div></li></ul></a></li>
                                    <li> <asp:TextBox tabindex="3"  onfocus="GraphicalBorder('container_edate_CustomerSp');" onblur="GraphicalBorderRemove('container_edate_CustomerSp');" ID="edate_CustomerSp" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                       
                        <div class ="ContainerTextBoxObject" >
                            <div class="ContainerTextBoxCaption">تصویر  &nbsp;  <asp:Label id="lblpic_CustomerSp" runat ="server"  class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_pic_CustomerSp"></div>
                                <ul class="ContainerQuotation">
...
<script  type ="text/javascript" >
    document.getElementById("Pic_Company").onchange = function() {
