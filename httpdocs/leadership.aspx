<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="leadership.aspx.vb" Inherits="Safe_leadership" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" lang="en" dir="ltr">
<head id="Head1" runat="server">
    <title>Anhar Leadership</title>
      <link href="graphic/BodyGraphic.css?v=leadStick8" rel="stylesheet" />
     ...
     <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" TargetControlID="txt_Search" ServiceMethod="Buscar" ServicePath="AutoCompletar.asmx" MinimumPrefixLength="2" CompletionInterval="1000" EnableCaching="true" CompletionSetCount="12"   CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"></asp:AutoCompleteExtender>  
        ...
        <div class ="backMobileMenu" id="mobileMenu4"  style ="display:none;">
           ...
           <div class ="mainScreenLayer">    
            ...
            <div class ="MessageCEO_SlideContainer" style="<%=SiteStudioStore.BgStyle("hero_leadership")%>">
            ...
            <div class ="MessageCEO_HeaderTextContainer"><h1 class="<%=SiteStudioStore.AlignClass("copy_leadership_h1")%>"><%=SiteStudioStore.Copy("copy_leadership_h1", "Anhar Leadership")%></h1> </div>
            <div class ="leadershipMainpage">
               <div class="leadershipStick swiper">
               <div class="swiper-wrapper">
               <div class="swiper-slide">
                    <div class="leadCard">
                    <div class ="boxPic"><img src="<%=SiteStudioStore.Asset("pic_leadership1")%>" alt="" <%=SiteStudioStore.ImgFitStyle("pic_leadership1")%> /></div>
                    <div class ="boxText">
                        <p class="leadName <%=SiteStudioStore.AlignClass("copy_leadership_1_name")%>"><%=SiteStudioStore.Copy("copy_leadership_1_name", "Masoud Moazami")%></p>
                        <p class="leadRole <%=SiteStudioStore.AlignClass("copy_leadership_1_role")%>"><%=SiteStudioStore.Copy("copy_leadership_1_role", "Chairman of the Board of Directors")%></p>
                    </div>
                    </div>
               </div>
               <div class="swiper-slide">
                    <div class="leadCard">
                    <div class ="boxPic"><img src="<%=SiteStudioStore.Asset("pic_leadership2")%>" alt="" <%=SiteStudioStore.ImgFitStyle("pic_leadership2")%> /></div>
                    <div class ="boxText">
                        <p class="leadName <%=SiteStudioStore.AlignClass("copy_leadership_2_name")%>"><%=SiteStudioStore.Copy("copy_leadership_2_name", "Sattar Azizian Tafti")%></p>
                        <p class="leadRole <%=SiteStudioStore.AlignClass("copy_leadership_2_role")%>"><%=SiteStudioStore.Copy("copy_leadership_2_role", "CEO and Member of the Board of Directors")%></p>
                    </div>
                    </div>
               </div>
               <div class="swiper-slide">
                    <div class="leadCard">
                    <div class ="boxPic"><img src="<%=SiteStudioStore.Asset("pic_leadership4")%>" alt="" <%=SiteStudioStore.ImgFitStyle("pic_leadership4")%> /></div>
                    <div class ="boxText">
                        <p class="leadName <%=SiteStudioStore.AlignClass("copy_leadership_3_name")%>"><%=SiteStudioStore.Copy("copy_leadership_3_name", "Akbar Eshraghi")%></p>
                        <p class="leadRole <%=SiteStudioStore.AlignClass("copy_leadership_3_role")%>"><%=SiteStudioStore.Copy("copy_leadership_3_role", "Financial Director and Vice Chairman of the Board of Directors")%></p>
                    </div>
                    </div>
               </div>
               <div class="swiper-slide">
                    <div class="leadCard">
                    <div class ="boxPic"><img src="<%=SiteStudioStore.Asset("pic_leadership3")%>" alt="" <%=SiteStudioStore.ImgFitStyle("pic_leadership3")%> /></div>
                    <div class ="boxText">
                        <p class="leadName <%=SiteStudioStore.AlignClass("copy_leadership_4_name")%>"><%=SiteStudioStore.Copy("copy_leadership_4_name", "Mojtaba Moazami")%></p>
                        <p class="leadRole <%=SiteStudioStore.AlignClass("copy_leadership_4_role")%>"><%=SiteStudioStore.Copy("copy_leadership_4_role", "Member of the Board of Directors")%></p>
                    </div>
                    </div>
               </div>
               <div class="swiper-slide">
                    <div class="leadCard">
                    <div class ="boxPic"><img src="<%=SiteStudioStore.Asset("pic_leadership5")%>" alt="" <%=SiteStudioStore.ImgFitStyle("pic_leadership5")%> /></div>
                    <div class ="boxText">
                        <p class="leadName <%=SiteStudioStore.AlignClass("copy_leadership_5_name")%>"><%=SiteStudioStore.Copy("copy_leadership_5_name", "Negar Moazami")%></p>
                        <p class="leadRole <%=SiteStudioStore.AlignClass("copy_leadership_5_role")%>"><%=SiteStudioStore.Copy("copy_leadership_5_role", "Planning Manager and Project Control Manager and Board Member")%></p>
                    </div>
                    </div>
               </div>
               <div class="swiper-slide">
                    <div class="leadCard">
                    <div class ="boxPic"><img src="<%=SiteStudioStore.Asset("pic_leadership6")%>" alt="" <%=SiteStudioStore.ImgFitStyle("pic_leadership6")%> /></div>
                    <div class ="boxText">
                        <p class="leadName <%=SiteStudioStore.AlignClass("copy_leadership_6_name")%>"><%=SiteStudioStore.Copy("copy_leadership_6_name", "Mahdiar Sharif")%></p>
                        <p class="leadRole <%=SiteStudioStore.AlignClass("copy_leadership_6_role")%>"><%=SiteStudioStore.Copy("copy_leadership_6_role", "Commercial Director and Board Member")%></p>
                    </div>
                    </div>
               </div>
               </div>
...
<script src="JS/leadership-slider.js?v=leadStick1" type="text/javascript"></script>
