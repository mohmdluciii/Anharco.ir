<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Privacy.aspx.vb" Inherits="W_ISM.Privacy" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" lang="en" dir="ltr">
<head id="Head1" runat="server">
    <title>Privacy - ANHAR Company</title>
     ...
     <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" TargetControlID="txt_Search" ServiceMethod="Buscar" ServicePath="AutoCompletar.asmx" MinimumPrefixLength="2" CompletionInterval="1000" EnableCaching="true" CompletionSetCount="12"   CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"></asp:AutoCompleteExtender>  
        ...
        <div class ="backMobileMenu" id="mobileMenu4"  style ="display:none;">
           ...
           <div class ="mainScreenLayer">    
            ...
            <div class ="MessageCEO_SlideContainer" style="<%=SiteStudioStore.BgStyle("hero_Privacy")%>">
            ...
            <div class ="MessageCEO_HeaderTextContainer"><h1 class="<%=SiteStudioStore.AlignClass("copy_Privacy_h1")%>"><%=SiteStudioStore.Copy("copy_Privacy_h1", "Privacy")%></h1> </div>
            <div class ="MessageCEO_topTextContainer">
            
                <p class="<%=SiteStudioStore.AlignClass("copy_Privacy_p1")%>" style ="text-align :left;"><%=SiteStudioStore.Copy("copy_Privacy_p1", "ANHAR Company is committed to protecting the privacy of all visitors and we have prepared this privacy statement as part of our commitment to your privacy. As our customer, you can visit the ANHAR Company site without entering personal information on the global Internet. The amount of information we collect depends on the information you provide to us")%></p>
                <p class="<%=SiteStudioStore.AlignClass("copy_Privacy_p2")%>" style ="text-align :left;"><%=SiteStudioStore.Copy("copy_Privacy_p2", "By registering or requesting information on this site, you consent to the collection, use and transfer of your information in accordance with this policy.")%></p> 
            
                <p class="<%=SiteStudioStore.AlignClass("copy_Privacy_h2")%>" style="text-align :left;font-size :16pt;font-weight:700;"><i class ="fa fa-arrow-right" style="font-size :16pt;"></i><%=SiteStudioStore.Copy("copy_Privacy_h2", "Information we collect from you.")%></p>
                
                <p class="<%=SiteStudioStore.AlignClass("copy_Privacy_p3")%>" style ="text-align :left;"><%=SiteStudioStore.Copy("copy_Privacy_p3", "When visiting, you will be asked to enter information such as your name and contact information. We may also collect information about your use of the Site along with information you send us by mail or email.")%></p> 
                
                
                <p style="text-align :left;font-size :16pt;font-weight:700;">
                    <i class ="fa fa-arrow-right" style="font-size :16pt;"></i>
                    disclosure
                </p>
                
                <p class="<%=SiteStudioStore.AlignClass("copy_Privacy_p4")%>" style ="text-align :left;"><%=SiteStudioStore.Copy("copy_Privacy_p4", "The information you provide to us is stored on our secure servers. We may also share information collected about your use of our site with third parties, but this information does not include information that can be used to identify you.")%></p>
                <p class="<%=SiteStudioStore.AlignClass("copy_Privacy_p5")%>" style ="text-align :left;"><%=SiteStudioStore.Copy("copy_Privacy_p5", "Wherever you are provided with (or choose) a password that allows you to access certain parts of our site, you are responsible for maintaining and maintaining this password. We ask that you do not share this password with anyone.")%></p> 
                <p class="<%=SiteStudioStore.AlignClass("copy_Privacy_p6")%>" style ="text-align :left;"><%=SiteStudioStore.Copy("copy_Privacy_p6", "Unfortunately, the transfer of information through the Internet is not completely secure. Although we do our best to protect your personal information, we cannot guarantee the security of your information transmission. Therefore, any transfer will be your responsibility. Once we receive your information, we will use strict security measures to prevent unauthorized access to it.")%></p> 
                <p class="<%=SiteStudioStore.AlignClass("copy_Privacy_p7")%>" style ="text-align :left;"><%=SiteStudioStore.Copy("copy_Privacy_p7", "Countries outside the European Economic Community do not always have strong data protection laws. However, we will always endeavor to ensure that your information is used in accordance with this policy. Except as required by law, we do not sell, trade or distribute any part of the information you provide to us.")%></p> 
                
                <p class="<%=SiteStudioStore.AlignClass("copy_Privacy_p8")%>" style ="text-align :left;"><%=SiteStudioStore.Copy("copy_Privacy_p8", "Finally, if our business enters into a joint venture with, or is merged with or sold to, another entity, your information will be disclosed to the new partners or owners.")%></p> 
                
                <p class="<%=SiteStudioStore.AlignClass("copy_Privacy_h4")%>" style="text-align :left;font-size :16pt;font-weight:700;"><i class ="fa fa-arrow-right" style="font-size :16pt;"></i><%=SiteStudioStore.Copy("copy_Privacy_h4", "IPs and cookies")%></p>
                <p class="<%=SiteStudioStore.AlignClass("copy_Privacy_p9")%>" style ="text-align :left;"><%=SiteStudioStore.Copy("copy_Privacy_p9", "We may collect information about your computer, including your IP address, operating system and browser type, and use it for administrative and marketing purposes. It contains statistical data about your Internet search patterns and performance and cannot identify you.")%></p> 
                
                <p class="<%=SiteStudioStore.AlignClass("copy_Privacy_p10")%>" style ="text-align :left;"><%=SiteStudioStore.Copy("copy_Privacy_p10", "Cookies are small packets of information that we store on your computer. When you visit our site, our system stores cookies on your computer. Unless you objected when providing your information to us. The speed of cookies will increase the next time you visit the site. Also, cookies allow us to control and monitor site traffic and personalize site content for you. You can prevent the storage of cookies by enabling certain settings in your computer browser, in which case you may not be able to use certain features of our site.")%></p> 
                
                <p class="<%=SiteStudioStore.AlignClass("copy_Privacy_h5")%>" style="text-align :left;font-size :16pt;font-weight:700;"><i class ="fa fa-arrow-right" style="font-size :16pt;"></i><%=SiteStudioStore.Copy("copy_Privacy_h5", "Security and data protection")%></p>
                
                <p class="<%=SiteStudioStore.AlignClass("copy_Privacy_p11")%>" style ="text-align :left;"><%=SiteStudioStore.Copy("copy_Privacy_p11", "We use security measures to protect your information from unauthorized access and illegal activity, accidental damage, destruction and loss. We will retain your information as long as required by law.")%></p> 
                <p class="<%=SiteStudioStore.AlignClass("copy_Privacy_p12")%>" style ="text-align :left;"><%=SiteStudioStore.Copy("copy_Privacy_p12", "In certain cases, our site may contain electronic links to other sites. If you choose to visit these sites, their privacy policy and privacy preferences will apply.")%></p> 
                <p class="<%=SiteStudioStore.AlignClass("copy_Privacy_h6")%>" style="text-align :left;font-size :16pt;font-weight:700;"><i class ="fa fa-arrow-right" style="font-size :16pt;"></i><%=SiteStudioStore.Copy("copy_Privacy_h6", "Access and update")%></p>
                <p style ="text-align :left;">
                    You have the right to be aware of the information we hold about you and to ask us to make changes to it so that it is accurate and up-to-date. Let us know if you are interested in this topic.
                </p> 
                
                <p class="<%=SiteStudioStore.AlignClass("copy_Privacy_h7")%>" style="text-align :left;font-size :16pt;font-weight:700;"><i class ="fa fa-arrow-right" style="font-size :16pt;"></i><%=SiteStudioStore.Copy("copy_Privacy_h7", "Changes to our privacy policy")%></p>
                
                <p class="<%=SiteStudioStore.AlignClass("copy_Privacy_p14")%>" style ="text-align :left;"><%=SiteStudioStore.Copy("copy_Privacy_p14", "Any changes to our privacy policy will be posted on the site in the future and will be notified by email if necessary.")%></p> 
