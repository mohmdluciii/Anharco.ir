<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="building.aspx.vb" Inherits="Safe_building" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" lang="en" dir="ltr">
<head id="Head1" runat="server">
    <title>Construction and building -  ANHAR Company</title>
     ...
     <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" TargetControlID="txt_Search" ServiceMethod="Buscar" ServicePath="AutoCompletar.asmx" MinimumPrefixLength="2" CompletionInterval="1000" EnableCaching="true" CompletionSetCount="12"   CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"></asp:AutoCompleteExtender>  
        ...
        <div class ="backMobileMenu" id="mobileMenu4"  style ="display:none;">
           ...
           <div class ="mainScreenLayer">    
            ...
            <div class ="MessageCEO_SlideContainer" style="<%=SiteStudioStore.BgStyle("hero_building")%>">
            ...
            <div class ="MessageCEO_HeaderTextContainer"><h1 class="<%=SiteStudioStore.AlignClass("copy_building_h1")%>"><%=SiteStudioStore.Copy("copy_building_h1", "Construction and building")%></h1> </div>
            <div class ="MessageCEO_topTextContainer">
                <p class="<%=SiteStudioStore.AlignClass("copy_building_p1")%>"><%=SiteStudioStore.Copy("copy_building_p1", "ANHAR Company started its activity with the construction and school building projects and so far, relying on the certificate of contracting qualification in the field of construction and buildings, the experience of working in this area, and also with the help of its abilities and the use of expert engineers, this company has been successfully able to complete more than one hundred projects in the field of construction and buildings, including the construction of repair yards, the construction of schools in different cities of the country, the implementation of concrete skeleton, the construction of office and residential buildings, etc. Briefly, the names of some projects are represented as follows:")%></p>
            </div>
