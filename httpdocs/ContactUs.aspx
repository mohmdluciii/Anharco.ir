     ...
     <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" TargetControlID="txt_Search" ServiceMethod="Buscar" ServicePath="AutoCompletar.asmx" MinimumPrefixLength="2" CompletionInterval="1000" EnableCaching="true" CompletionSetCount="12"   CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"></asp:AutoCompleteExtender>  
        ...
        <div class ="backMobileMenu" id="mobileMenu4"  style ="display:none;">
           ...
           <div class ="mainScreenLayer">    
            ...
            <div class ="MessageCEO_HeaderTextContainer"><h1 class="<%=SiteStudioStore.AlignClass("copy_ContactUs_h1")%>"><%=SiteStudioStore.Copy("copy_ContactUs_h1", "Contact Us")%></h1> </div>
            <div class ="MessageCEO_topTextContainer">
                <p class="<%=SiteStudioStore.AlignClass("copy_ContactUs_h2")%>" style="text-align :left;font-size :16pt;font-weight:700;"><i class ="fa fa-arrow-right" style="font-size :16pt;"></i><%=SiteStudioStore.Copy("copy_ContactUs_h2", "Company information")%></p>
                <p style ="text-align :left;">
                     Name: Anhar Construction Co
                </p>
                <p style ="text-align :left;">
                    Type of Company: Private Joint Stock
                </p>
                <p style ="text-align :left;">
                     Date of Establishment: 1974-10-28
                </p>
                
                <p style ="text-align :left;">
                     Registration No. 149903
                </p>
                
                <p style ="text-align :left;">
                     National Identity No. 10260014510
                </p>
                
                <p style ="text-align :left;">
                     Economic Code: 411175119134
                </p>
                
                <p class="<%=SiteStudioStore.AlignClass("copy_ContactUs_h3")%>" style="text-align :left;font-size :16pt;font-weight:700;"><i class ="fa fa-arrow-right" style="font-size :16pt;"></i><%=SiteStudioStore.Copy("copy_ContactUs_h3", "Contact information")%></p>
                
                <p class="<%=SiteStudioStore.AlignClass("copy_ContactUs_p7")%>" style ="text-align :left;"><%=SiteStudioStore.Copy("copy_ContactUs_p7", "Address: No. 4, Alley 21, Zahedi Alley, Persepolis St., Persepolis Sq., Sheikh Bahaei St., Tehran. 1995775314, Iran")%></p>
                
                <p style ="text-align :left;">
                    Tel.: +98-21-41372
                </p> 
                
                <p class="<%=SiteStudioStore.AlignClass("copy_ContactUs_p10")%>" style ="text-align :left;"><%=SiteStudioStore.Copy("copy_ContactUs_p10", "Fax: +98-21-88600730")%></p> 
                

                
                <p class="<%=SiteStudioStore.AlignClass("copy_ContactUs_p11")%>" style ="text-align :left;"><%=SiteStudioStore.Copy("copy_ContactUs_p11", "Email: Info@anharco.ir")%></p> 
                
                <p class="<%=SiteStudioStore.AlignClass("copy_ContactUs_p12")%>" style ="text-align :left;"><%=SiteStudioStore.Copy("copy_ContactUs_p12", "Website: Anharepc.ir")%></p> 
                <p class="<%=SiteStudioStore.AlignClass("copy_ContactUs_p13")%>" style ="text-align :left;"><%=SiteStudioStore.Copy("copy_ContactUs_p13", "Instagram: AnharCompany")%></p>
                
                <p class="<%=SiteStudioStore.AlignClass("copy_ContactUs_p14")%>" style ="text-align :left;"><%=SiteStudioStore.Copy("copy_ContactUs_p14", "LinkedIn: AnharCompany")%></p>
