<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="OpenHoghogh_List.aspx.vb" Inherits="W_ISM.OpenHoghogh_List" %>
...
<head id="Head1" runat="server">
    <title>لیست فیش های حقوقی </title>
   ...
   <script type="text/javascript" src="JS/1.6.2/jquery.min.js"></script>
    ...
    .ModalBackground
    {
	    ...
	    filter:alpha(opaOpenHoghogh=50);
	    -moz-opaOpenHoghogh:0.5;
	    -khtml-opaOpenHoghogh: 0.5;
	    opaOpenHoghogh: 0.5;
    }
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><a href="#">عملیات پایه</a><i class="fa fa-chevron-left arrow"></i><a href="#">افتتاح فیش حقوقی</a><i class="fa fa-chevron-left arrow"></i><a>لیست</a></div>
        ...
        <div class="formBox">
            ...
            <div class="containerForm">
                ...
                <div class="InterBoxFormLeft">
                    <ul>
                        <li>
                            <a class ="LinkIcon" href="OpenHoghogh_frm.aspx"><i class="fa  fa-pencil"></i></a>
                            <ul>
                ...
                <div class="InterBoxFormRight" >
                  ...
                  <div class="SaveBoxContainer" id="saveContainer">
                    <div class ="SaveBox" id="saveDialog" style="top:5%">
                        ...
                        <input type="button" value="تایید" onclick="window.open('OpenHoghogh_List.aspx','_top');" /> 
                    </div>
                  </div>
                    <div class="headForm_List" >
                       <a class="ExcelIcon" href="showExcel.aspx?page=OpenHoghogh_List" target="_blank" title ="خروجی اکسل"><i class="fa fa-file-excel-o"></i></a>
                        <a class="ExcelIcon" href="Report.aspx?page=OpenHoghogh_List" target="_blank" title ="نسخه قابل چاپ"><i class="fa fa-print"></i></a>
                    </div>
                    
                    <div class="bodyForm">
                        <p style="position :relative ;top:0px;left:0px;width :100%;float:right ;direction:rtl;font-size:10pt;font-family:yekan,arial;text-align :right;padding-right :20px;margin-top :10px"><a style ="width :50px;display:inline-block ">سال </a> &nbsp;<asp:DropDownList class="Combo_InList" runat ="server" dir="rtl" ID="cmb_year_OpenHoghogh" width="200" AutoPostBack="True"></asp:DropDownList></p>
