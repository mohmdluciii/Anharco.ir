<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Rahnama_BimeTakmili_frm.aspx.vb" Inherits="W_ISM.Rahnama_BimeTakmili_frm" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><a href="#">مدیریت همکار</a><i class="fa fa-chevron-left arrow"></i><a href="#">راهنمای بیمه تکمیلی</a><i class="fa fa-chevron-left arrow"></i><a>درج</a></div>
                ...
                <div class="InterBoxFormRight" >
                    ...
                    <div class="bodyForm">
                        ...
                        <div class ="ContainerTextBoxObject" style="width :100%;">
                            <div class="ContainerTextBoxCaption"><asp:Label id="lblText_Rahnama_BimeTakmili" runat ="server"  class="errStyle" ></asp:Label></div>
                            <iframe  src="Editor_New_Large.aspx"  style ="width:90%;min-height:820px;visibility:visible;position:relative ;top:0px;right:0px;float:right " frameborder ="0" scrolling ="no" ></iframe>
                        </div>
