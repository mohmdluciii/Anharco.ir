<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="StatusAmar_frm.aspx.vb" Inherits="W_ISM.StatusAmar_frm" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><a href="#">تنظیمات</a><i class="fa fa-chevron-left arrow"></i><a href="#">وضعیت نمایش آمار</a><i class="fa fa-chevron-left arrow"></i><a>درج</a></div>
                ...
                <div class="InterBoxFormRight" >
                    ...
                    <div class="bodyForm">
                        ...
                        <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption"><asp:CheckBox ID="chk_amount_StatusAmar" runat ="server" Text ="عدم نمایش آمار" /></div>
                        </div>
