<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PM_frm1.aspx.vb" Inherits="W_ISM.PM_frm1" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><a href="#">راه اندازی سامانه</a><i class="fa fa-chevron-left arrow"></i><a href="#">واحد</a><i class="fa fa-chevron-left arrow"></i><a>درج</a></div>
        ...
        <div class="formBox">
            ...
            <div class="containerForm">
                ...
                <div class="InterBoxFormLeft">
                    <ul>
                        <li>
                            <a class ="LinkIcon" href="pm_List1.aspx"><i class="fa  fa-pencil"></i></a>
                            <ul>
                    ...
                    <ul>
                        <li>
                            <a class ="LinkIcon" href="pm_List1.aspx"><i class="fa  fa-trash"></i></a>
                            <ul>
                ...
                <div class="InterBoxFormRight" >
                    ...
                    <div class="bodyForm">
                     ...
                     <div class ="ContainerTextBoxObject">
                            ...
                            <div class="ContainerTextBoxCaption">نام واحد&nbsp; *<asp:Label id="lblName_PM" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_Name_PM"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">نام منحصری برای واحد تعمیر و نگهداری که قصد دارید تعریف کنید است.</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="1"  onfocus="GraphicalBorder('container_Name_PM');" onblur="GraphicalBorderRemove('container_Name_PM');" ID="Name_PM" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class ="ContainerTextBoxObject">        
                            <div class="ContainerTextBoxCaption">تلفن های تماس&nbsp; *<asp:Label id="lblPhone_PM" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_Phone_PM"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">تلفن های تماس با واحد تعمیر و نگهداری می باشد.</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="2"  onfocus="GraphicalBorder('container_Phone_PM');" onblur="GraphicalBorderRemove('container_Phone_PM');" ID="Phone_PM" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        
                       <div class ="ContainerTextBoxObject">        
                            <div class="ContainerTextBoxCaption">نشانی&nbsp; <asp:Label id="lblAddress_PM" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle ContainerTextBoxStyleTextEditor" >
                                <div class="effectContainerDiv"  id="container_Address_PM"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">آدرس واحد تعمیر و نگهداری برای دسترسی دیگر واحد ها به آن است.</div></li></ul></a></li>
                                    <li> <asp:TextBox class="ContainerTextBoxObjectTextEditor" tabindex="3" TextMode ="MultiLine"  onfocus="GraphicalBorder('container_Address_PM');" onblur="GraphicalBorderRemove('container_Address_PM');" ID="Address_PM" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        <div class ="ContainerTextBoxObject">        
                            <div class="ContainerTextBoxCaption">توضیحات&nbsp; <asp:Label id="lblDes_PM" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle ContainerTextBoxStyleTextEditor" >
                                <div class="effectContainerDiv"  id="container_Des_PM"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">توضیحات اضافه در مورد واحد تعمیر و نگهداری را می توانید درج کنید</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="4" class="ContainerTextBoxObjectTextEditor" TextMode ="MultiLine"   onfocus="GraphicalBorder('container_Des_PM');" onblur="GraphicalBorderRemove('container_Des_PM');" ID="Des_PM" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>             
