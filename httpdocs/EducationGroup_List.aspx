<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="EducationGroup_List.aspx.vb" Inherits="W_ISM.EducationGroup_List" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><a href="#">مدیریت همکار</a><i class="fa fa-chevron-left arrow"></i><a href="#">گروه آموزش</a><i class="fa fa-chevron-left arrow"></i><a>لیست</a></div>
        <div class="formBox">    
            <div class="containerForm">
                ...
                <div class="InterBoxFormLeft">
                    <ul>
                        <li>
                            <a class ="LinkIcon" href="EducationGroup_frm.aspx"><i class="fa  fa-pencil"></i></a>
                            <ul>
                ...
                <div class="InterBoxFormRight" >
                    <div class="headForm_List" >
                       <a class="ExcelIcon" href="showExcel.aspx?page=EducationGroup_List" target="_blank" title ="خروجی اکسل"><i class="fa fa-file-excel-o"></i></a>
