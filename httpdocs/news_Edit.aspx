<%@ Page Language="vb" ValidateRequest="false" AutoEventWireup="false" CodeBehind="news_Edit.aspx.vb" Inherits="Safe_news_Edit" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><a href="#">اطلاع رسانی</a><i class="fa fa-chevron-left arrow"></i><a href="#">اخبار و رویدادها</a><i class="fa fa-chevron-left arrow"></i><a>ویرایش</a></div>
            ...
            <div class="containerForm">
                ...
                <div class="DeleteBoxContainer" id="DeleteBoxContainer" onclick="closeDeleteDialog();">
                    <div class ="DeleteBox" id="DeleteBox">
                       <iframe src="news_Delete.aspx?rowID_news=<%=request.QueryString("rowID_news") %>" frameborder="0"></iframe>
                    </div>
                </div>
                ...
                <div class="InterBoxFormRight" >
                    ...
                    <div class="bodyForm">
                        <div class ="ContainerTextBoxObject">       
                            <div class="ContainerTextBoxCaption">عنوان خبر&nbsp;* <asp:Label id="lblTitle_News" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle" style="height:88px">
                                <div class="effectContainerDiv"  id="container_Title_News"></div>
                                <ul class="ContainerQuotation" >
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">عنوان خبر می باشد که حتما باید درج شود</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="1" style="height:80px" TextMode ="MultiLine"  onfocus="GraphicalBorder('container_Title_News');" onblur="GraphicalBorderRemove('container_Title_News');" ID="Title_News" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        <div class ="ContainerTextBoxObject">       
                            <div class="ContainerTextBoxCaption">خلاصه خبر&nbsp;* <asp:Label id="lblShort_News" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle" style="height:88px">
                                <div class="effectContainerDiv"  id="container_Short_News"></div>
                                <ul class="ContainerQuotation" >
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">خلاصه خبر می باشد که حتما باید درج شود</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="1" style="height:80px" TextMode ="MultiLine"  onfocus="GraphicalBorder('container_Short_News');" onblur="GraphicalBorderRemove('container_Short_News');" ID="Short_News" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        <div class ="ContainerTextBoxObject">       
                            <div class="ContainerTextBoxCaption">تاریخ انقضا&nbsp;* <asp:Label id="lblexpireDate_news" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle" >
                                <div class="effectContainerDiv"  id="container_expireDate_news"></div>
                                <ul class="ContainerQuotation" >
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">تاریخی که خبر از آرشیو حذف می شود</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="1"  TextMode ="MultiLine"  onfocus="GraphicalBorder('container_expireDate_news');" onblur="GraphicalBorderRemove('container_expireDate_news');" ID="expireDate_news" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class ="ContainerTextBoxObject" >
                            <div class="ContainerTextBoxCaption">تصویر  &nbsp;  <asp:Label id="lblPic_news" runat ="server"  class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                ...
                                <ul class="ContainerQuotation">
                                    ...
                                    <li><input id="uploadFile" tabindex="7"  placeholder="انتخاب فایل" disabled="disabled" class="fileUpload_Style" /><div class="upload-btn-wrapper"><a href="#"  class="btn" style="height :38px;position:relative ;top:2px;left:0px;margin :0;"><i class="fa  fa-upload"></i></a><asp:FileUpload  type="file" name="myfile" runat ="server"  id="Pic_news" /></div> </li>
                                </ul>
                            </div>
                        </div>
                        <div class ="ContainerTextBoxObject">       
                            <div class="ContainerTextBoxCaption"><asp:CheckBox ID="chk_Titr_News" runat ="server" Text ="خبر فوری" /></div>
...
<link rel="stylesheet" href="Calender/jquery.calendars.picker.css">
    ...
    <script>
        $(function() {
            ...
            $('#expireDate_news').calendarsPicker({ calendar: calendar });
        });
