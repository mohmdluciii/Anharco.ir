<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Session_frm1.aspx.vb" Inherits="W_ISM.Session_frm1" %>
...
<body style ="margin :0">
    ...
    <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server">
        <Services><asp:ServiceReference Path ="AutoCompleter_Processors.asmx" /></Services>
    </asp:ToolkitScriptManager>
     
     <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" TargetControlID="txtPerson" ServiceMethod="fetchDeviceNameProcessors" ServicePath="~/AutoCompleter_Processors.asmx"  MinimumPrefixLength="2" CompletionInterval="1000" EnableCaching="true" CompletionSetCount="12"  CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"></asp:AutoCompleteExtender>
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><a href="#">مدیریت همکار</a><i class="fa fa-chevron-left arrow"></i><a href="#">مدیریت جلسات</a><i class="fa fa-chevron-left arrow"></i><a>درج</a></div>
            ...
            <div class="containerForm" style="width:98%">
                ...
                <div class="InterBoxFormRight" >
                    ...
                    <div class="bodyForm">  
                        ...
                        <div class ="ContainerTextBoxObject" >
                            ...
                            <div class="ContainerTextBoxStyle" style="height:108px;">
                                ...
                                <ul class="ContainerQuotation">
                                    ...
                                    <li> <asp:TextBox tabindex="2" class="ContainerTextBoxObjectTextEditor" style="height:100px;"   TextMode ="MultiLine" onfocus="GraphicalBorder('container_Title_Session');" onblur="GraphicalBorderRemove('container_Title_Session');" ID="Title_Session" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class ="ContainerTextBoxObject" style="width:100%;text-align :right ;">
                            <p style="width :100%;font-size :10pt;font-family:yekan;">پرسنل دعوت شده به جلسه : <asp:TextBox ID="txtPerson" runat ="server" style="font-family:Yekan;font-size :10pt;text-align:right ;border-style :solid ;border-color :#EEEEEE;" AutoPostBack ="true" ></asp:TextBox></p>
...
<script>
    $(function() {
        ...
        $('#Date_Session').calendarsPicker({ calendar: calendar });
