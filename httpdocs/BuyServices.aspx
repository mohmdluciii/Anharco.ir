<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="BuyServices.aspx.vb" Inherits="Safe_BuyServices" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" lang="en" dir="ltr">
<head id="Head1" runat="server">
    <title>Equipment purchase services - ANHAR Company</title>
     ...
     <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" TargetControlID="txt_Search" ServiceMethod="Buscar" ServicePath="AutoCompletar.asmx" MinimumPrefixLength="2" CompletionInterval="1000" EnableCaching="true" CompletionSetCount="12"   CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"></asp:AutoCompleteExtender>  
        ...
        <div class ="backMobileMenu" id="mobileMenu1" style ="display:none;">
             <div class ="topMenuBox">
                ...
                <div class ="boxMenuMobile"><a href="MessageCEO.aspx">Chairmanman of the Board  Message</a></div>
        ...
        <div class ="backMobileMenu" id="mobileMenu4"  style ="display:none;">
           ...
           <div class ="mainScreenLayer">    
            ...
            <div class ="MessageCEO_SlideContainer" style="<%=SiteStudioStore.BgStyle("hero_BuyServices")%>">
                         ...
                         <ul>
                            <li><a onmouseover ="showBoxBackMenu();">About Us</a>
                                <ul id="obj-m-1">
                                    ...
                                    <li><a href="MessageCEO.aspx">Chairmanman of the Board  Message</a></li>
            ...
            <div class ="MessageCEO_HeaderTextContainer"><h1 class="<%=SiteStudioStore.AlignClass("copy_BuyServices_h1")%>"><%=SiteStudioStore.Copy("copy_BuyServices_h1", "Equipment purchase services")%></h1> </div>
            <div class ="MessageCEO_Box5Container" style="top:-250px;background :#fff;margin-top :0;margin-bottom :0;margin :0;">
                <div class ="MessageCEO_inner" style="top:0px;bmargin-top:0px;margin-bottom :0xp;margin :0;">
                    
                    <div class ="box" style="top:-10px;">
                        <img src="<%=SiteStudioStore.Asset("pic_BuyInner")%>" />
                    </div>
                    <div class ="box">  
                        <p class="<%=SiteStudioStore.AlignClass("copy_BuyServices_p1")%>" style ="color:#000;"><%=SiteStudioStore.Copy("copy_BuyServices_p1", "Procurement phase:")%></p>
                        <p style ="color:#000;"><i class ="fa fa-chevron-right" style="font-size:14pt;color:#000;margin-right :10px;"></i>Purchase manufacture supply and procurement of equipment goods and materials needed for project implementation from outside the project implementation organization.</p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_BuyServices_p3")%>" style ="color:#000;"><i class ="fa fa-chevron-right" style="font-size:14pt;color:#000;margin-right :10px;"></i><%=SiteStudioStore.Copy("copy_BuyServices_p3", "Supervision of sellers, manufacturers, and suppliers (Vendor or Supplier)")%></p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_BuyServices_p4")%>" style ="color:#000;"><i class ="fa fa-chevron-right" style="font-size:14pt;color:#000;margin-right :10px;"></i><%=SiteStudioStore.Copy("copy_BuyServices_p4", "Receiving equipment, goods, and materials from sellers, manufacturers, and suppliers")%></p>
                        
                        <p class="<%=SiteStudioStore.AlignClass("copy_BuyServices_p5")%>" style ="color:#000;"><%=SiteStudioStore.Copy("copy_BuyServices_p5", "In the procurement phase the progress of the project is usually planned and controlled based on the stages of purchase and cost (in some cases time or a combination of cost and time) necessary to complete the purchase. Among the activities of the purchase phase And procurement can refer to the construction and purchase of equipment and fittings.")%></p>
                    </div>
                </div>
            </div>
