<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ForgetPassword_Text_Edit1.aspx.vb" Inherits="W_ISM.ForgetPassword_Text_Edit1" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><a href="#">تنظیمات سایت</a><i class="fa fa-chevron-left arrow"></i><a href="#">مدیریت متن فراموشی کلمه عبوری</a><i class="fa fa-chevron-left arrow"></i><a>ویرایش</a></div>
            ...
            <div class="containerForm">
                ...
                <div class="DeleteBoxContainer" id="DeleteBoxContainer" onclick="closeDeleteDialog();">
                    <div class ="DeleteBox" id="DeleteBox">
                       <iframe src="ForgetPassword_Text_Delete1.aspx?rowID_ForgetPassword_Text=<%=request.QueryString("rowID_ForgetPassword_Text") %>" frameborder="0"></iframe>
                    </div>
                </div>
                <div class="InterBoxFormLeft">
                    <ul>
                        <li>
                            <a class ="LinkIcon" href="ForgetPassword_Text_List1.aspx"><i class="fa  fa-pencil"></i></a>
                            <ul>
                ...
                <div class="InterBoxFormRight" >
                    ...
                    <div class="bodyForm">
                        <div class ="ContainerTextBoxObject">                           
                            <div class="ContainerTextBoxCaption">متن فراموشی کلمه عبوری&nbsp; *<asp:Label id="lblname_ForgetPassword_Text" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle" style="height:208px;">
                                <div class="effectContainerDiv"  id="container_name_ForgetPassword_Text"></div>
                                <ul class="ContainerQuotation">
                                    ...
                                    <li> <asp:TextBox  tabindex="1" style="height:200px;" TextMode="MultiLine"   onfocus="GraphicalBorder('container_name_ForgetPassword_Text');" onblur="GraphicalBorderRemove('container_name_ForgetPassword_Text');" ID="name_ForgetPassword_Text" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
