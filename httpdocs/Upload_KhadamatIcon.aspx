<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Upload_KhadamatIcon.aspx.vb" Inherits="W_ISM.Upload_KhadamatIcon" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><a href="#">صفحه اصلی</a><i class="fa fa-chevron-left arrow"></i><a href="#"><asp:Label ID="lbl_Title" runat ="server"  Text ="مدیریت آیکون های خدمات" ></asp:Label></a><i class="fa fa-chevron-left arrow"></i><a>درج</a></div>
                ...
                <div class="InterBoxFormRight" >
                    ...
                    <div class="bodyForm">
                        <div class ="ContainerTextBoxObject">       
                            <div class="ContainerTextBoxCaption">نام&nbsp;* <asp:Label id="lblname_KhadamatIcon" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_name_KhadamatIcon"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">عنوان خدماتی است که روی آیکون نمایش داده می شود</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="1"  onfocus="GraphicalBorder('container_name_KhadamatIcon');" onblur="GraphicalBorderRemove('container_name_KhadamatIcon');" ID="name_KhadamatIcon" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        
                        <div class ="ContainerTextBoxObject">       
                            <div class="ContainerTextBoxCaption">لینک&nbsp;* <asp:Label id="lbllink_KhadamatIcon" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_link_KhadamatIcon"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">لینک خدماتی که قصد دارید کاربر سایت را به آن ارجاع دهید</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="1"  onfocus="GraphicalBorder('container_link_KhadamatIcon');" onblur="GraphicalBorderRemove('container_link_KhadamatIcon');" ID="link_KhadamatIcon" AutoComplete="off" runat ="server"   style="direction:ltr;text-align :left ;" ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class ="ContainerTextBoxObject" >
                            <div class="ContainerTextBoxCaption">انتخاب آیکون  &nbsp;  <asp:Label id="lblicon_KhadamatIcon" runat ="server"  class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_icon_KhadamatIcon"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">فایل آیکون است که در صورت وجود باید از هارد کامپیوتر انتخاب شود</div></li></ul></a></li>
                                    <li><input  id="uploadFile" tabindex="7"  placeholder="انتخاب فایل" disabled="disabled" class="fileUpload_Style" /><div class="upload-btn-wrapper"><a href="#"  class="btn" style="height :38px;position:relative ;top:2px;left:0px;margin :0;"><i class="fa  fa-upload"></i></a><asp:FileUpload accept="image/*"   type="file" name="myfile" runat ="server" onchange ="showPreview(event)"  id="icon_KhadamatIcon" /></div> </li>
                                </ul>
                            </div>
                        </div>
    ...
    <script type="text/javascript" src="JS/jquery-scrolltofixed.js"></script>
      ...
      <%--loading click--%>
        ...
        <div style="position:fixed;top:0px;left:0px;width :100%;height:100%;display:none;text-align :center ;background :rgb(0,0,0);background:rgba(0,0,0,0.8);z-index:1000000000000000000;background-repeat :no-repeat ;background-position :center center;justify-content:center;" id="objectPre" onclick="this.style.display='none';">
            <div style="position:relative ; width :70px;height:70px;border:2px dashed #fff;float :none;margin-left :auto ;margin-right :auto ;top:50%;margin-top :-35px;"></div>
        </div>
    </form>
...
<script  type ="text/javascript" >
    document.getElementById("icon_KhadamatIcon").onchange = function() {
