<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Goods_Edit1.aspx.vb" Inherits="W_ISM.Goods_Edit1" %>
            ...
            <div class="containerForm" style="width:98%">
                ...
                <div class="DeleteBoxContainer" id="DeleteBoxContainer" onclick="closeDeleteDialog();">
                    <div class ="DeleteBox" id="DeleteBox">
                       <iframe src="Goods_Delete1.aspx?rowID_Tajhizat=<%=request.QueryString("rowID_Tajhizat") %>" frameborder="0"></iframe>
                    </div>
                </div>
                <div class="InterBoxFormLeft">
                    <ul>
                        <li>
                            <a class ="LinkIcon" href="Goods_List1.aspx?f1=<%=request.QueryString("f1") %>"><i class="fa  fa-pencil"></i></a>
                            <ul>
