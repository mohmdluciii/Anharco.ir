<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Remove_Services_Request.aspx.vb" Inherits="W_ISM.Remove_Services_Request" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><a href="#">راه اندازی سامانه</a><i class="fa fa-chevron-left arrow"></i><a href="#">حذف درخواست های مراکز رفاهی</a><i class="fa fa-chevron-left arrow"></i><a>لیست</a></div>
                ...
                <div class="InterBoxFormRight" >
                  ...
                  <div class="SaveBoxContainer" id="saveContainer">
                    <div class ="SaveBox" id="saveDialog" style="top:5%">
                        ...
                        <input type="button" value="تایید" onclick="window.open('Remove_Services_Request.aspx','_top');" /> 
                    </div>
                  </div>
                    ...
                    <div class="bodyForm">
                        <p style="position :relative ;top:0px;left:0px;width :100%;float:right ;direction:rtl;font-size:10pt;font-family:yekan,arial;text-align :right;padding-right :20px;margin-top :10px"><a style ="width :50px;display:inline-block ">تاریخ از</a> &nbsp;<asp:TextBox class="TextBox_InList" ID="sDate" runat ="server" Width ="80" AutoComplete="off" Font-Names ="tahoma" Font-Size ="8pt" ></asp:TextBox></p>
                        <p style="position :relative ;top:0px;left:0px;width :100%;float:right ;direction:rtl;font-size:10pt;font-family:yekan,arial;text-align :right;padding-right :20px;margin-top :10px"><a style ="width :50px;display:inline-block ">تا تاریخ </a> &nbsp;<asp:TextBox class="TextBox_InList" ID="eDate" runat ="server" Width ="80" AutoComplete="off" Font-Names ="tahoma" Font-Size ="8pt" ></asp:TextBox>&nbsp;<asp:Button class="Button_InList" ID="btnSearch" runat ="server" Text ="حذف" Font-Names ="tahoma" Font-Size ="8pt" /></p>
