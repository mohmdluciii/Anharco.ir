...
<head id="Head1" runat="server">
    <title>Implementation services ANHAR Company</title>
     ...
     <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" TargetControlID="txt_Search" ServiceMethod="Buscar" ServicePath="AutoCompletar.asmx" MinimumPrefixLength="2" CompletionInterval="1000" EnableCaching="true" CompletionSetCount="12"   CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"></asp:AutoCompleteExtender>  
        ...
        <div class ="backMobileMenu" id="mobileMenu4"  style ="display:none;">
           ...
           <div class ="mainScreenLayer">    
            ...
            <div class ="MessageCEO_HeaderTextContainer"><h1 class="<%=SiteStudioStore.AlignClass("copy_OperationsServices_h1")%>"><%=SiteStudioStore.Copy("copy_OperationsServices_h1", "Implementation services")%></h1> </div>
           <div class ="MessageCEO_Box5Container" style="top:-250px;background :#fff;margin-top :0;margin-bottom :0;margin :0;">
                <div class ="MessageCEO_inner" style="top:0px;bmargin-top:0px;margin-bottom :0xp;margin :0;">
                    ...
                    <div class ="box">  
                        <p class="<%=SiteStudioStore.AlignClass("copy_OperationsServices_p1")%>" style ="color:#000;"><%=SiteStudioStore.Copy("copy_OperationsServices_p1", "Construction phase:")%></p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_OperationsServices_p2")%>" style ="color:#000;"><i class ="fa fa-chevron-right" style="font-size:14pt;color:#000;margin-right :10px;"></i><%=SiteStudioStore.Copy("copy_OperationsServices_p2", "Installation of equipment")%></p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_OperationsServices_p3")%>" style ="color:#000;"><i class ="fa fa-chevron-right" style="font-size:14pt;color:#000;margin-right :10px;"></i><%=SiteStudioStore.Copy("copy_OperationsServices_p3", "Implementation of activities")%></p>
                        
                        <p style ="color:#000;">In the construction phase the progress of the project is usually planned and controlled based on the volumes and values of the uted works and the installed values of the equipment. and installation of equipment drilling welding and piping.</p>
                    </div>
                </div>
            </div>
