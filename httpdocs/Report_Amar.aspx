<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Report_Amar.aspx.vb" Inherits="W_ISM.Report_Amar" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        ...
        <div class="titleForm"><a href="#">مدیریت سایت</a><i class="fa fa-chevron-left arrow"></i><a href="#">آمار بازدید سایت</a><i class="fa fa-chevron-left arrow"></i><a>لیست</a></div>
                ...
                <div class="InterBoxFormRight" >
                  ...
                  <div class="SaveBoxContainer" id="saveContainer">
                    <div class ="SaveBox" id="saveDialog" style="top:5%">
                        ...
                        <input type="button" value="تایید" onclick="window.open('Report_Amar.aspx','_top');" /> 
                    </div>
                  </div>
                    <div class="headForm_List" >
                       <a class="ExcelIcon" href="showExcel.aspx?page=Report_Amar" target="_blank" title ="خروجی اکسل"><i class="fa fa-file-excel-o"></i></a>
                        
                    </div>
                    
                    <div class="bodyForm">
                        <p style="position :relative ;top:0px;left:0px;width :100%;float:right ;direction:rtl;font-size:10pt;font-family:yekan,arial;text-align :right;padding-right :20px;margin-top :10px"><a style ="width :50px;display:inline-block ">تاریخ </a> &nbsp;<asp:TextBox class="TextBox_InList" ID="txtDate" runat ="server" Width ="80" AutoComplete="off" Font-Names ="tahoma" Font-Size ="8pt" ></asp:TextBox>&nbsp;<asp:Button class="Button_InList" ID="btnSearch" runat ="server" Text ="جستجو" Font-Names ="tahoma" Font-Size ="8pt" /></p>
...
<script type="text/javascript">
 ...
 <script type ="text/javascript" src="MyScript/MenuMobilePanel.js" ></script><%=Session("scriptDelete")%>
