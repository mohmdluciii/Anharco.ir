<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="MessageCEO.aspx.vb" Inherits="Safe_MessageCEO" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" lang="en" dir="ltr">
<head id="Head1" runat="server">
    <title>Chairman of the Board  - ANHAR Company</title>
     ...
     <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" TargetControlID="txt_Search" ServiceMethod="Buscar" ServicePath="AutoCompletar.asmx" MinimumPrefixLength="2" CompletionInterval="1000" EnableCaching="true" CompletionSetCount="12"   CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"></asp:AutoCompleteExtender>  
        ...
        <div class ="backMobileMenu" id="mobileMenu4"  style ="display:none;">
           ...
           <div class ="mainScreenLayer">    
            ...
            <div class ="MessageCEO_SlideContainer" style="<%=SiteStudioStore.BgStyle("hero_MessageCEO")%>">
            ...
            <div class ="MessageCEO_HeaderTextContainer"><h1 class="<%=SiteStudioStore.AlignClass("copy_MessageCEO_h1")%>"><%=SiteStudioStore.Copy("copy_MessageCEO_h1", "Chairman of the Board Message")%></h1> </div>
            <div class ="MessageCEO_topTextContainer">
                <p class="<%=SiteStudioStore.AlignClass("copy_MessageCEO_p1")%>" style="text-align :justify ;"><%=SiteStudioStore.Copy("copy_MessageCEO_p1", "For nearly fifty years since the beginning of our activity, we have truly believed that creating and gaining credit is achieved by adhering to our commitments with others. " & Environment.NewLine & "The founders of Anhar, with the approach of improving the level of literacy and culture in the society, succeeded in building more than a hundred educational and cultural units in the cities of Golpayegan, Khansar, Khomein and the surrounding villages, " & Environment.NewLine & "and we are pleased that after the years and successful presence in other fields, construction of the educational and cultural complexes in deprived areas is one of the company’s regular programs.")%></p>
            </div>
            <div class ="MessageCEO_TopLogoType">
                <img src="<%=SiteStudioStore.Asset("logotype")%>" alt="ANHAR Company" />
            </div>
            
            <div class ="MessageCEO_Box1Container">
                <div class ="MessageCEO_inner">
                    <div class ="box">
                        <p class="<%=SiteStudioStore.AlignClass("copy_MessageCEO_p2")%>"><%=SiteStudioStore.Copy("copy_MessageCEO_p2", "After going through many ups and downs and the changes of the Islamic Revolution era, by moving the head office to Tehran and receiving the qualification approval certificate from Iranian Planning and Budget Organization, we began to meet the conditions for entering the projects of National Gas Company, and over many years, the scope of this activity has expanded with various entities of the Ministry of Oil, such as National Petrochemical Company of Iran, National Iranian Oil Engineering and Construction Company (NIOEC), and the Iranian Oil Pipelines and Telecommunications Company.")%></p>
                    </div>
                    <div class ="box">
                        <img src="<%=SiteStudioStore.Asset("pic_MessageCEO1")%>" />
                    </div>
                </div>
            </div>
            
            
            <div class ="MessageCEO_Box2Container">
                <div class ="MessageCEO_inner">
                    
                    <div class ="box">
                        <img src="<%=SiteStudioStore.Asset("pic_MessageCEO2")%>" />
                    </div>
                    <div class ="box">  
                        <p class="<%=SiteStudioStore.AlignClass("copy_MessageCEO_p3")%>"><%=SiteStudioStore.Copy("copy_MessageCEO_p3", "I consider the achieved success to be the result of the round-the-clock efforts of all our dear colleagues in the great Anhar family of caring organizational employees, engineers, and experts, who in all difficult and hard conditions caused by international sanctions, the outbreak of the Corona pandemic, the sharp increase in prices and so on spared no efforts patiently and selflessly in implementing the projects committed by the company, and I hope that the young and passionate colleagues with the new management will record a great honor for themselves and our dear country Iran in the history of the country’s private sector.")%></p>
                    </div>
                </div>
            </div>
            
            
            <div class ="MessageCEO_Box3Container">
                <div class ="MessageCEO_inner">
                    <div class ="box">
                        <p>Anhar company is proud to support the efforts of all its loved employees in various ways. Increasing specialized knowledge and ability through the use of training centers, cooperation in providing free and interest-free facilities in order to increase the comfort and well-being of employees is defined in this direction.</p>
                    </div>
                    <div class ="box">
                        <img src="<%=SiteStudioStore.Asset("pic_MessageCEO3")%>" />
                    </div>
                </div>
            </div>
            
            
            <div class ="MessageCEO_Box4Container">
                <div class ="MessageCEO_inner">
                    
                    <div class ="box">
                        <img src="<%=SiteStudioStore.Asset("pic_MessageCEO4")%>" />
                    </div>
                    <div class ="box">  
                        <p class="<%=SiteStudioStore.AlignClass("copy_MessageCEO_p5")%>"><%=SiteStudioStore.Copy("copy_MessageCEO_p5", "As one of the pro-environmental companies, Anhar has an acceptable track record in the field of performing duties related to social responsibilities. Today, our land Iran is in great need of true servants who are committed to the preservation of its environment and social responsibilities.")%></p>
                    </div>
                </div>
            </div>
            ...
            <div class ="MessageCEO_Box5Container">
                <div class ="MessageCEO_inner">
                    ...
                    <div class ="box">
                        <img src="<%=SiteStudioStore.Asset("pic_MessageCEO5")%>" />
                    </div>
                    <div class ="box">  
                        <p class="<%=SiteStudioStore.AlignClass("copy_MessageCEO_p6")%>"><%=SiteStudioStore.Copy("copy_MessageCEO_p6", "At last, we honor the memory of 3 founders of the company who are not with us today:")%></p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_MessageCEO_p7")%>"><i class ="fa fa-chevron-right" style="font-size:14pt;color:#fff;margin-right :10px;"></i><%=SiteStudioStore.Copy("copy_MessageCEO_p7", "Mr. Mohammad Bagher MOAZZAMI")%></p>
                        <p><i class ="fa fa-chevron-right" style="font-size:14pt;color:#fff;margin-right :10px;"></i>Mr. Javad MOAZZAMI</p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_MessageCEO_p9")%>"><i class ="fa fa-chevron-right" style="font-size:14pt;color:#fff;margin-right :10px;"></i><%=SiteStudioStore.Copy("copy_MessageCEO_p9", "Mr. Mohammad Ali KHORRAMI")%></p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_MessageCEO_p10")%>"><%=SiteStudioStore.Copy("copy_MessageCEO_p10", "And with all pride, let’s continue their way and agreement in the direction of service and prosperity as much as possible and institutionalize this outstanding thinking into a common culture in the organization and the great family of Anhar.")%></p>
                    </div>
                </div>
            </div>
