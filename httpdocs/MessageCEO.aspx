        ...
        <div class ="backMobileMenu" id="mobileMenu4"  style ="display:none;">
           ...
           <div class ="mainScreenLayer">    
            ...
            <div class ="MessageCEO_topTextContainer">
                <p class="<%=SiteStudioStore.AlignClass("copy_MessageCEO_p1")%>" style="text-align :justify ;"><%=SiteStudioStore.Copy("copy_MessageCEO_p1", "For nearly fifty years since the beginning of our activity, we have truly believed that creating and gaining credit is achieved by adhering to our commitments with others. The founders of Anhar, with the approach of improving the level of literacy and culture in the society, succeeded in building more than a hundred educational and cultural units in the cities of Golpayegan, Khansar, Khomein and the surrounding villages, and we are pleased that after the years and successful presence in other fields, construction of the educational and cultural complexes in deprived areas is one of the company’s regular programs.")%></p>
            </div>
