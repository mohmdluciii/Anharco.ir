<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="UploadFile_VideoCustomer.aspx.vb" Inherits="W_ISM.UploadFile_VideoCustomer" %>
...
<body>
    ...
    <div class ="uploadFileMainBox" style="direction:rtl;">
        ...
        <asp:Button ID="btnDelete" style="margin-right :10px;"  Text="حذف فیلم" runat="server"   OnClientClick="StartProgressBar()" />
        </div> 
    </div>
