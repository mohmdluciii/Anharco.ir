<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GozineNazarSanji_Edit.aspx.vb" Inherits="W_ISM.GozineNazarSanji_Edit" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><a href="#">تماس با ما</a><i class="fa fa-chevron-left arrow"></i><a href="#">گزینه نظر سنجی</a><i class="fa fa-chevron-left arrow"></i><a>ویرایش</a></div>
            ...
            <div class="containerForm">
                ...
                <div class="DeleteBoxContainer" id="DeleteBoxContainer" onclick="closeDeleteDialog();">
                    <div class ="DeleteBox" id="DeleteBox">
                       <iframe src="GozineNazarSanji_Delete.aspx?rowID_GozineNazarSanji=<%=request.QueryString("rowID_GozineNazarSanji") %>" frameborder="0"></iframe>
                    </div>
                </div>
                ...
                <div class="InterBoxFormLeft">
                    <ul>
                        <li>
                            <a class ="LinkIcon" href="GozineNazarSanji_List.aspx"><i class="fa  fa-pencil"></i></a>
                            <ul>
                ...
                <div class="InterBoxFormRight" >
                    ...
                    <div class="bodyForm">
                        ...
                        <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption">سوال&nbsp; *<asp:Label id="lblrowID_NazarSanji" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_rowID_NazarSanji"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">سوالی است که قصد درج گزینه های آنرا دارید</div></li></ul></a></li>
                                    <li><asp:DropDownList  id="cmb_rowID_NazarSanji" tabindex="1" runat ="server"  onfocus="GraphicalBorder('container_rowID_NazarSanji');" onblur="GraphicalBorderRemove('container_rowID_NazarSanji');"></asp:DropDownList></li>                 
                                </ul>
                            </div>
                        </div>
                    
                        <div class ="ContainerTextBoxObject">       
                            <div class="ContainerTextBoxCaption">شماره گزینه&nbsp;* <asp:Label id="lblNumber_Gozine" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle" style="height:88px">
                                <div class="effectContainerDiv"  id="container_Number_Gozine"></div>
                                <ul class="ContainerQuotation" >
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">شماره گزینه ای است که قصد درج آنرا دارید</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="1" style="height:80px" TextMode ="MultiLine"  onfocus="GraphicalBorder('container_Number_Gozine');" onblur="GraphicalBorderRemove('container_Number_Gozine');" ID="Number_Gozine" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
...
<script  type ="text/javascript" >
    document.getElementById("pic_NazarSanji").onchange = function() {
