<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Gallery.aspx.vb" Inherits="Safe_Gallery1" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" lang="en" dir="ltr">
<head id="Head1" runat="server">
    <title>Picture and Video Gallery</title>
...
<body style ="background :#fff;margin :0;padding :0;">
    ...
    <div onclick="clodeVideo();" id="saveDialog" style="position:fixed  ;top:0px;left:0px;width:100%;height:100%;display:none;background :rgb(0,0,0);background :rgba(0,0,0,0.5);text-align :center ;z-index:1000000000000000000000000000000000000;" >
        <div style="position:relative ;float:none;margin-left :auto ;margin-right :auto ;margin-top :auto ;margin-bottom :auto; ">
            <iframe src="" id="videoFrame" class="videoFrame_Anhar" frameborder ="0" scrolling ="no" ></iframe>
        </div>
      </div>
        ...
        <div class ="backMobileMenu" id="mobileMenu4"  style ="display:none;">
           ...
           <div class ="mainScreenLayer">    
            ...
            <div class ="MessageCEO_SlideContainer" style="<%=SiteStudioStore.BgStyle("hero_Gallery")%>">
            ...
            <div class ="MessageCEO_HeaderTextContainer"><h1 class="<%=SiteStudioStore.AlignClass("copy_Gallery_h1")%>"><%=SiteStudioStore.Copy("copy_Gallery_h1", "Picture and Video Gallery")%></h1> </div>
            <div class="selectContainer">
            <select id="cmb_select_Gallery" style="margin-bottom :20px;padding-left :20px;">
                <%=Session("fill_Combo_GroupGallery") %>
            </select>
            
            </div>
            <%=Session("fetch_all_GroupGallery")%>
...
<script  type ="text/javascript" >
    function showNewSection() {
        window.location.href = "Gallery.aspx#" + document.getElementById("cmb_select_Gallery").selectedIndex;
    }
</script>
