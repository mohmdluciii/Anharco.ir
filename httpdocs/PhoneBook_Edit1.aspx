<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PhoneBook_Edit1.aspx.vb" Inherits="W_ISM.PhoneBook_Edit1" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><a href="#">ارتباط با ما </a><i class="fa fa-chevron-left arrow"></i><a href="#">راهنمای تلفن</a><i class="fa fa-chevron-left arrow"></i><a>ویرایش</a></div>
            ...
            <div class="containerForm">
                ...
                <div class="DeleteBoxContainer" id="DeleteBoxContainer" onclick="closeDeleteDialog();">
                    <div class ="DeleteBox" id="DeleteBox">
                       <iframe src="PhoneBook_Delete1.aspx?rowID_PhoneBook=<%=request.QueryString("rowID_PhoneBook") %>" frameborder="0"></iframe>
                    </div>
                </div>
                <div class="InterBoxFormLeft">
                    <ul>
                        <li>
                            <a class ="LinkIcon" href="PhoneBook_List1.aspx"><i class="fa  fa-pencil"></i></a>
                            <ul>
                ...
                <div class="InterBoxFormRight" >
                    ...
                    <div class="bodyForm">
                       ...
                       <div class ="ContainerTextBoxObject">       
                            <div class="ContainerTextBoxCaption">واحد&nbsp;* <asp:Label id="lblunit_PhoneBook" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_unit_PhoneBook"></div>
                                <ul class="ContainerQuotation">
                                    ...
                                    <li> <asp:TextBox  tabindex="1"  onfocus="GraphicalBorder('container_unit_PhoneBook');" onblur="GraphicalBorderRemove('container_unit_PhoneBook');" ID="unit_PhoneBook" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        <div class ="ContainerTextBoxObject">       
                            <div class="ContainerTextBoxCaption">پرسنل &nbsp;* <asp:Label id="lblperson_PhoneBook" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_person_PhoneBook"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">پرسنلی است که قصد دارید شماره تماس آنرا درج کنید</div></li></ul></a></li>
                                    
                                    <li> <asp:TextBox  tabindex="1"  onfocus="GraphicalBorder('container_person_PhoneBook');" onblur="GraphicalBorderRemove('container_person_PhoneBook');" ID="person_PhoneBook" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        <div class ="ContainerTextBoxObject">       
                            <div class="ContainerTextBoxCaption">سمت &nbsp;* <asp:Label id="lblsemat_PhoneBook" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_semat_PhoneBook"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">سمت پرسنلی است که قصد دارید شماره تماس آنرا درج کنید</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="1"  onfocus="GraphicalBorder('container_semat_PhoneBook');" onblur="GraphicalBorderRemove('container_semat_PhoneBook');" ID="semat_PhoneBook" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        <div class ="ContainerTextBoxObject">       
                            <div class="ContainerTextBoxCaption">شماره تماس &nbsp;* <asp:Label id="lblphone_PhoneBook" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_phone_PhoneBook"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">شماره تماس پرسنل است</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="1"  onfocus="GraphicalBorder('container_phone_PhoneBook');" onblur="GraphicalBorderRemove('container_phone_PhoneBook');" ID="phone_PhoneBook" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
