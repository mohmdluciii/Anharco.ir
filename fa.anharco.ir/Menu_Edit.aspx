<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Menu_Edit.aspx.vb" Inherits="W_ISM.Menu_Edit" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><a href="#">راه اندازی سامانه</a><i class="fa fa-chevron-left arrow"></i><a href="#">مدیریت محتوا</a><i class="fa fa-chevron-left arrow"></i><a>ویرایش</a></div>
            ...
            <div class="containerForm">
                ...
                <div class="DeleteBoxContainer" id="DeleteBoxContainer" onclick="closeDeleteDialog();">
                    <div class ="DeleteBox" id="DeleteBox">
                       <iframe src="menu_Delete.aspx?RowID_Table=<%=request.QueryString("RowID_Table") %>" frameborder="0"></iframe>
                    </div>
                </div>
                ...
                <div class="InterBoxFormLeft">
                    <ul>
                        <li>
                            <a class ="LinkIcon" href="menu_List.aspx"><i class="fa  fa-pencil"></i></a>
                            <ul>
                ...
                <div class="InterBoxFormRight" >
                    ...
                    <div class ="ContainerTextBoxObject" style ="display:none;">
                            <div class="ContainerTextBoxCaption">منوی اصلی&nbsp; <asp:Label id="lblrowID_TopMenu" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_rowID_TopMenu"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">منوی تعریف شده تحت منو انتخابی باشد</div></li></ul></a></li>
                                    <li><asp:DropDownList  id="cmb_rowID_TopMenu" tabindex="1" runat ="server"  onfocus="GraphicalBorder('container_rowID_TopMenu');" onblur="GraphicalBorderRemove('container_rowID_TopMenu');"></asp:DropDownList></li>                 
                                </ul>
                            </div>
                        </div>
                        <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption">فرم&nbsp; <asp:Label id="lblrowID_Form" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_rowID_Form"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">اگر صفحه فرمی دارد فرم را برگزینید</div></li></ul></a></li>
                                    <li><asp:DropDownList  id="cmb_rowID_Form" tabindex="1" runat ="server"  onfocus="GraphicalBorder('container_rowID_Form');" onblur="GraphicalBorderRemove('container_rowID_Form');"></asp:DropDownList></li>                 
                                </ul>
                            </div>
                        </div>
                         <div class ="ContainerTextBoxObject">       
                            <div class="ContainerTextBoxCaption">عنوان محتوا&nbsp;* <asp:Label id="lblTitle_Table" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_Title_Table"></div>
                                <ul class="ContainerQuotation" >
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">عنوان محتوا است که قصد نمایش در وب سایت را دارید</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="1" TextMode ="MultiLine"  onfocus="GraphicalBorder('container_Title_Table');" onblur="GraphicalBorderRemove('container_Title_Table');" ID="Title_Table" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        <div class ="ContainerTextBoxObject">       
                            <div class="ContainerTextBoxCaption">نام لاتین محتوا&nbsp;* <asp:Label id="lblname_table" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle" >
                                <div class="effectContainerDiv"  id="container_name_table"></div>
                                <ul class="ContainerQuotation" >
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">محتوا برای ثبت در سامانه نیاز به یک نام انگلیسی منحصر دارد</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="1"  TextMode ="MultiLine"  onfocus="GraphicalBorder('container_name_table');" onblur="GraphicalBorderRemove('container_name_table');" ID="name_table" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                       
                        <div class ="ContainerTextBoxObject" style="width :100%;">
                            <div class="ContainerTextBoxCaption"><asp:Label id="lbltext_MenuIT" runat ="server"  class="errStyle" ></asp:Label></div>
                            <iframe  src="Editor_New_Large.aspx" style ="width:90%;height:820px;visibility:visible;position:relative ;top:0px;right:0px;float:right " frameborder ="0" scrolling ="no" ></iframe>
                        </div>
...
<script  type ="text/javascript" >
    document.getElementById("pic_menu").onchange = function() {
