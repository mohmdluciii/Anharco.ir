...
<head id="Head1" runat="server">
    <title>اعضای هیات مدیره شرکت انهار</title>
     ...
     <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" TargetControlID="txt_Search" ServiceMethod="Buscar" ServicePath="AutoCompletar.asmx" MinimumPrefixLength="2" CompletionInterval="1000" EnableCaching="true" CompletionSetCount="12"   CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"></asp:AutoCompleteExtender>  
        ...
        <div class ="backMobileMenu" id="mobileMenu4"  style ="display:none;">
           ...
           <div class ="mainScreenLayer">    
            ...
            <div class ="MessageCEO_HeaderTextContainer"><h1 class="<%=SiteStudioStore.AlignClass("copy_leadership_h1")%>"><%=SiteStudioStore.Copy("copy_leadership_h1", "اعضای هیات مدیره")%></h1> </div>
            <div class ="leadershipMainpage">
               ...
               <div class="swiper-slide">
                    ...
                    <div class ="boxText">
                        <p class="leadName <%=SiteStudioStore.AlignClass("copy_leadership_1_name")%>"><%=SiteStudioStore.Copy("copy_leadership_1_name", "مسعود معظمی")%></p>
                        <p class="leadRole <%=SiteStudioStore.AlignClass("copy_leadership_1_role")%>"><%=SiteStudioStore.Copy("copy_leadership_1_role", "مهندسی عمران و تاریخ")%></p>
                    </div>
                    </div>
               </div>
               <div class="swiper-slide">
                    ...
                    <div class ="boxText">
                        <p class="leadName <%=SiteStudioStore.AlignClass("copy_leadership_2_name")%>"><%=SiteStudioStore.Copy("copy_leadership_2_name", "ستار عزیزیان تفتی")%></p>
                        <p class="leadRole <%=SiteStudioStore.AlignClass("copy_leadership_2_role")%>"><%=SiteStudioStore.Copy("copy_leadership_2_role", "مهندسی مواد")%></p>
                    </div>
                    </div>
               </div>
               <div class="swiper-slide">
                    ...
                    <div class ="boxText">
                        <p class="leadName <%=SiteStudioStore.AlignClass("copy_leadership_3_name")%>"><%=SiteStudioStore.Copy("copy_leadership_3_name", "اکبر اشراقی")%></p>
                        <p class="leadRole <%=SiteStudioStore.AlignClass("copy_leadership_3_role")%>"><%=SiteStudioStore.Copy("copy_leadership_3_role", "حسابداری و مدیریت مالی")%></p>
                    </div>
                    </div>
               </div>
               <div class="swiper-slide">
                    ...
                    <div class ="boxText">
                        <p class="leadName <%=SiteStudioStore.AlignClass("copy_leadership_4_name")%>"><%=SiteStudioStore.Copy("copy_leadership_4_name", "مجتبی معظمی")%></p>
                        <p class="leadRole <%=SiteStudioStore.AlignClass("copy_leadership_4_role")%>"><%=SiteStudioStore.Copy("copy_leadership_4_role", "فیزیک و MBA")%></p>
                    </div>
                    </div>
               </div>
               <div class="swiper-slide">
                    ...
                    <div class ="boxText">
                        <p class="leadName <%=SiteStudioStore.AlignClass("copy_leadership_5_name")%>"><%=SiteStudioStore.Copy("copy_leadership_5_name", "نگار معظمی")%></p>
                        <p class="leadRole <%=SiteStudioStore.AlignClass("copy_leadership_5_role")%>"><%=SiteStudioStore.Copy("copy_leadership_5_role", "مهندسی عمران/مهندسی سازه")%></p>
                    </div>
                    </div>
               </div>
               <div class="swiper-slide">
                    ...
                    <div class ="boxText">
                        ...
                        <p class="leadRole <%=SiteStudioStore.AlignClass("copy_leadership_6_role")%>"><%=SiteStudioStore.Copy("copy_leadership_6_role", "مهندسی عمران")%></p>
                    </div>
                    </div>
               </div>
               </div>
