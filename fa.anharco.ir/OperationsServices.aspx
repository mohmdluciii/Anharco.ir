<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="OperationsServices.aspx.vb" Inherits="Safe_OperationsServices" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" lang="fa" dir="rtl">
<head id="Head1" runat="server">
    <title>خدمات اجرا شرکت انهار</title>
     ...
     <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" TargetControlID="txt_Search" ServiceMethod="Buscar" ServicePath="AutoCompletar.asmx" MinimumPrefixLength="2" CompletionInterval="1000" EnableCaching="true" CompletionSetCount="12"   CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"></asp:AutoCompleteExtender>  
        ...
        <div class ="backMobileMenu" id="mobileMenu4"  style ="display:none;">
           ...
           <div class ="mainScreenLayer">    
            ...
            <div class ="MessageCEO_SlideContainer" style="<%=SiteStudioStore.BgStyle("hero_OperationsServices")%>">
            ...
            <div class ="MessageCEO_HeaderTextContainer"><h1 class="<%=SiteStudioStore.AlignClass("copy_OperationsServices_h1")%>"><%=SiteStudioStore.Copy("copy_OperationsServices_h1", "خدمات اجرا شرکت انهار")%></h1> </div>
           <div class ="MessageCEO_Box5Container" style="top:-250px;background :#fff;margin-top :0;margin-bottom :0;margin :0;">
                <div class ="MessageCEO_inner" style="top:0px;bmargin-top:0px;margin-bottom :0xp;margin :0;">
                    ...
                    <div class ="box" style="top:-10px;">
                        <img src="<%=SiteStudioStore.Asset("pic_OperationsInner")%>" />
                    </div>
                    <div class ="box">  
                        <p class="<%=SiteStudioStore.AlignClass("copy_OperationsServices_p1")%>" style ="color:#000;"><%=SiteStudioStore.Copy("copy_OperationsServices_p1", "فاز نصب یا اجرا (Construction):")%></p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_OperationsServices_p2")%>" style ="color:#000;"><i class ="fa fa-chevron-left" style="font-size:14pt;color:#000;margin-left :10px;"></i><%=SiteStudioStore.Copy("copy_OperationsServices_p2", "نصب تجهیزات")%></p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_OperationsServices_p3")%>" style ="color:#000;"><i class ="fa fa-chevron-left" style="font-size:14pt;color:#000;margin-left :10px;"></i><%=SiteStudioStore.Copy("copy_OperationsServices_p3", "اجرای فعالیت ها")%></p>
                        
                        <p class="<%=SiteStudioStore.AlignClass("copy_OperationsServices_p4")%>" style ="color:#000;"><%=SiteStudioStore.Copy("copy_OperationsServices_p4", "در فاز نصب یا اجرا (Construction) معمولا پیشرفت پروژه بر اساس احجام و مقادیر کاری اجرا شده و مقادیر نصب شده تجهیزات برنامه ریزی و کنترل می شود.از جمله فعالیت های فاز نصب یا اجرا (Construction) می توان به اجرای فونداسیون، اجرای اسکلت و نصب تجهیزات، حفاری، جوش و لوله گذاری اشاره نمود.")%></p>
                    </div>
                </div>
            </div>
