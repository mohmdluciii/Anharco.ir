<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="EnserafOmr_frm.aspx.vb" Inherits="W_ISM.EnserafOmr_frm" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><i class="fa fa-medkit"></i><a href="#">خدمات بیمه</a><i class="fa fa-chevron-left arrow"></i><a href="#">درخواست انصراف از بیمه عمر و حوادث</a><i class="fa fa-chevron-left arrow"></i><a>درج</a></div>
                ...
                <div class="InterBoxFormRight" >
                    ...
                    <div class="bodyForm">
                        ...
                        <div class ="ContainerTextBoxObject">       
                            <div class="ContainerTextBoxCaption">نام&nbsp;* <asp:Label id="lblname_EnserafOmr" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle" >
                                <div class="effectContainerDiv"  id="container_name_EnserafOmr"></div>
                                <ul class="ContainerQuotation" >
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">نام درخواست  کننده انصراف بیمه عمر و حوادث که باید وارد شود</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="1"  onfocus="GraphicalBorder('container_name_EnserafOmr');" onblur="GraphicalBorderRemove('container_name_EnserafOmr');" ID="name_EnserafOmr" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        <div class ="ContainerTextBoxObject">       
                            <div class="ContainerTextBoxCaption">نام خانوادگی&nbsp;* <asp:Label id="lbllname_EnserafOmr" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle" >
                                <div class="effectContainerDiv"  id="container_lname_EnserafOmr"></div>
                                <ul class="ContainerQuotation" >
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">نام خانوادگی درخواست  کننده انصراف بیمه عمر و حوادث است که باید وارد شود</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="1"  onfocus="GraphicalBorder('container_lname_EnserafOmr');" onblur="GraphicalBorderRemove('container_lname_EnserafOmr');" ID="lname_EnserafOmr" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class ="ContainerTextBoxObject">       
                            <div class="ContainerTextBoxCaption">شماره شناسنامه&nbsp;* <asp:Label id="lblid_EnserafOmr" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle" >
                                <div class="effectContainerDiv"  id="container_id_EnserafOmr"></div>
                                <ul class="ContainerQuotation" >
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">شماره شناسنامه درخواست  کننده انصراف بیمه عمر و حوادث است که باید وارد شود</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="1"  onfocus="GraphicalBorder('container_id_EnserafOmr');" onblur="GraphicalBorderRemove('container_id_EnserafOmr');" ID="id_EnserafOmr" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        
                        <div class ="ContainerTextBoxObject">       
                            <div class="ContainerTextBoxCaption"> کد ملی&nbsp;* <asp:Label id="lblmeli_EnserafOmr" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle" >
                                <div class="effectContainerDiv"  id="container_meli_EnserafOmr"></div>
                                <ul class="ContainerQuotation" >
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">کد ملی درخواست  کننده انصراف بیمه عمر و حوادث است که باید وارد شود</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="1"  onfocus="GraphicalBorder('container_meli_EnserafOmr');" onblur="GraphicalBorderRemove('container_meli_EnserafOmr');" ID="meli_EnserafOmr" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class ="ContainerTextBoxObject">       
                            <div class="ContainerTextBoxCaption">  منطقه&nbsp;* <asp:Label id="lblcostCenter_EnserafOmr" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle" >
                                <div class="effectContainerDiv"  id="container_costCenter_EnserafOmr"></div>
                                <ul class="ContainerQuotation" >
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">منطقه درخواست  کننده انصراف بیمه عمر و حوادث است که باید وارد شود</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="1"  onfocus="GraphicalBorder('container_costCenter_EnserafOmr');" onblur="GraphicalBorderRemove('container_costCenter_EnserafOmr');" ID="costCenter_EnserafOmr" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        
                        <div class ="ContainerTextBoxObject">       
                            <div class="ContainerTextBoxCaption">  از تاریخ&nbsp;* <asp:Label id="lbldate_EnserafOmr" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle" >
                                <div class="effectContainerDiv"  id="container_date_EnserafOmr"></div>
                                <ul class="ContainerQuotation" >
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">تاریخ شروع خدمت درخواست  کننده انصراف بیمه عمر و حوادث است که باید وارد شود</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="1"  onfocus="GraphicalBorder('container_date_EnserafOmr');" onblur="GraphicalBorderRemove('container_date_EnserafOmr');" ID="date_EnserafOmr" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
