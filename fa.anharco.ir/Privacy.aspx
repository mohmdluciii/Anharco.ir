...
<head id="Head1" runat="server">
    <title>حریم خصوصی - شرکت انهار</title>
     ...
     <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" TargetControlID="txt_Search" ServiceMethod="Buscar" ServicePath="AutoCompletar.asmx" MinimumPrefixLength="2" CompletionInterval="1000" EnableCaching="true" CompletionSetCount="12"   CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"></asp:AutoCompleteExtender>  
        ...
        <div class ="backMobileMenu" id="mobileMenu4"  style ="display:none;">
           ...
           <div class ="mainScreenLayer">    
            ...
            <div class ="MessageCEO_HeaderTextContainer"><h1 class="<%=SiteStudioStore.AlignClass("copy_Privacy_h1")%>"><%=SiteStudioStore.Copy("copy_Privacy_h1", "حریم خصوصی")%></h1> </div>
            <div class ="MessageCEO_topTextContainer">
            
                <p class="<%=SiteStudioStore.AlignClass("copy_Privacy_p1")%>" style ="text-align :right;"><%=SiteStudioStore.Copy("copy_Privacy_p1", "شرکت انهار متعهد به حفظ حریم خصوصی تمامی بازدیدکنندگان است و ما این بیانیه حفظ حریم خصوصی را به عنوان بخشی از تعهد خود به حریم خصوصی شما تهیه کرده ایم. شما به عنوان مشتری ما می توانید بدون وارد کردن اطلاعات شخصی در اینترنت جهانی به سایت شرکت انهار مراجعه کنید. مقدار اطلاعاتی که جمع آوری می کنیم به اطلاعاتی که در اختیار ما قرار می دهید بستگی دارد")%></p>
                <p class="<%=SiteStudioStore.AlignClass("copy_Privacy_p2")%>" style ="text-align :right;"><%=SiteStudioStore.Copy("copy_Privacy_p2", "با ثبت نام یا درخواست اطلاعات در این سایت، با جمع آوری، استفاده و انتقال اطلاعات خود مطابق با این سیاست موافقت می کنید.")%></p> 
            
                <p class="<%=SiteStudioStore.AlignClass("copy_Privacy_h2")%>" style="text-align :right;font-size :16pt;font-weight:700;"><i class ="fa fa-arrow-left" style="font-size :16pt;"></i><%=SiteStudioStore.Copy("copy_Privacy_h2", "اطلاعاتی که از شما جمع آوری می کنیم.")%></p>
                
                <p class="<%=SiteStudioStore.AlignClass("copy_Privacy_p3")%>" style ="text-align :right;"><%=SiteStudioStore.Copy("copy_Privacy_p3", "هنگام بازدید، از شما خواسته می شود اطلاعاتی مانند نام و اطلاعات تماس خود را وارد کنید. همچنین ممکن است اطلاعاتی در مورد استفاده شما از سایت به همراه اطلاعاتی که از طریق نامه یا ایمیل برای ما ارسال می کنید جمع آوری کنیم.")%></p> 
                
                
                <p class="<%=SiteStudioStore.AlignClass("copy_Privacy_h3")%>" style="text-align :right;font-size :16pt;font-weight:700;"><i class ="fa fa-arrow-left" style="font-size :16pt;"></i><%=SiteStudioStore.Copy("copy_Privacy_h3", "افشای")%></p>
                
                <p class="<%=SiteStudioStore.AlignClass("copy_Privacy_p4")%>" style ="text-align :right;"><%=SiteStudioStore.Copy("copy_Privacy_p4", "اطلاعاتی که شما در اختیار ما قرار می دهید در سرورهای امن ما ذخیره می شود. ما همچنین ممکن است اطلاعات جمع آوری شده در مورد استفاده شما از سایت خود را با اشخاص ثالث به اشتراک بگذاریم، اما این اطلاعات شامل اطلاعاتی نمی شود که بتوان از آنها برای شناسایی شما استفاده کرد.")%></p>
                <p class="<%=SiteStudioStore.AlignClass("copy_Privacy_p5")%>" style ="text-align :right;"><%=SiteStudioStore.Copy("copy_Privacy_p5", "هر جا که رمز عبوری برای شما ارائه شد (یا انتخاب کردید) که به شما امکان دسترسی به بخش های خاصی از سایت ما را می دهد، مسئولیت حفظ و نگهداری این رمز عبور بر عهده شماست. از شما می خواهیم که این رمز عبور را با کسی به اشتراک نگذارید.")%></p> 
                <p class="<%=SiteStudioStore.AlignClass("copy_Privacy_p6")%>" style ="text-align :right;"><%=SiteStudioStore.Copy("copy_Privacy_p6", "متاسفانه انتقال اطلاعات از طریق اینترنت کاملا امن نیست. اگرچه ما تمام تلاش خود را برای محافظت از اطلاعات شخصی شما انجام می دهیم، نمی توانیم امنیت انتقال اطلاعات شما را تضمین کنیم. بنابراین مسئولیت هرگونه انتقال به عهده شما خواهد بود. پس از دریافت اطلاعات شما، ما از اقدامات امنیتی سختگیرانه برای جلوگیری از دسترسی غیرمجاز به آن استفاده خواهیم کرد.")%></p> 
                <p class="<%=SiteStudioStore.AlignClass("copy_Privacy_p7")%>" style ="text-align :right;"><%=SiteStudioStore.Copy("copy_Privacy_p7", "کشورهای خارج از جامعه اقتصادی اروپا همیشه قوانین قوی حفاظت از داده ها ندارند. با این حال، ما همیشه تلاش خواهیم کرد تا اطمینان حاصل کنیم که از اطلاعات شما مطابق با این سیاست استفاده می شود. جز در مواردی که توسط قانون الزامی باشد، ما هیچ بخشی از اطلاعاتی که شما به ما ارائه می دهید را نمی فروشیم، نمی فروشیم یا توزیع نمی کنیم.")%></p> 
                
                <p class="<%=SiteStudioStore.AlignClass("copy_Privacy_p8")%>" style ="text-align :right;"><%=SiteStudioStore.Copy("copy_Privacy_p8", "در نهایت، اگر کسب و کار ما وارد یک سرمایه گذاری مشترک با شرکت دیگری شود، یا با نهاد دیگری ادغام شود یا به آن فروخته شود، اطلاعات شما برای شرکا یا مالکان جدید فاش می شود.")%></p> 
                
                <p class="<%=SiteStudioStore.AlignClass("copy_Privacy_h4")%>" style="text-align :right;font-size :16pt;font-weight:700;"><i class ="fa fa-arrow-left" style="font-size :16pt;"></i><%=SiteStudioStore.Copy("copy_Privacy_h4", "آی پی ها و کوکی ها")%></p>
                <p class="<%=SiteStudioStore.AlignClass("copy_Privacy_p9")%>" style ="text-align :right;"><%=SiteStudioStore.Copy("copy_Privacy_p9", "ممکن است اطلاعاتی درباره رایانه شما، از جمله آدرس IP، سیستم عامل و نوع مرورگر شما جمع آوری کنیم و از آن برای اهداف مدیریتی و بازاریابی استفاده کنیم. این شامل داده های آماری در مورد الگوهای جستجوی اینترنتی و عملکرد شما است و نمی تواند شما را شناسایی کند.")%></p> 
                
                <p class="<%=SiteStudioStore.AlignClass("copy_Privacy_p10")%>" style ="text-align :right;"><%=SiteStudioStore.Copy("copy_Privacy_p10", "کوکی ها بسته های کوچکی از اطلاعات هستند که ما در رایانه شما ذخیره می کنیم. هنگامی که وارد سایت ما می شوید، سیستم ما کوکی ها را در رایانه شما ذخیره می کند. مگر اینکه هنگام ارائه اطلاعات خود به ما اعتراض خود را اعلام کرده باشید. دفعه بعد که از سایت بازدید می کنید سرعت کوکی ها افزایش می یابد. همچنین، کوکی ها به ما اجازه می دهند ترافیک سایت را کنترل و نظارت کنیم و محتوای سایت را برای شما شخصی سازی کنیم. شما می توانید با فعال کردن تنظیمات خاصی در مرورگر رایانه خود از ذخیره سازی کوکی ها جلوگیری کنید، در این صورت ممکن است نتوانید از برخی ویژگی های خاص سایت ما استفاده کنید.")%></p> 
                
                <p class="<%=SiteStudioStore.AlignClass("copy_Privacy_h5")%>" style="text-align :right;font-size :16pt;font-weight:700;"><i class ="fa fa-arrow-left" style="font-size :16pt;"></i><%=SiteStudioStore.Copy("copy_Privacy_h5", "امنیت و حفاظت از داده ها")%></p>
                
                <p class="<%=SiteStudioStore.AlignClass("copy_Privacy_p11")%>" style ="text-align :right;"><%=SiteStudioStore.Copy("copy_Privacy_p11", "ما از تدابیر امنیتی برای محافظت از اطلاعات شما در برابر دسترسی های غیرمجاز و فعالیت های غیرقانونی، آسیب های تصادفی، تخریب و از دست دادن استفاده می کنیم. ما اطلاعات شما را تا زمانی که قانون ایجاب کند حفظ خواهیم کرد.")%></p> 
                <p class="<%=SiteStudioStore.AlignClass("copy_Privacy_p12")%>" style ="text-align :right;"><%=SiteStudioStore.Copy("copy_Privacy_p12", "در موارد خاص، سایت ما ممکن است حاوی لینک های الکترونیکی به سایت های دیگر باشد. اگر انتخاب کنید که از این سایت ها بازدید کنید، سیاست حفظ حریم خصوصی و اولویت های حریم خصوصی آنها اعمال خواهد شد.")%></p> 
                <p class="<%=SiteStudioStore.AlignClass("copy_Privacy_h6")%>" style="text-align :right;font-size :16pt;font-weight:700;"><i class ="fa fa-arrow-left" style="font-size :16pt;"></i><%=SiteStudioStore.Copy("copy_Privacy_h6", "دسترسی و به روز رسانی")%></p>
                <p class="<%=SiteStudioStore.AlignClass("copy_Privacy_p13")%>" style ="text-align :right;"><%=SiteStudioStore.Copy("copy_Privacy_p13", "شما این حق را دارید که از اطلاعاتی که در مورد شما نگهداری می کنیم آگاه باشید و از ما بخواهید که تغییراتی در آن اعمال کنیم تا دقیق و به روز باشد. اگر به این موضوع علاقه دارید، به ما اطلاع دهید.")%></p> 
                
                <p class="<%=SiteStudioStore.AlignClass("copy_Privacy_h7")%>" style="text-align :right;font-size :16pt;font-weight:700;"><i class ="fa fa-arrow-left" style="font-size :16pt;"></i><%=SiteStudioStore.Copy("copy_Privacy_h7", "تغییرات در سیاست حفظ حریم خصوصی ما")%></p>
                
                <p class="<%=SiteStudioStore.AlignClass("copy_Privacy_p14")%>" style ="text-align :right;"><%=SiteStudioStore.Copy("copy_Privacy_p14", "هر گونه تغییر در سیاست حفظ حریم خصوصی ما در آینده در سایت پست خواهد شد و در صورت لزوم از طریق ایمیل اطلاع رسانی خواهد شد.")%></p> 
