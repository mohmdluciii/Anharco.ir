<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CustomerSP_list.aspx.vb" Inherits="W_ISM.CustomerSP_list" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        ...
        <div class="titleForm"><i class="fa fa-user-circle-o icon"></i><a href="#">مشتری</a><i class="fa fa-chevron-left arrow"></i><i class="fa fa-pencil-square icon"></i><a href="#">تبلیغات مشتریان</a><i class="fa fa-chevron-left arrow"></i><a>لیست</a></div>
        ...
        <div class="formBox">
            ...
            <div class="containerForm">
                ...
                <div class="InterBoxFormLeft">
                    <ul>
                        <li>
                            <a class ="LinkIcon" href="Company_frm.aspx"><i class="fa  fa-pencil"></i></a>
                            <ul>
                ...
                <div class="SaveBoxContainer" id="saveContainer">
                    <div class ="SaveBox" id="saveDialog" style="top:5%">
                        ...
                        <input type="button" value="تایید" onclick="window.open('Company_List.aspx','_top');" /> 
                    </div>
                </div>
                    <div class="headForm_List" >
                       <a class="ExcelIcon" href="showExcel.aspx?page=Company_List" target="_blank" title ="خروجی اکسل"><i class="fa fa-file-excel-o"></i></a>
                        <a class="ExcelIcon" href="Report.aspx?page=Company_List" target="_blank" title ="نسخه قابل چاپ"><i class="fa fa-print"></i></a>
                    </div>
