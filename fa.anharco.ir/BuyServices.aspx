...
<head id="Head1" runat="server">
    <title>خدمات خرید شرکت انهار</title>
     ...
     <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" TargetControlID="txt_Search" ServiceMethod="Buscar" ServicePath="AutoCompletar.asmx" MinimumPrefixLength="2" CompletionInterval="1000" EnableCaching="true" CompletionSetCount="12"   CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"></asp:AutoCompleteExtender>  
        ...
        <div class ="backMobileMenu" id="mobileMenu4"  style ="display:none;">
           ...
           <div class ="mainScreenLayer">    
            ...
            <div class ="MessageCEO_HeaderTextContainer"><h1 class="<%=SiteStudioStore.AlignClass("copy_BuyServices_h1")%>"><%=SiteStudioStore.Copy("copy_BuyServices_h1", "خدمات خرید شرکت انهار")%></h1> </div>
           <div class ="MessageCEO_Box5Container" style="top:-250px;background :#fff;margin-top :0;margin-bottom :0;margin :0;">
                <div class ="MessageCEO_inner" style="top:0px;bmargin-top:0px;margin-bottom :0xp;margin :0;">
                    ...
                    <div class ="box">  
                        <p class="<%=SiteStudioStore.AlignClass("copy_BuyServices_p1")%>" style ="color:#000;"><%=SiteStudioStore.Copy("copy_BuyServices_p1", "فاز خرید و ساخت یا تامین و تدارکات (Procurement):")%></p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_BuyServices_p2")%>" style ="color:#000;"><i class ="fa fa-chevron-left" style="font-size:14pt;color:#000;margin-left :10px;"></i><%=SiteStudioStore.Copy("copy_BuyServices_p2", "خرید ، ساخت ، تامین و تدارکات تجهیزات، کالاها و مواد مورد نیاز جهت اجرای پروژه از خارج از سازمان اجرایی پروژه")%></p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_BuyServices_p3")%>" style ="color:#000;"><i class ="fa fa-chevron-left" style="font-size:14pt;color:#000;margin-left :10px;"></i><%=SiteStudioStore.Copy("copy_BuyServices_p3", "نظارت بر فروشندگان ، سازندگان و تامین کنندگان (Vendor or Supplier)")%></p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_BuyServices_p4")%>" style ="color:#000;"><i class ="fa fa-chevron-left" style="font-size:14pt;color:#000;margin-left :10px;"></i><%=SiteStudioStore.Copy("copy_BuyServices_p4", "تحویل گیری تجهیزات، کالاها و مواد از فروشندگان ، سازندگان و تامین کنندگان")%></p>
                        
                        <p class="<%=SiteStudioStore.AlignClass("copy_BuyServices_p5")%>" style ="color:#000;"><%=SiteStudioStore.Copy("copy_BuyServices_p5", "در فاز خرید و ساخت یا تامین و تدارکات (Procurement) معمولا پیشرفت پروژه بر اساس مراحل خرید و هزینه (در برخی موارد زمان یا ترکیبی از هزینه و زمان) لازم جهت تکمیل خرید برنامه ریزی و کنترل می شود.از جمله فعالیت های فاز خرید و ساخت یا تامین و تدارکات (Procurement) می توان به ساخت و خرید تجهیزات و اتصالات اشاره نمود.")%></p>
                    </div>
                </div>
            </div>
