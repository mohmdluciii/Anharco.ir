<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FG.aspx.vb" Inherits="W_ISM.FG" %>
...
<head runat="server">
    ...
    <style>
        ...
        @context@contextborder-box{.gitter-chat-embed{box-sizing:border-box;background-color:#fff}
        .gitter-chat-embed.is-collapsed:not(.is-loading)
        {
            box-sizing: border-box;
            transform: translateX(110%);
        }
        .gitter-chat-embed:after
        {
            box-sizing: border-box;
            content: "";
            z-index: -1;
        ...
        @context@contextborder-box{.gitter-chat-embed:after{box-sizing:border-box;background-color:#fff}@media(max-width:1150px){
        .gitter-chat-embed
        {
            box-sizing: border-box;
            left: 45%;
        ...
        .is-loading .gitter-chat-embed-loading-wrapper
        {
            box-sizing: border-box;
            display: -ms-flexbox;
            display: flex;
        ...
        @keyframes@keyframesspin{0%{box-sizing:border-box;transform:rotate(0deg)}
        to
        {
            box-sizing: border-box;
        ...
        .gitter-chat-embed-action-bar-item:focus, .gitter-chat-embed-action-bar-item:hover
        {
            box-sizing: border-box;
            opacity: 1;
        }
        ...
        {
            box-sizing: border-box;
            box-shadow: 0 0 8px rgba(62,160,127,.6);
            outline: none;
        }
        .gitter-open-chat-button:active
        {
            box-sizing: border-box;
            color: #eee;
        }
    ...
    <meta name="description" content="Generate Bootstrap friendly form html for your app or website.">
    <meta name="theme-color" content="#232323">
    <link rel="prefetch" href="https://fonts.googleapis.com/css?family=Roboto:100,300,400,500,700">
    <link rel="preload" href="site.min.js" as="script">
...
<body>
     <select id="setLanguage" class="form-control" style ="display:none;">
            
            
          </select>
     
       <div class="build-form">
       <div id="frmb-1571322546758-form-wrap" class="form-wrap form-builder ">
        ...
        <div class="render-form clearfix">
          ...
          <div class="btn-group pull-right">
            <button type="button" id="render-form-button" class="btn btn-secondary edit-form">ویرایش مجدد</button>
            <button type="button" id="copy-html" class="btn btn-primary copy-html">کپی کردن فرم</button>
            <button type="button" id="saveForm" onclick="location.href='../form_frm.aspx?c=1'" class="btn btn-primary copy-html">ثبت فرم</button>
          </div>
        </div>
</body>
</html>
 <script src="highlight.min.js.download"></script>

    <script src="clipboard.min.js.download"></script>

    <script src="vendor.min.js.download"></script>

    <script src="form-builder.min.js.download"></script>

    <script src="form-render.min.js.download"></script>

    <script src="site.min.js.download"></script>
