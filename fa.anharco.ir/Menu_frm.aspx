<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Menu_frm.aspx.vb" Inherits="W_ISM.Menu_frm" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><a href="#">راه اندازی سامانه</a><i class="fa fa-chevron-left arrow"></i><a href="#">مدیریت محتوا</a><i class="fa fa-chevron-left arrow"></i><a>درج</a></div>
                    ...
                    <div class="bodyForm">
                        ...
                        <div class ="ContainerTextBoxObject">       
                            ...
                            <div class="ContainerTextBoxStyle" >
                                ...
                                <ul class="ContainerQuotation" >
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">عنوان مجتوای است که قصد نمایش در وب سایت را دارید</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="1"  onfocus="GraphicalBorder('container_Title_Table');" onblur="GraphicalBorderRemove('container_Title_Table');" ID="Title_Table" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        <div class ="ContainerTextBoxObject">       
                            ...
                            <div class="ContainerTextBoxStyle" >
                                ...
                                <ul class="ContainerQuotation" >
                                    ...
                                    <li> <asp:TextBox  tabindex="1" onfocus="GraphicalBorder('container_name_table');" onblur="GraphicalBorderRemove('container_name_table');" ID="name_table" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
