...
<head id="Head1" runat="server">
    <title>پروژه های خطوط لوله - - شرکت انهار</title>
     ...
     <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" TargetControlID="txt_Search" ServiceMethod="Buscar" ServicePath="AutoCompletar.asmx" MinimumPrefixLength="2" CompletionInterval="1000" EnableCaching="true" CompletionSetCount="12"   CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"></asp:AutoCompleteExtender>  
        ...
        <div class ="backMobileMenu" id="mobileMenu4"  style ="display:none;">
           ...
           <div class ="mainScreenLayer">    
            ...
            <div class ="MessageCEO_HeaderTextContainer"><h1 class="<%=SiteStudioStore.AlignClass("copy_pipelines_h1")%>"><%=SiteStudioStore.Copy("copy_pipelines_h1", "خطوط لوله انتقال نفت و گاز")%></h1> </div>
            <div class ="MessageCEO_topTextContainer">
                <p class="<%=SiteStudioStore.AlignClass("copy_pipelines_p1")%>"><%=SiteStudioStore.Copy("copy_pipelines_p1", "به طور کلی اجرای خطوط لوله، اقتصادی ترین راه برای انتقال مقادیر قابل توجهی از نفت، نفت تصفیه شده و گاز طبیعی از طریق زمین می¬باشد. خطوط لوله انتقال نفت از فولاد و یا پلی اتیلن با قطر داخلی 4 تا 50 اینچ و خطوط لوله انتقال گاز از فولاد با قطر داخلی 2 تا 56 اینچ ساخته می¬شوند. کشورمان ایران، با دارا بودن منابع وسیعی از نفت و گاز، نیازمند تأسیس خطوط لوله بسیاری جهت انتقال نفت، فرآورده های نفتی و گاز می¬باشد و شرکت انهار با بکارگیری از دانش فنی نیروی انسانی مجرب و کارآزموده و همچنین تجهیزات و ماشین آلات به روز و مناسب، پروژه های فراوانی را در این راستا اجرا نموده است")%></p>
            </div>
