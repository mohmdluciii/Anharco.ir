...
<head id="Head1" runat="server">
    <title>پروژه های ساختمانی و ابنیه شرکت انهار</title>
     ...
     <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" TargetControlID="txt_Search" ServiceMethod="Buscar" ServicePath="AutoCompletar.asmx" MinimumPrefixLength="2" CompletionInterval="1000" EnableCaching="true" CompletionSetCount="12"   CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"></asp:AutoCompleteExtender>  
        ...
        <div class ="backMobileMenu" id="mobileMenu4"  style ="display:none;">
           ...
           <div class ="mainScreenLayer">    
            ...
            <div class ="MessageCEO_HeaderTextContainer"><h1 class="<%=SiteStudioStore.AlignClass("copy_building_h1")%>"><%=SiteStudioStore.Copy("copy_building_h1", "پروژه های ساختمانی و ابنیه")%></h1> </div>
            <div class ="MessageCEO_topTextContainer">
                <p class="<%=SiteStudioStore.AlignClass("copy_building_p1")%>"><%=SiteStudioStore.Copy("copy_building_p1", "شرکت انهار فعالیت خود را با ساخت پروژه های ساختمانی و مدرسه سازی آغاز و تاکنون توانسته است با برخورداری از گواهینامه صلاحیت پیمانکاری در زمینه ساختمان و ابنیه، سابقه فعالیت در این حوزه و همچنین به کمک توانایی های خود و بکارگیری مهندسین متخصص، بیش از یکصد پروژه در زمینه ساختمان و ابنیه، شامل احداث یاردهای تعمیراتی، احداث مدارس در شهر های مختلف کشور، اجرای اسکلت بتنی، احداث ساختمان های اداری و مسکونی و ... را با موفقیت اجرا نماید.")%></p>
            </div>
