<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="LawQuestion_Archive.aspx.vb" Inherits="W_ISM.LawQuestion_Archive" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm">آرشیو</a><i class="fa fa-chevron-left arrow"></i><a href="#">سوالات قوانین و مقررات</a><i class="fa fa-chevron-left arrow"></i><a>لیست</a></div>
            ...
            <div class="containerForm" style="width:100%;">
                ...
                <div class="SaveBoxContainer" id="saveContainer">
                    <div class ="SaveBox" id="saveDialog" style="top:5%">
                        ...
                        <input type="button" value="تایید" onclick="window.open('LawQuestion_Archive.aspx','_top');" /> 
                    </div>
                  </div>
                    <div class="headForm_List" >
                       <a class="ExcelIcon" href="showExcel.aspx?page=LawQuestion_Archive" target="_blank" title ="خروجی اکسل"><i class="fa fa-file-excel-o"></i></a>
                    </div>
