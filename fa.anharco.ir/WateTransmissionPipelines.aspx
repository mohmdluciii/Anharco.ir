...
<head id="Head1" runat="server">
    <title>پروژه های خطوط لوله انتقال آب - شرکت انهار</title>
     ...
     <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" TargetControlID="txt_Search" ServiceMethod="Buscar" ServicePath="AutoCompletar.asmx" MinimumPrefixLength="2" CompletionInterval="1000" EnableCaching="true" CompletionSetCount="12"   CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"></asp:AutoCompleteExtender>  
        ...
        <div class ="backMobileMenu" id="mobileMenu4"  style ="display:none;">
           ...
           <div class ="mainScreenLayer">    
            ...
            <div class ="MessageCEO_HeaderTextContainer"><h1 class="<%=SiteStudioStore.AlignClass("copy_WateTransmissionPipelines_h1")%>"><%=SiteStudioStore.Copy("copy_WateTransmissionPipelines_h1", "پروژه های خطوط لوله انتقال آب")%></h1> </div>
            <div class ="MessageCEO_topTextContainer">
                <p class="<%=SiteStudioStore.AlignClass("copy_WateTransmissionPipelines_p1")%>"><%=SiteStudioStore.Copy("copy_WateTransmissionPipelines_p1", "با توجه به نقش حیاتی آب در زندگی بشر و کمبود این مایع حیات در قرن جدید، فرآیند انتقال و تصفیه آن تا مرحله رساندن به دست مصرف‌کننده، جزو پروژه¬های مهم و استراتژیک هر کشوری می¬باشد. خطوط انتقال و شبکه های توزیع آب به مجموعه ای از تأسیسات، شامل لوله، اتصالات و شیرآلات اطلاق می‌شود که به منظور انتقال سیالات از نقطه‌ای به نقطه دیگر احداث می‌شوند. مهمترین بخش‌های یک شبکه توزیع یا خطوط انتقال آب شامل لوله با جنس‌های مختلف، ایستگاه پمپاژ به منظور تأمین فشار خط و شیرآلات به منظور کنترل و بهره برداری از خط انتقال می‌باشد.")%></p>
            </div>
           ...
           <%=Session("initProjectWateTransmissionPipelines")%>
           </div>
