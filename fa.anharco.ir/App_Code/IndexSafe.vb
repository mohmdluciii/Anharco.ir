...
Public Class IndexSafe
    ...
    Private Sub BindLocalBanners()
        ...
        SetIfEmpty("name_TopBanner1", "خطوط لوله نفت و گاز")
        SetIfEmpty("text_TopBanner1", "احداث و اجرای خطوط انتقال نفت و گاز.")
        SetIfEmpty("small_TopBanner1", "بیشتر")

        SetIfEmpty("name_TopBanner2", "تأسیسات تقویت فشار گاز")
        SetIfEmpty("text_TopBanner2", "طراحی و اجرای ایستگاه‌های تقویت فشار گاز.")
        SetIfEmpty("small_TopBanner2", "بیشتر")

        SetIfEmpty("name_TopBanner3", "ابنیه و ساختمان")
        SetIfEmpty("text_TopBanner3", "پروژه‌های عمرانی، ساختمان و سازه‌های بتنی.")
        SetIfEmpty("small_TopBanner3", "بیشتر")

        SetIfEmpty("name_TopBanner4", "تأسیسات و تجهیزات")
        SetIfEmpty("text_TopBanner4", "تأمین و نصب تأسیسات و تجهیزات صنعتی.")
        SetIfEmpty("small_TopBanner4", "بیشتر")
