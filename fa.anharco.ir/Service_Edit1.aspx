<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Service_Edit1.aspx.vb" Inherits="W_ISM.Service_Edit1" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
       <div class="titleForm"><a href="#">تنظیمات سایت</a><i class="fa fa-chevron-left arrow"></i><a href="#">خدمات</a><i class="fa fa-chevron-left arrow"></i><a>درج</a></div>
        ...
        <div class="formBox">
            ...
            <div class="containerForm">
                ...
                <div class="InterBoxFormLeft">
                    <ul>
                        <li>
                            <a class ="LinkIcon" href="Service_List1.aspx?f1=<%=request.QueryString("f1") %>"><i class="fa  fa-pencil"></i></a>
                            <ul>
                ...
                <div class="InterBoxFormRight" >
                    ...
                    <div class="bodyForm">
                        ...
                        <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption">گروه سرویس&nbsp; *<asp:Label id="lblRowID_GroupService" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_GroupService"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">گروه سرویسی است که سرویس جدید در آن قرار دارد.</div></li></ul></a></li>
                                    <li><asp:DropDownList  id="cmb_GroupService" tabindex="1" runat ="server"  onfocus="GraphicalBorder('container_GroupService');" onblur="GraphicalBorderRemove('container_GroupService');"></asp:DropDownList></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption">نام سرویس&nbsp; *<asp:Label id="lblname_Service" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_name_Service"></div>
                                <ul class="ContainerQuotation">
                                    ...
                                    <li> <asp:TextBox  tabindex="2"  onfocus="GraphicalBorder('container_name_Service');" onblur="GraphicalBorderRemove('container_name_Service');" ID="name_Service" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
