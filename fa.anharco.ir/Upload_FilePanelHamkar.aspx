<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Upload_FilePanelHamkar.aspx.vb" Inherits="W_ISM.Upload_FilePanelHamkar" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><a href="#">مدیریت همکار</a><i class="fa fa-chevron-left arrow"></i><a href="#"><asp:Label ID="lbl_Title" runat ="server"  Text ="دریافت فایل" ></asp:Label></a><i class="fa fa-chevron-left arrow"></i><a>درج</a></div>
                ...
                <div class="InterBoxFormRight" >
                    ...
                    <div class="bodyForm">
                         ...
                         <div class ="ContainerTextBoxObject">       
                            <div class="ContainerTextBoxCaption">نام&nbsp;* <asp:Label id="lblname_FilePanelHamkar" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_name_FilePanelHamkar"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">عنوان فایل است که باید درج شود</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="1"  onfocus="GraphicalBorder('container_name_FilePanelHamkar');" onblur="GraphicalBorderRemove('container_name_FilePanelHamkar');" ID="name_FilePanelHamkar" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        <div class ="ContainerTextBoxObject" >
                            <div class="ContainerTextBoxCaption">انتخاب فایل  &nbsp;  <asp:Label id="lblfile_FilePanelHamkar" runat ="server"  class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_file_FilePanelHamkar"></div>
                                <ul class="ContainerQuotation">
...
<script  type ="text/javascript" >
    document.getElementById("file_FilePanelHamkar").onchange = function() {
