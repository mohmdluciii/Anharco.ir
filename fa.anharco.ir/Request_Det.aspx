<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Request_Det.aspx.vb" Inherits="W_ISM.Request_Det" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
     <title>درخواست تعمیر و نگهداری</title>
                        ...
                        <tr>
                            <td>
                                <table style="width :100%;font-size :9pt;font-family:yekan " dir="rtl" >
                                    ...
                                    <tr>
                                        <td>وضعیت : </td>
                                        <td><asp:DropDownList ID="cmb_status" runat ="server" Width ="100" Font-Names ="yekan" Font-Size ="8pt" ></asp:DropDownList></td>
                                    </tr>
                                    <tr>
                                        <td>اعلان وضعیت : </td>
                                        <td><asp:TextBox  style="resize:none" ID="textStatus_Request" runat ="server" Width ="300px" TextMode ="MultiLine"  Height ="50px"  Font-Names ="yekan" Font-Size ="8pt" ></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                        <td>فایل ضمیمه : </td>
                                        <td><asp:FileUpload ID="file_Request" runat ="server" Width ="300px"  Font-Names ="yekan" Font-Size ="8pt"  /></td>
                                    </tr>
                                    <tr>
                                        <td></td>
