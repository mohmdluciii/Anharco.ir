<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PersonPM_Edit1.aspx.vb" Inherits="W_ISM.PersonPM_Edit1" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><a href="#">چارت سازمانی</a><i class="fa fa-chevron-left arrow"></i><a href="#">پرسنل چارت</a><i class="fa fa-chevron-left arrow"></i><a href="PersonPM_list.aspx">ویرایش</a></div>
            ...
            <div class="containerForm" style="width:98%">
                ...
                <div class="DeleteBoxContainer" id="DeleteBoxContainer" onclick="closeDeleteDialog();">
                    <div class ="DeleteBox" id="DeleteBox">
                       <iframe src="PersonPM_Delete1.aspx?rowID_PersonPM=<%=request.QueryString("rowID_PersonPM") %>" frameborder="0"></iframe>
                    </div>
                </div>
                ...
                <div class="InterBoxFormRight" >
                    ...
                    <div class="bodyForm">
                         <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption">سطح&nbsp; *<asp:Label id="lblcodeLevel_PersonPM" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_codeLevel_PersonPM"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble"></div></li></ul></a></li>
                                    <li><asp:DropDownList  id="cmb_codeLevel_PersonPM" tabindex="1" runat ="server"  onfocus="GraphicalBorder('container_codeLevel_PersonPM');" onblur="GraphicalBorderRemove('container_codeLevel_PersonPM');"></asp:DropDownList></li>
                                </ul>
                            </div>
                        </div>
                        
                        <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption">بالا دستی&nbsp; *<asp:Label id="lblcodeParent_PersonPM" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_codeParent_PersonPM"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble"></div></li></ul></a></li>
                                    <li><asp:DropDownList  id="cmb_codeParent_PersonPM" tabindex="1" runat ="server"  onfocus="GraphicalBorder('container_codeParent_PersonPM');" onblur="GraphicalBorderRemove('container_codeParent_PersonPM');"></asp:DropDownList></li>
                                </ul>
                            </div>
                        </div>
                        <div class ="ContainerTextBoxObject">
...
<script  type ="text/javascript" >
    document.getElementById("Logo_PersonPM").onchange = function () {
