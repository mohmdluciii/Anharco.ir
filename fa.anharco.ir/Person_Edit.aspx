<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Person_Edit.aspx.vb" Inherits="W_ISM.Person_Edit2" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><a href="#">درباره ما</a><i class="fa fa-chevron-left arrow"></i><a href="#">مدیران</a><i class="fa fa-chevron-left arrow"></i><a>ویرایش</a></div>
        ...
        <div class="formBox">
            ...
            <div class="containerForm">
                ...
                <div class="DeleteBoxContainer" id="DeleteBoxContainer" onclick="closeDeleteDialog();">
                    <div class ="DeleteBox" id="DeleteBox">
                       <iframe src="Person_Delete.aspx?rowID_Person=<%=request.QueryString("rowID_Person") %>" frameborder="0"></iframe>
                    </div>
                </div>
                ...
                <div class="InterBoxFormRight" >
                    ...
                    <div class="bodyForm">
                        ...
                        <div class ="ContainerTextBoxObject">       
                            <div class="ContainerTextBoxCaption">شماره الویت  <asp:Label id="lblorder_Person" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle" >
                                <div class="effectContainerDiv"  id="container_order_Person"></div>
                                <ul class="ContainerQuotation" >
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">شماره اواویت نمایش مدیر که 1 بالاترین اولویت را دارد</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="1"   onfocus="GraphicalBorder('container_order_Person');" onblur="GraphicalBorderRemove('container_order_Person');" ID="order_Person" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                        ...
                        <div class ="ContainerTextBoxObject" >
                            ...
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_Pic_Person"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">تصویر پرسنل است که در صورت وجود باید از هارد کامپیوتر انتخاب شود</div></li></ul></a></li>
                                    <li><input id="uploadFile" tabindex="7"  placeholder="انتخاب فایل" disabled="disabled" class="fileUpload_Style" /><div class="upload-btn-wrapper"><a href="#"  class="btn" style="height :38px;position:relative ;top:2px;left:0px;margin :0;"><i class="fa  fa-upload"></i></a><asp:FileUpload  type="file" name="myfile" runat ="server"  id="Pic_Person" /></div> </li>
                                </ul>
                            </div>
                        </div>
            ...
            <div class="containerForm_Left">
                <asp:Image ID="img_Pic_Person" runat="server" style="position:relative ;top:0px;left:0px;width :100%;"  />
            </div>
        </div>
