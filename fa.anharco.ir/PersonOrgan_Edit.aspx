<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PersonOrgan_Edit.aspx.vb" Inherits="W_ISM.PersonOrgan_Edit" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><a href="#">مدیریت همکار</a><i class="fa fa-chevron-left arrow"></i><a href="#">اعضاء شرکت</a><i class="fa fa-chevron-left arrow"></i><a>ویرایش</a></div>
            ...
            <div class="containerForm">
                ...
                <div class="DeleteBoxContainer" id="DeleteBoxContainer" onclick="closeDeleteDialog();">
                    <div class ="DeleteBox" id="DeleteBox">
                       <iframe src="PersonOrgan_Delete.aspx?rowID_Person=<%=request.QueryString("rowID_Person") %>" frameborder="0"></iframe>
                    </div>
                </div>
                <div class="InterBoxFormLeft">
                    ...
                    <ul>
                        <li>
                            <a class ="LinkIcon" href="PersonOrgan_List.aspx?f1=<%=request.QueryString("f1") %>&f2=<%=request.QueryString("f2") %>&f3=<%=request.QueryString("f3") %>&f4=<%=request.QueryString("f4") %>"><i class="fa  fa-pencil"></i></a>
                            <ul>
