...
<head runat="server">
    <title></title>
     <link href="graphic/BodyGraphic.css?v=bidiFix1" rel="stylesheet" />
    ...
    <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server"></asp:ToolkitScriptManager>
     <div onclick="saveDialog.style.display='none';" id="saveDialog" style="position:fixed  ;top:0px;left:0px;width:100%;height:100%;display:none;background :rgb(0,0,0);background :rgba(0,0,0,0.5);text-align :center ;z-index:1000000" >
        ...
        <div class ="contactForm_MainPage">
            <div class="captionBox">نام : </div>
            <div class ="ContentTextBox"><asp:TextBox ID="Name_Comment" runat ="server"  ></asp:TextBox></div>
            
            <div class="captionBox">شماره تماس : </div>
            <div class ="ContentTextBox"><asp:TextBox ID="Phone_Comment" runat ="server"  ></asp:TextBox></div>
            
            <div class="captionBox">پست الکترونیکی : </div>
            <div class ="ContentTextBox"><asp:TextBox ID="Email_Comment" runat ="server"  ></asp:TextBox></div>
            
            <div class="captionBox">عنوان : </div>
            <div class ="ContentTextBox"><asp:TextBox ID="Title_Comment" runat ="server"  ></asp:TextBox></div>
            
            <div class="captionBox">توضیحات : </div>
            <div class ="ContentTextBox"><asp:TextBox ID="Text_Comment" runat ="server" TextMode ="MultiLine"   ></asp:TextBox></div>
            
            <div class="captionBox">کد امنیتی : </div>
            <div class ="ContentTextBox"><p><iframe src="showSign.aspx" style ="position:relative;top:0px;right:0px;float:right ; height:40px;width:130px;border:1px solid #aaa" frameborder ="0" scrolling ="no"  ></iframe> 
            <asp:TextBox autocomplete ="off" Height ="30" style="position:relative ;top:0px;right:10px;float:right; text-align :center;border-radius:0px;border:1px solid #aaa;color:#000;"   ID="txtSign" runat ="server" Width ="100" MaxLength="8" ></asp:TextBox></p></div>
            
            <div class="captionBox"><asp:Label id="lblErr" runat ="server" ></asp:Label></div>
            <div class ="ContentTextBox"><asp:Button ID="btn_Save" runat ="server" Text ="ارسال" class="ButtonStyle" /></div>
