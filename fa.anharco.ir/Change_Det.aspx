<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Change_Det.aspx.vb" Inherits="W_ISM.Change_Det" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
   <title>جزئیات تغییرات</title>
                        ...
                        <tr>
                            <td>
                                <table style="width :100%;font-size :9pt;font-family:yekan " dir="rtl" >
                                    ...
                                    <tr>
                                        <td>اعلان وضعیت : </td>
                                        <td><asp:TextBox  style="resize:none" ID="textStatus_Change" runat ="server" Width ="300px" TextMode ="MultiLine"  Height ="50px"  Font-Names ="tahoma" Font-Size ="8pt" ></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                        <td></td>
