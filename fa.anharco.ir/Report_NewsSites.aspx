<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Report_NewsSites.aspx.vb" Inherits="W_ISM.Report_NewsSites" %>
...
<body style ="margin :0">
    ...
    <div class="memberPanel_rightBox" >
        <div class="titleForm"><a href="#">مدیریت سایت</a><i class="fa fa-chevron-left arrow"></i><a href="#">گزارش تماس با مدیریت</a><i class="fa fa-chevron-left arrow"></i><a>لیست</a></div>
