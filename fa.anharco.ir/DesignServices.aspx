<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="DesignServices.aspx.vb" Inherits="Safe_DesignServices" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" lang="fa" dir="rtl">
<head id="Head1" runat="server">
    <title>خدمات طراحی شرکت انهار</title>
     ...
     <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" TargetControlID="txt_Search" ServiceMethod="Buscar" ServicePath="AutoCompletar.asmx" MinimumPrefixLength="2" CompletionInterval="1000" EnableCaching="true" CompletionSetCount="12"   CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"></asp:AutoCompleteExtender>  
        ...
        <div class ="backMobileMenu" id="mobileMenu4"  style ="display:none;">
           ...
           <div class ="mainScreenLayer">    
            ...
            <div class ="MessageCEO_SlideContainer" style="<%=SiteStudioStore.BgStyle("hero_DesignServices")%>">
            ...
            <div class ="MessageCEO_HeaderTextContainer"><h1 class="<%=SiteStudioStore.AlignClass("copy_DesignServices_h1")%>"><%=SiteStudioStore.Copy("copy_DesignServices_h1", "خدمات طراحی شرکت انهار")%></h1> </div>
            <div class ="MessageCEO_Box5Container" style="top:-250px;background :#fff;margin-top :0;margin-bottom :0;margin :0;">
                <div class ="MessageCEO_inner" style="top:0px;bmargin-top:0px;margin-bottom :0xp;margin :0;">
                    ...
                    <div class ="box" style="top:-10px;">
                        <img src="<%=SiteStudioStore.Asset("pic_DesignInner")%>" />
                    </div>
                    <div class ="box">  
                        <p class="<%=SiteStudioStore.AlignClass("copy_DesignServices_p1")%>" style ="color:#000;"><%=SiteStudioStore.Copy("copy_DesignServices_p1", "فاز مهندسی یا طراحی (Engineering):")%></p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_DesignServices_p2")%>" style ="color:#000;"><i class ="fa fa-chevron-left" style="font-size:14pt;color:#000;margin-left :10px;"></i><%=SiteStudioStore.Copy("copy_DesignServices_p2", "طراحی مدارک، اسناد و نقشه های مورد نیاز جهت طراحی های آتی")%></p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_DesignServices_p3")%>" style ="color:#000;"><i class ="fa fa-chevron-left" style="font-size:14pt;color:#000;margin-left :10px;"></i><%=SiteStudioStore.Copy("copy_DesignServices_p3", "تهیه درخواست ها و اسناد خرید تجهیزات، کالا و مواد")%></p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_DesignServices_p4")%>" style ="color:#000;"><i class ="fa fa-chevron-left" style="font-size:14pt;color:#000;margin-left :10px;"></i><%=SiteStudioStore.Copy("copy_DesignServices_p4", "طراحی مدارک و نقشه های فنی مربوط به نصب تجهیزات")%></p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_DesignServices_p5")%>" style ="color:#000;"><i class ="fa fa-chevron-left" style="font-size:14pt;color:#000;margin-left :10px;"></i><%=SiteStudioStore.Copy("copy_DesignServices_p5", "طراحی مدارک و نقشه های فنی مربوط به اجرای فعالیت ها")%></p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_DesignServices_p6")%>" style ="color:#000;"><%=SiteStudioStore.Copy("copy_DesignServices_p6", "در فاز مهندسی یا طراحی (Engineering) معمولا پیشرفت پروژه بر اساس مراحل طراحی و میزان نفر ساعت لازم جهت تکمیل طراحی برنامه ریزی و کنترل می شود.از جمله فعالیت های فاز طراحی یا مهندسی (Engineering) می توان به طراحی مسیر و محاسبات سازه ای اشاره نمود.")%></p>
                    </div>
                </div>
            </div>
