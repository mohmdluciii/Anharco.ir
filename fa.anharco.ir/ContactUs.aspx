<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ContactUS.aspx.vb" Inherits="Safe_ContactUS" %>
     ...
     <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" TargetControlID="txt_Search" ServiceMethod="Buscar" ServicePath="AutoCompletar.asmx" MinimumPrefixLength="2" CompletionInterval="1000" EnableCaching="true" CompletionSetCount="12"   CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"></asp:AutoCompleteExtender>  
        ...
        <div class ="backMobileMenu" id="mobileMenu4"  style ="display:none;">
           ...
           <div class ="mainScreenLayer">    
            ...
            <div class ="MessageCEO_SlideContainer" style="<%=SiteStudioStore.BgStyle("hero_ContactUs")%>">
            ...
            <div class ="MessageCEO_HeaderTextContainer"><h1 class="<%=SiteStudioStore.AlignClass("copy_ContactUs_h1")%>"><%=SiteStudioStore.Copy("copy_ContactUs_h1", "تماس با ما")%></h1> </div>
            <div class ="MessageCEO_topTextContainer">
                <p class="<%=SiteStudioStore.AlignClass("copy_ContactUs_h2")%>" style="text-align :right;font-size :16pt;font-weight:700;color:#2C3C63"><i class ="fa fa-arrow-left" style="font-size :16pt;"></i><%=SiteStudioStore.Copy("copy_ContactUs_h2", "اطلاعات شرکت")%></p>
                <p class="<%=SiteStudioStore.AlignClass("copy_ContactUs_p1")%>" style ="text-align :right;"><%=SiteStudioStore.Copy("copy_ContactUs_p1", "نام شرکت: ساختمانی انهار")%></p>
                <p class="<%=SiteStudioStore.AlignClass("copy_ContactUs_p2")%>" style ="text-align :right;"><%=SiteStudioStore.Copy("copy_ContactUs_p2", "نوع شرکت: سهامی خاص")%></p>
                <p class="<%=SiteStudioStore.AlignClass("copy_ContactUs_p3")%>" style ="text-align :right;"><%=SiteStudioStore.Copy("copy_ContactUs_p3", "تاریخ تاسیس شرکت: 1353/08/06")%></p>
                
                <p class="<%=SiteStudioStore.AlignClass("copy_ContactUs_p4")%>" style ="text-align :right;"><%=SiteStudioStore.Copy("copy_ContactUs_p4", "شماره ثبت: 149903")%></p>
                
                <p class="<%=SiteStudioStore.AlignClass("copy_ContactUs_p5")%>" style ="text-align :right;"><%=SiteStudioStore.Copy("copy_ContactUs_p5", "شناسه ملی: 10260014510")%></p>
                
                <p class="<%=SiteStudioStore.AlignClass("copy_ContactUs_p6")%>" style ="text-align :right;"><%=SiteStudioStore.Copy("copy_ContactUs_p6", "کد اقتصادی: 411175119134")%></p>
                
                <p class="<%=SiteStudioStore.AlignClass("copy_ContactUs_h3")%>" style="text-align :right;font-size :16pt;font-weight:700;color:#2C3C63"><i class ="fa fa-arrow-left" style="font-size :16pt;"></i><%=SiteStudioStore.Copy("copy_ContactUs_h3", "اطلاعات تماس")%></p>
                
                <p class="<%=SiteStudioStore.AlignClass("copy_ContactUs_p7")%>" style ="text-align :right;"><%=SiteStudioStore.Copy("copy_ContactUs_p7", "آدرس: تهران، خیابان شیخ بهایی، میدان پرسپولیس، خیابان پرسپولیس، کوچه زاهدی، کوچه بیست و یکم، پلاک 4")%></p>
                
                <p class="<%=SiteStudioStore.AlignClass("copy_ContactUs_p8")%>" style ="text-align :right;"><%=SiteStudioStore.Copy("copy_ContactUs_p8", "کد پستی: 1995775314")%></p> 
                
                <p class="<%=SiteStudioStore.AlignClass("copy_ContactUs_p9")%>" style ="text-align :right;"><%=SiteStudioStore.Copy("copy_ContactUs_p9", "تلفن: 41372-021")%></p> 
                
                <p class="<%=SiteStudioStore.AlignClass("copy_ContactUs_p10")%>" style ="text-align :right;"><%=SiteStudioStore.Copy("copy_ContactUs_p10", "فکس: 88600730-021")%></p> 
                
                <p class="<%=SiteStudioStore.AlignClass("copy_ContactUs_p11")%>" style ="text-align :right;"><%=SiteStudioStore.Copy("copy_ContactUs_p11", "پست الکترونیک: Info@anharco.ir")%></p> 
                
                <p class="<%=SiteStudioStore.AlignClass("copy_ContactUs_p12")%>" style ="text-align :right;"><%=SiteStudioStore.Copy("copy_ContactUs_p12", "وبسایت: www.anharco.ir")%></p> 
                <p class="<%=SiteStudioStore.AlignClass("copy_ContactUs_p13")%>" style ="text-align :right;"><%=SiteStudioStore.Copy("copy_ContactUs_p13", "اینستاگرام: AnharCompany")%></p>
                
                <p class="<%=SiteStudioStore.AlignClass("copy_ContactUs_p14")%>" style ="text-align :right;"><%=SiteStudioStore.Copy("copy_ContactUs_p14", "لینکدین: AnharCompany")%></p>
            ...
            <div class ="MessageCEO_TopLogoType">
             ...
             <div style ="overflow:hidden ;position:relative ;top:0px;width :100%;height:300px;">
                    <iframe style="position:relative  ;top:-60px;width :100%;min-height:360px;left:0px; " frameborder ="0" src="https://www.google.com/maps/d/embed?mid=1UqPi80ymNg5oifgofs4_h5gwaXCeG3s&ehbc=2E312F&z=15"></iframe>
                </div>
