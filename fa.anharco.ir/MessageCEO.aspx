...
<head id="Head1" runat="server">
    <title>پیام رئیس هیات مدیره شرکت انهار</title>
           ...
           <div class ="mainScreenLayer">    
            ...
            <div class ="MessageCEO_Box1Container">
                <div class ="MessageCEO_inner">
                    <div class ="box">
                        <p class="<%=SiteStudioStore.AlignClass("copy_MessageCEO_p2")%>"><%=SiteStudioStore.Copy("copy_MessageCEO_p2", "ما با گذار از فراز و نشیب های بسیار و تحولات دوران انقلاب، با انتقال دفتر مرکزی به تهران و دریافت گواهی تائید صلاحیت از سازمان برنامه و بودجه کشور، شرایط ورود به پروژه های شرکت ملی گاز، را آغاز و طی سالهای متمادی گستره این فعالیت با مجموعه های گوناگون وزارت نفت همچون شرکت ملی صنایع پتروشیمی ایران، شرکت ملی مهندسی و ساختمان نفت ایران، شرکت خطوط لوله و مخابرات نفت ایران گسترش یافته است.")%></p>
                    </div>
                    <div class ="box">
            ...
            <div class ="MessageCEO_Box3Container">
                <div class ="MessageCEO_inner">
                    <div class ="box">
                        <p class="<%=SiteStudioStore.AlignClass("copy_MessageCEO_p4")%>"><%=SiteStudioStore.Copy("copy_MessageCEO_p4", "شرکت انهار افتخار دارد در راستای تلاش همگی عزیزان شاغل خود، به وظیفه حمایت از آنان به اشکال مختلف اقدام نماید. افزایش دانش و توانمندی تخصصی از طریق استفاده از مراکز آموزشی، همکاری در ارائه تسهیلات بلاعوض و بدون بهره در جهت بالا بردن آسایش و رفاه کارکنان در این راستا تعریف می گردد.")%></p>
                    </div>
                    <div class ="box">
            ...
            <div class ="MessageCEO_Box4Container">
                <div class ="MessageCEO_inner">
                    ...
                    <div class ="box">  
                        <p class="<%=SiteStudioStore.AlignClass("copy_MessageCEO_p5")%>"><%=SiteStudioStore.Copy("copy_MessageCEO_p5", "شرکت انهار به عنوان یکی از شرکت های طرفدار محیط زیست و هم چنین در حوزه انجام وظیفه مرتبط با مسئولیت های اجتماعی دارای کارنامه قابل قبولی می باشد. سرزمینمان ایران امروزه بشدت نیازمند خدمتگزاران واقعی می باشد که بدون هیچ چشم داشت در قبال حفظ محیط زیست آن و تعهد در انجام مسئولیت های اجتماعی پایبند می باشد.")%></p>
                    </div>
                </div>
            </div>
            ...
            <div class ="MessageCEO_Box5Container">
                <div class ="MessageCEO_inner">
                    ...
                    <div class ="box">  
                        <p class="<%=SiteStudioStore.AlignClass("copy_MessageCEO_p6")%>"><%=SiteStudioStore.Copy("copy_MessageCEO_p6", "در خاتمه جا دارد یاد و خاطره 3 نفر از موسسان شرکت را که امروزه در جمع ما نیستند:")%></p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_MessageCEO_p7")%>"><i class ="fa fa-chevron-left" style="font-size:14pt;color:#fff;margin-left :10px;"></i><%=SiteStudioStore.Copy("copy_MessageCEO_p7", "جناب آقای محمدباقر عظیمی")%></p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_MessageCEO_p8")%>"><i class ="fa fa-chevron-left" style="font-size:14pt;color:#fff;margin-left :10px;"></i><%=SiteStudioStore.Copy("copy_MessageCEO_p8", "جناب آقای جواد معظمی")%></p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_MessageCEO_p9")%>"><i class ="fa fa-chevron-left" style="font-size:14pt;color:#fff;margin-left :10px;"></i><%=SiteStudioStore.Copy("copy_MessageCEO_p9", "جناب آقای محمدعلی خرمی")%></p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_MessageCEO_p10")%>"><%=SiteStudioStore.Copy("copy_MessageCEO_p10", "گرامی داریم و با افتخار تمام، راه و پیمان آنان در جهت خدمت رسانی و آبادانی را به قدر توان ادامه دهیم و این تفکر برجسته را به فرهنگی عام در سازمان و خانواده بزرگ انهار نهادینه گردانیم.")%></p>
                    </div>
                </div>
            </div>
