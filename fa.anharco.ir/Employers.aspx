<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Employers.aspx.vb" Inherits="Safe_Employers" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" lang="fa" dir="rtl">
<head id="Head1" runat="server">
    <title>معرفی کارفرمایان شرکت انهار</title>
     ...
     <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" TargetControlID="txt_Search" ServiceMethod="Buscar" ServicePath="AutoCompletar.asmx" MinimumPrefixLength="2" CompletionInterval="1000" EnableCaching="true" CompletionSetCount="12"   CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"></asp:AutoCompleteExtender>  
        ...
        <div class ="backMobileMenu" id="mobileMenu4"  style ="display:none;">
           ...
           <div class ="mainScreenLayer">    
            ...
            <div class ="MessageCEO_SlideContainer" style="<%=SiteStudioStore.BgStyle("hero_Employers")%>">
            ...
            <div class ="MessageCEO_HeaderTextContainer"><h1 class="<%=SiteStudioStore.AlignClass("copy_Employers_h1")%>"><%=SiteStudioStore.Copy("copy_Employers_h1", "معرفی کارفرمایان")%></h1> </div>
            <div class ="MessageCEO_topTextContainer" style ="text-align :center ;">
                <div style="position:relative ;top:-150px;float:none;margin-left :auto ;margin-right :auto ;width :60%;min-height:400px;display:inline-block;text-align :center ; ">
                    <div style="position:relative ;top:0px;float:right ;width :100%;min-height:200px;text-align :right;"><img src="<%=SiteStudioStore.Asset("pic_nioc")%>"  /></div>
                    <div style="position:relative ;top:0px;float:right ;width :100%;min-height:300px;">
                        <p class="<%=SiteStudioStore.AlignClass("copy_Employers_1_name")%>" style="font-weight:900;font-size:18pt;position:relative ;top:0px;width :100%;text-align :right ;"><%=SiteStudioStore.Copy("copy_Employers_1_name", "شرکت ملی نفت ایران")%></p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_Employers_1_ceo")%>" style="position:relative ;top:0px;width :100%;text-align :right ;"><i class ="fa fa-arrow-left"></i><%=SiteStudioStore.Copy("copy_Employers_1_ceo", "مدیر عامل : حمید بورد")%></p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_Employers_1_addr")%>" style="position:relative ;top:0px;width :100%;text-align :right ;"><i class ="fa fa-arrow-left"></i><%=SiteStudioStore.Copy("copy_Employers_1_addr", "خیابان حافظ ، نبش خیابان رودسرتماس با شرکت ملی نفت ایران: ۶۱۶۵۱-۰۲۱")%></p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_Employers_1_web")%>" style="position:relative ;top:0px;width :100%;text-align :right ;"><i class ="fa fa-arrow-right"></i><%=SiteStudioStore.Copy("copy_Employers_1_web", "وب سایت")%></p>
                    </div>
                    
               </div>
               
               <div style="position:relative ;top:-150px;float:none;margin-left :auto ;margin-right :auto ;width :60%;min-height:400px;display:inline-block;text-align :center ; ">
                    <div style="position:relative ;top:0px;float:right ;width :100%;min-height:200px;text-align :right;"><img src="<%=SiteStudioStore.Asset("pic_logogz")%>"  /></div>
                    <div style="position:relative ;top:0px;float:right ;width :100%;min-height:300px;">
                        <p class="<%=SiteStudioStore.AlignClass("copy_Employers_2_name")%>" style="font-weight:900;font-size:18pt;position:relative ;top:0px;width :100%;text-align :right ;"><%=SiteStudioStore.Copy("copy_Employers_2_name", "شرکت ملی گاز ایران")%></p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_Employers_2_ceo")%>" style="position:relative ;top:0px;width :100%;text-align :right ;"><i class ="fa fa-arrow-left"></i><%=SiteStudioStore.Copy("copy_Employers_2_ceo", "مدیر عامل : دکتر سعید توکلی")%></p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_Employers_2_addr")%>" style="position:relative ;top:0px;width :100%;text-align :right ;"><i class ="fa fa-arrow-left"></i><%=SiteStudioStore.Copy("copy_Employers_2_addr", "تهران ، خیابان عضدی (آبان)، پلاک ۲۹")%></p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_Employers_2_web")%>" style="position:relative ;top:0px;width :100%;text-align :right ;"><i class ="fa fa-arrow-right"></i><%=SiteStudioStore.Copy("copy_Employers_2_web", "وب سایت")%></p>
                    </div>
