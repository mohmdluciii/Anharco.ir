<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SubMenu_Edit.aspx.vb" Inherits="W_ISM.SubMenu_Edit" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
       <div class="titleForm"><a href="#">راه اندازی سامانه</a><i class="fa fa-chevron-left arrow"></i><a href="#">مدیریت زیر منو</a><i class="fa fa-chevron-left arrow"></i><a>ویرایش</a></div>
            ...
            <div class="containerForm">
                <div class="SaveBoxContainer" id="saveContainer">
                    <div class ="SaveBox" id="saveDialog">
                        <p><i class='fa fa-floppy-o'></i> &nbsp;&nbsp;تغییرات با<span style="color:#DB6767"> موفقیت </span>در سامانه ثبت گردید</p>
                ...
                <div class="DeleteBoxContainer" id="DeleteBoxContainer" onclick="closeDeleteDialog();">
                    <div class ="DeleteBox" id="DeleteBox">
                       <iframe src="SubMenu_Delete.aspx?rowID_SubMenu=<%=request.QueryString("rowID_SubMenu") %>" frameborder="0"></iframe>
                    </div>
                </div>
                <div class="InterBoxFormLeft">
                    <ul>
                        <li>
                            <a class ="LinkIcon" href="SubMenu_List.aspx?f1=<%=request.QueryString("f1") %>"><i class="fa  fa-pencil"></i></a>
                            <ul>
                ...
                <div class="InterBoxFormRight" >
                    <div class="headForm" >
                        ...
                        <a href="#" title ="اطلاعات جدید" id="btnNew_top" runat ="server" ><i class="fa fa-trash-o"></i></a>
                    </div>
                      ...
                      <div class ="ContainerTextBoxObject">
                            ...
                            <div class="ContainerTextBoxStyle">
                                ...
                                <ul class="ContainerQuotation">
                                    ...
                                    <li><asp:DropDownList  id="cmb_TopMenu" tabindex="1" runat ="server"  onfocus="GraphicalBorder('container_TopMenu');" onblur="GraphicalBorderRemove('container_TopMenu');"></asp:DropDownList></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption">نام &nbsp; *<asp:Label id="lblname_SubMenu" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle" >
                                <div class="effectContainerDiv"  id="container_name_SubMenu"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">نام منو زیر منو است</div></li></ul></a></li>
                                    <li> <asp:TextBox   tabindex="1"  onfocus="GraphicalBorder('container_name_SubMenu');" onblur="GraphicalBorderRemove('container_name_SubMenu');" ID="name_SubMenu" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        
                        <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption">کد &nbsp; *<asp:Label id="lblcode_subMenu" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle" >
                                <div class="effectContainerDiv"  id="container_code_subMenu"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">کد زیر منو است که ترتیب نمایش زیر منو را نمایش می دهد</div></li></ul></a></li>
                                    <li> <asp:TextBox   tabindex="1"  onfocus="GraphicalBorder('container_code_subMenu');" onblur="GraphicalBorderRemove('container_code_subMenu');" ID="code_subMenu" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                         ...
                         <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption">منبع &nbsp; *<asp:Label id="lblsource_subMenu" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle" >
                                <div class="effectContainerDiv"  id="container_source_subMenu"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">منبع زیر منو است </div></li></ul></a></li>
                                    <li> <asp:DropDownList   tabindex="1"  onfocus="GraphicalBorder('container_source_TopMenu');" onblur="GraphicalBorderRemove('container_source_TopMenu');" ID="cmb_source_subMenu"  runat ="server"  ></asp:DropDownList></li>
                                </ul>
                            </div>
                        </div>
                       <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption">عنوان &nbsp; *<asp:Label id="lblTitle_submenu" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle" >
                                <div class="container_Title_submenu"  id="container_Title_submenu"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">عنوان صفحه یا محتویات تگ title است</div></li></ul></a></li>
                                    <li> <asp:TextBox   tabindex="1"  onfocus="GraphicalBorder('container_Title_submenu');" onblur="GraphicalBorderRemove('container_Title_submenu');" ID="Title_submenu" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                       <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption"> متاتگ کلمات کلیدی &nbsp; <asp:Label id="lblkeyword_subMenu" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle"  style="height:108px" >
                                <div class="effectContainerDiv"  id="container_keyword_subMenu"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">کلمات کلیدی در صفحه است که باید با - از هم جدا شود</div></li></ul></a></li>
                                    <li> <asp:TextBox   tabindex="1" style="height:100px" TextMode ="MultiLine"  onfocus="GraphicalBorder('container_keyword_subMenu');" onblur="GraphicalBorderRemove('container_keyword_subMenu');" ID="keyword_subMenu" AutoComplete="off" runat ="server"   MaxLength="256"  ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption"> &nbsp;متاتگ توصیفات <asp:Label id="lbldescription_submenu" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle" style="height:108px" >
                                <div class="effectContainerDiv"  id="container_description_submenu"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">توصیفات یا متاتگ Description در صفحه است </div></li></ul></a></li>
                                    <li> <asp:TextBox   tabindex="1" style="height:100px"   TextMode ="MultiLine"   onfocus="GraphicalBorder('container_description_submenu');" onblur="GraphicalBorderRemove('container_description_submenu');" ID="description_submenu" AutoComplete="off" runat ="server"  MaxLength="256"  ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                         <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption"><asp:CheckBox ID="chk_status_subMenu" runat ="server" Text ="غیر فعال" />&nbsp;<asp:Label id="lbl_statusFooter_subMenu" runat ="server" class="errStyle" ></asp:Label><asp:CheckBox ID="chk_statusFooter_subMenu" runat ="server" Text ="فوتر" />&nbsp;<asp:CheckBox ID="chk_Manager_submenu" runat ="server" Text ="مدیران" /></div>
                        </div>
                        ...
                        <asp:Image Visible ="false"  ID="img_File_SubMenu" runat="server"  style="width:3cm;height:4cm;position:absolute;top:3.1cm; left:0.7cm"  />
                    </div>
                </div>
            </div>    
