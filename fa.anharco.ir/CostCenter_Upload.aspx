<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="CostCenter_Upload.aspx.vb" Inherits="W_ISM.CostCenter_Upload" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        ...
        <div class="titleForm"><a href="#">عملیات پایه</a><i class="fa fa-chevron-left arrow"></i><a href="#">ارسال فایل پرسنل</a><i class="fa fa-chevron-left arrow"></i><a>درج</a></div>
        ...
        <div class="formBox">
            ...
            <div class="containerForm">
                ...
                <div class="InterBoxFormLeft">
                    <ul>
                        <li>
                            <a class ="LinkIcon" href="CostCenter_Upload.aspx"><i class="fa  fa-pencil"></i></a>
                            <ul>
                    ...
                    <ul>
                        <li>
                            <a class ="LinkIcon" href="Template/Template_CostCener.xlsx"><i class="fa  fa-info-circle "></i></a>
                            <ul>
                ...
                <div class="InterBoxFormRight" >
                    ...
                    <div class="bodyForm">
                         ...
                         <div class ="ContainerTextBoxObject" >
                            <div class="ContainerTextBoxCaption">انتخاب فایل منطقه پرسنل جدید  &nbsp;  <asp:Label id="lblFileUpload1" runat ="server"  class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_FileUpload1"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">فایل اکسل باید از هارد کامپیوتر انتخاب شود</div></li></ul></a></li>
