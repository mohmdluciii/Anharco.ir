<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="changePassword_Person.aspx.vb" Inherits="W_ISM.changePassword_Person" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><i class="fa fa-file-text-o icon"></i><a href="#"> تغییرات   </a><i class="fa fa-chevron-left arrow"></i><a href="#"> تغییر کلمه عبوری پنل شما  </a><i class="fa fa-chevron-left arrow"></i><a>درج</a></div>
                    ...
                    <div class="bodyForm">
                        ...
                        <div class ="ContainerTextBoxObject">       
                            ...
                            <div class="ContainerTextBoxStyle" >
                                ...
                                <ul class="ContainerQuotation" >
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">کلمه عبوری فعلی است که با آن وارد پنل شده اید و قصد تغییر آنرا دارید</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="1" TextMode ="Password"   onfocus="GraphicalBorder('container_CurrentPassword');" onblur="GraphicalBorderRemove('container_CurrentPassword');" ID="CurrentPassword" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class ="ContainerTextBoxObject">       
                            ...
                            <div class="ContainerTextBoxStyle" >
                                ...
                                <ul class="ContainerQuotation" >
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">کلمه عبوری جدید است که قصد دارید با آن از این به بعد وارد پنل شوید</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="1" TextMode ="Password"   onfocus="GraphicalBorder('container_newPassword');" onblur="GraphicalBorderRemove('container_newPassword');" ID="newPassword" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                         <div class ="ContainerTextBoxObject nobr"> </div> 
                        <div class ="ContainerTextBoxObject">       
                            <div class="ContainerTextBoxCaption">   تکرار عبوری جدید&nbsp;* <asp:Label id="lblnewPassword1" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle" >
                                <div class="effectContainerDiv"  id="container_newPassword1"></div>
                                <ul class="ContainerQuotation" >
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">تکرار کلمه عبوری جدید است</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="1" TextMode ="Password"   onfocus="GraphicalBorder('container_newPassword1');" onblur="GraphicalBorderRemove('container_newPassword1');" ID="newPassword1" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        <div class ="ContainerTextBoxObject nobr"> </div> 
