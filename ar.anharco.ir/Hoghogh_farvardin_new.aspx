<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Hoghogh_farvardin_new.aspx.vb" Inherits="W_ISM.Hoghogh_farvardin_new" %>
            ...
            <div class="containerForm" style="width:100%;">
                ...
                <div class="SaveBoxContainer" id="saveContainer">
                    ...
                    <div class="bodyForm">
                        ...
                        <iframe style ="position:relative ;top:0px;left:0px;width:100%;min-height:500px;" frameborder ="0" scrolling ="auto" src="Hoghogh_Show.aspx?rowID_OpenHoghogh=11" ></iframe>
                    </div>
                </div>
            </div>    
