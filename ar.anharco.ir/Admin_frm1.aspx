<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Admin_frm1.aspx.vb" Inherits="Safe_Admin_frm1" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><a href="#">مدیریت سایت </a><i class="fa fa-chevron-left arrow"></i><a href="#">کاربر مدیریتی</a><i class="fa fa-chevron-left arrow"></i><a>درج</a></div>
                        ...
                        <div class ="ContainerTextBoxObject">       
                            ...
                            <div class="ContainerTextBoxStyle">
                                ...
                                <ul class="ContainerQuotation">
                                    ...
                                    <li> <asp:TextBox  tabindex="1"  onfocus="GraphicalBorder('container_password_Admin');" onblur="GraphicalBorderRemove('container_password_Admin');" ID="password_Admin" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
