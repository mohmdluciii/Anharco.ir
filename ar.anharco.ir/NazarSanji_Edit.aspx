<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="NazarSanji_Edit.aspx.vb" Inherits="W_ISM.NazarSanji_Edit" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><a href="#">مدیریت همکار</a><i class="fa fa-chevron-left arrow"></i><a href="#">نظر سنجی</a><i class="fa fa-chevron-left arrow"></i><a>ویرایش</a></div>
            ...
            <div class="containerForm">
                ...
                <div class="DeleteBoxContainer" id="DeleteBoxContainer" onclick="closeDeleteDialog();">
                    <div class ="DeleteBox" id="DeleteBox">
                       <iframe src="NazarSanji_Delete.aspx?rowID_NazarSanji=<%=request.QueryString("rowID_NazarSanji") %>" frameborder="0"></iframe>
                    </div>
                </div>
                ...
                <div class="InterBoxFormLeft">
                    <ul>
                        <li>
                            <a class ="LinkIcon" href="NazarSanji_List.aspx"><i class="fa  fa-pencil"></i></a>
                            <ul>
                ...
                <div class="InterBoxFormRight" >
                    ...
                    <div class="bodyForm">
                        ...
                        <div class ="ContainerTextBoxObject">       
                            <div class="ContainerTextBoxCaption">عنوان سوال&nbsp;* <asp:Label id="lblTitle_NazarSanji" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle" style="height:88px">
                                <div class="effectContainerDiv"  id="container_Title_NazarSanji"></div>
                                <ul class="ContainerQuotation" >
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">عنوان سوالی است که برای نظر سنجی مطرح می شود</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="1" style="height:80px" TextMode ="MultiLine"  onfocus="GraphicalBorder('container_Title_NazarSanji');" onblur="GraphicalBorderRemove('container_Title_NazarSanji');" ID="Title_NazarSanji" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
