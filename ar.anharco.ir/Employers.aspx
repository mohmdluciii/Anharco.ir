...
<head id="Head1" runat="server">
    <title>معرفی أصحاب العمل شركة أنهار الإنشائية </title>
     ...
     <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" TargetControlID="txt_Search" ServiceMethod="Buscar" ServicePath="AutoCompletar.asmx" MinimumPrefixLength="2" CompletionInterval="1000" EnableCaching="true" CompletionSetCount="12"   CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"></asp:AutoCompleteExtender>  
        ...
        <div class ="backMobileMenu" id="mobileMenu4"  style ="display:none;">
           ...
           <div class ="mainScreenLayer">    
            ...
            <div class ="MessageCEO_HeaderTextContainer"><h1 class="<%=SiteStudioStore.AlignClass("copy_Employers_h1")%>"><%=SiteStudioStore.Copy("copy_Employers_h1", "أصحاب العمل")%></h1> </div>
            <div class ="MessageCEO_topTextContainer">
                 <div style="position:relative ;top:-150px;float:none;margin-left :auto ;margin-right :auto ;width :60%;min-height:400px;display:inline-block;text-align :center ; ">
                    ...
                    <div style="position:relative ;top:0px;float:right ;width :100%;min-height:300px;">
                        <p style="font-weight:900;font-size:18pt;position:relative ;top:0px;width :100%;text-align :right ;"> شركة النفط الوطنية الإيرانية</p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_Employers_1_ceo")%>" style="position:relative ;top:0px;width :100%;text-align :right ;"><i class ="fa fa-arrow-left"></i><%=SiteStudioStore.Copy("copy_Employers_1_ceo", "المدير التنفيذي: حمید بورد")%></p>
                        <p style="position:relative ;top:0px;width :100%;text-align :right ;"><i class ="fa fa-arrow-left"></i>شارع حافظ، زاوية شارع رودسارتماس مع شركة النفط الوطنية الإيرانية: 61651-021</p>
                        <p style="position:relative ;top:0px;width :100%;text-align :right ;"><a class="buttonResume" style="color:#000;" href="https://www.nioc.ir/" target ="_blank" >موقع إلكتروني <i class ="fa fa-arrow-right"></i></a></p>
                    </div>
               ...
               <div style="position:relative ;top:-150px;float:none;margin-left :auto ;margin-right :auto ;width :60%;min-height:400px;display:inline-block;text-align :center ; ">
                    ...
                    <div style="position:relative ;top:0px;float:right ;width :100%;min-height:300px;">
                        <p style="font-weight:900;font-size:18pt;position:relative ;top:0px;width :100%;text-align :right ;">شركة الغاز الوطنية الإيرانية</p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_Employers_2_ceo")%>" style="position:relative ;top:0px;width :100%;text-align :right ;"><i class ="fa fa-arrow-left"></i><%=SiteStudioStore.Copy("copy_Employers_2_ceo", "المدير التنفيذي : دکتر سعید توکلی")%></p>
                        <p style="position:relative ;top:0px;width :100%;text-align :right ;"><i class ="fa fa-arrow-left"></i>رقم 29، شارع ازدي (ابان)، طهران</p>
                        <p style="position:relative ;top:0px;width :100%;text-align :right ;"><a class="buttonResume" style="color:#000;" href="https://nigc.ir" target ="_blank" >موقع إلكتروني <i class ="fa fa-arrow-right"></i></a></p>
                    </div>
