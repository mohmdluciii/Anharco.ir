<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PanelPerson_LogIn_Edit1.aspx.vb" Inherits="W_ISM.PanelPerson_LogIn_Edit1" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><a href="#">تنظیمات سایت</a><i class="fa fa-chevron-left arrow"></i><a href="#">مدیریت متن ورود به پنل</a><i class="fa fa-chevron-left arrow"></i><a>ویرایش</a></div>
            ...
            <div class="containerForm">
                ...
                <div class="DeleteBoxContainer" id="DeleteBoxContainer" onclick="closeDeleteDialog();">
                    <div class ="DeleteBox" id="DeleteBox">
                       <iframe src="PanelPerson_LogIn_Delete1.aspx?rowID_PanelPerson_LogIn=<%=request.QueryString("rowID_PanelPerson_LogIn") %>" frameborder="0"></iframe>
                    </div>
                </div>
                <div class="InterBoxFormLeft">
                    <ul>
                        <li>
                            <a class ="LinkIcon" href="PanelPerson_LogIn_List1.aspx"><i class="fa  fa-pencil"></i></a>
                            <ul>
                ...
                <div class="InterBoxFormRight" >
                    ...
                    <div class="bodyForm">
                        <div class ="ContainerTextBoxObject">                           
                            <div class="ContainerTextBoxCaption">متن ورود به پنل&nbsp; *<asp:Label id="lblname_PanelPerson_LogIn" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle" style="height:208px;">
                                <div class="effectContainerDiv"  id="container_name_PanelPerson_LogIn"></div>
                                <ul class="ContainerQuotation">
                                    ...
                                    <li> <asp:TextBox  tabindex="1" style="height:200px;" TextMode="MultiLine"   onfocus="GraphicalBorder('container_name_PanelPerson_LogIn');" onblur="GraphicalBorderRemove('container_name_PanelPerson_LogIn');" ID="name_PanelPerson_LogIn" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
