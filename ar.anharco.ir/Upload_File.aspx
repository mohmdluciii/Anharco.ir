<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Upload_File.aspx.vb" Inherits="W_ISM.Upload_File" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><a href="#">مدیریت سایت</a><i class="fa fa-chevron-left arrow"></i><a href="#"><asp:Label ID="lbl_Title" runat ="server" text="مدیریت فایل" ></asp:Label></a><i class="fa fa-chevron-left arrow"></i><a>درج</a></div>
