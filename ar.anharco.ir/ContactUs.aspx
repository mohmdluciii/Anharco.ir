     ...
     <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" TargetControlID="txt_Search" ServiceMethod="Buscar" ServicePath="AutoCompletar.asmx" MinimumPrefixLength="2" CompletionInterval="1000" EnableCaching="true" CompletionSetCount="12"   CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"></asp:AutoCompleteExtender>  
        ...
        <div class ="backMobileMenu" id="mobileMenu4"  style ="display:none;">
           ...
           <div class ="mainScreenLayer">    
            ...
            <div class ="MessageCEO_HeaderTextContainer"><h1 class="<%=SiteStudioStore.AlignClass("copy_ContactUs_h1")%>"><%=SiteStudioStore.Copy("copy_ContactUs_h1", "التواصل معنا")%></h1> </div>
            <div class ="MessageCEO_topTextContainer">
                ...
                <p style ="text-align :right;">
                    اسم الشركة: أنهار الإنشائية
                </p>
                <p style ="text-align :right;">
                   نوع الشرکة : مساهمة خاصة 
                </p>
                <p style ="text-align :right;">
                   تاریخ تأسیس الشرکة : 28/10/1974 م
                </p>
                ...
                <p style ="text-align :right;">
                 رمز التعریف : 10260014510
                </p>
                
                <p style ="text-align :right;">
                 الرمز الإقتصادي : 411175119134
                </p>
                ...
                <p style ="text-align :right;">
                    المقر الرئیسي : طهران ، شارع الشیخ بهائي ، ساحة برسبولیس ، شارع برسبولیس ، زقاق زاهدي رقم 4
                </p>
                
                <p style ="text-align :right;">
                   الرمز البریدي : 1995775314
                </p> 
                
                <p style ="text-align :right;">
                   رقم الهاتف : 41372-009821
                </p> 
                
                <p style ="text-align :right;">
                 رقم الفاکس : 88600730-009821
                </p> 
                
                <p style ="text-align :right;">
                 البرید الإلکتروني : <a  target ="_blank"  style ="color:#000;" href="mailto:Info@anharco.ir">Info@anharco.ir</a> 
                </p> 
                
                <p style ="text-align :right;">
                    عنوان الموقع: www.anharco.ir
                </p> 
                <p style ="text-align :right;">
                    إنستغرام : <a target ="_blank" style ="color:#000;"  href="https://www.instagram.com/AnharCompany">AnharCompany</a> 
                </p>
