<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="User_SelectQuestionService.aspx.vb" Inherits="W_ISM.User_SelectQuestionService" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><i class="fa fa-address-book  icon"></i><a href="#"> درخواست تعمیر و نگهداری</a><i class="fa fa-chevron-left arrow"></i><a href="#">لیست درخواست ها</a><i class="fa fa-chevron-left arrow"></i><a>لیست</a></div>
        ...
        <div class="formBox">
           ...
           <div class ="ContainerTextBoxObject">
               <p style ="position:relative ;top:0px;left:0px;width :100%;direction:rtl;margin :0px;">
                <asp:Button ID="btn_Save"  OnClientClick="StartProgressBar()"   runat ="server" style="font-size:10pt;font-family:yekan;border:0;color:#fff;background :#6498FE;cursor:pointer ;padding:5px 10px 5px 10px;  " Text ="مرحله بعدی" />
            </p>
