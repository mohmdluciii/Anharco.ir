<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Banner_Edit.aspx.vb" Inherits="W_ISM.Banner_Edit" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
       <div class="titleForm"><a href="#">راه اندازی سامانه</a><i class="fa fa-chevron-left arrow"></i><a href="#">مدیریت بنر</a><i class="fa fa-chevron-left arrow"></i><a>ویرایش</a></div>
            ...
            <div class="containerForm">
                ...
                <div class="DeleteBoxContainer" id="DeleteBoxContainer" onclick="closeDeleteDialog();">
                    <div class ="DeleteBox" id="DeleteBox">
                       <iframe src="Banner_delete.aspx?RowID_Banner=<%=request.QueryString("RowID_Banner") %>" frameborder="0"></iframe>
                    </div>
                </div>
                <div class="InterBoxFormLeft">
                    <ul>
                        <li>
                            <a class ="LinkIcon" href="Banner_List.aspx?f1=<%=request.QueryString("f1") %>"><i class="fa  fa-pencil"></i></a>
                            <ul>
                ...
                <div class="InterBoxFormRight" >
                    ...
                    <div class="bodyForm">
                      ...
                      <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption">عنوان&nbsp; *<asp:Label id="lblName_Banner" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_Name_Banner"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">عنوان بنری است که قصد درج آنرا دارید</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="2"  onfocus="GraphicalBorder('container_Name_Banner');" onblur="GraphicalBorderRemove('container_Name_Banner');" ID="Name_Banner" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption">پیوند&nbsp; *<asp:Label id="lbllink_Banner" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_link_Banner"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">لینکی است که با کلیک روی بنر کاربر به آن ارجاع داده می شود</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="2"  onfocus="GraphicalBorder('container_link_Banner');" onblur="GraphicalBorderRemove('container_link_Banner');" ID="link_Banner" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        <div class ="ContainerTextBoxObject">
                            ...
                            <div class="ContainerTextBoxStyle">
                                ...
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">اولویت ترتیب نمایش بنر است که باید یک عدد باشد عدد کمتر اولویت بالاتری دارد</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="2"  onfocus="GraphicalBorder('container_no_Banner');" onblur="GraphicalBorderRemove('container_no_Banner');" ID="no_Banner" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                       <div class ="ContainerTextBoxObject" >
                            <div class="ContainerTextBoxCaption">تصویر  &nbsp;  <asp:Label id="lblFile_Banner" runat ="server"  class="errStyle" ></asp:Label>&nbsp;<asp:Label runat ="server" ID="lblFileName" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_File_Banner"></div>
                                <ul class="ContainerQuotation">
                                    ...
                                    <li><input id="uploadFile" tabindex="7"  placeholder="انتخاب فایل" disabled="disabled" class="fileUpload_Style" /><div class="upload-btn-wrapper"><a href="#"  class="btn" style="height :38px;position:relative ;top:4px;left:0px;margin :0;"><i class="fa  fa-upload"></i></a><asp:FileUpload  type="file" name="myfile" runat ="server"  id="File_Banner" /></div> </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <asp:Image ID="img_File_Banner" runat="server"  style="width:3cm;height:4cm;position:absolute;top:3.1cm; left:0.7cm"  />
                    </div>
                </div>
            </div>    
