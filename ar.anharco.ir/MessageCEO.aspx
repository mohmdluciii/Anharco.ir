...
<head id="Head1" runat="server">
    <title>پیام رئیس . أعضاء مجلس إدارة الشرکة شركة أنهار الإنشائية </title>
     ...
     <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" TargetControlID="txt_Search" ServiceMethod="Buscar" ServicePath="AutoCompletar.asmx" MinimumPrefixLength="2" CompletionInterval="1000" EnableCaching="true" CompletionSetCount="12"   CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"></asp:AutoCompleteExtender>  
        ...
        <div class ="backMobileMenu" id="mobileMenu4"  style ="display:none;">
           ...
           <div class ="mainScreenLayer">    
            ...
            <div class ="MessageCEO_HeaderTextContainer"><h1 class="<%=SiteStudioStore.AlignClass("copy_MessageCEO_h1")%>"><%=SiteStudioStore.Copy("copy_MessageCEO_h1", "کلمة رئیس مجلس إدارة الشرکة")%></h1> </div>
            <div class ="MessageCEO_topTextContainer">
                <p class="<%=SiteStudioStore.AlignClass("copy_MessageCEO_p1")%>"><%=SiteStudioStore.Copy("copy_MessageCEO_p1", "السلام علیکم ورحمة الله وبرکاته لقد مضی علی نشاطات الشرکة حوالي 50 سنة ، نحن سعداء جداً عندما نری ثمار نجاح مشاریعنا وتحقیق أهدافنا علی کافة الأصعدة بسبب الوفاء بإلتزاماتنا ، " & Environment.NewLine & "إن تاريخ وأداء شركة أنهار الإنشائية منذ البداية يظهر مدی الجهد الذي بذله مدراء الشرکة لرفع مستوى الثقافة والتعليم للأجیال الصاعدة من الشباب في بناء المجمعات التعليمية والرياضية . " & Environment.NewLine & "وفي هذا السیاق تم بناء أکثر من مائة مرکز تعليمي وثقافي في مدن کلبایکان وخوانسار وخمین وأریافها لکي لا یشعر الشباب والیافعین في هذه الأریاف النائیة بالعزلة والحرمان والتي یعد سجلاً مشرفاً لما تبذلها في هذا المضمار .")%></p>
            </div>
            ...
            <div class ="MessageCEO_Box1Container">
                <div class ="MessageCEO_inner">
                    <div class ="box">
                        <p class="<%=SiteStudioStore.AlignClass("copy_MessageCEO_p2")%>"><%=SiteStudioStore.Copy("copy_MessageCEO_p2", "باشرت شركة أنهار الإنشائية نشاطاتها العمرانیة لأول مرة بعد إنتصار الثورة الإسلامیة المظفرة حیث تم نقل مقرها من کلبایکان الی طهران العاصمة ، وحصلت علی أول شهادة تأهیل الصلاحیة من منظمة التخطیط والمیزانیة في مجال تنفیذ مشاریع شرکة الغاز الوطنیة ثم بادرت الی تطویر نشاطاتها وتعاونها مع سائر القطاعات الحکومیة کوزارة النفط والشرکة الوطنیة للبتروکیمیاویات وشرکة خطوط أنابیب النفط والغاز والإتصالات وغیرها .")%></p>
                    </div>
                    <div class ="box">
            ...
            <div class ="MessageCEO_Box2Container">
                <div class ="MessageCEO_inner">
                    ...
                    <div class ="box">  
                        <p class="<%=SiteStudioStore.AlignClass("copy_MessageCEO_p3")%>"><%=SiteStudioStore.Copy("copy_MessageCEO_p3", "وقد لعب الکوادر العاملة في شركة أنهار الإنشائية من المدراء والمهندسین والخبراء والتقنیین دوراً متمیزاً في تنفیذ المهام المخولة إلیهم بنجاح ودقة وإمعان ، وبهذه المناسبة تعرب الشرکة عن تقديرها وشكرها لجميع المنتسبین والکوادر العاملة على جهودهم الحثیثة لتحقیق أهداف الشرکة . اليوم، الوطن بحاجة ماسة إلى کوادر نشطة وملتزمة بحماية البيئة وملتزمة بوظائفهم وواجیاتهم الاجتماعية .")%></p>
                    </div>
                </div>
            </div>
            ...
            <div class ="MessageCEO_Box3Container">
                <div class ="MessageCEO_inner">
                    <div class ="box">
                        <p>وفي الختام ، نكرم ذكرى مؤسسي هذه الشركة الذین بذلوا قصاری جهودهم من أجل تطویر نشاطات وخدمات شركة أنهار الإنشائية لتشمل کافة المجالات الإجتماعیة والثقافیة والصناعیة وسوف نواصل طریقهم من أجل خدمة الشعب وتنمية البلاد بكل ما أوتينا من قوة .</p>
                        <p>مع تحیات 
                       <br />
رئیس مجلس إدارة الشرکة
</p>
                    </div>
                    <div class ="box">
