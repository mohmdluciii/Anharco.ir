        ...
        <div class ="backMobileMenu" id="mobileMenu4"  style ="display:none;">
           ...
           <div class ="mainScreenLayer">    
            ...
            <div class ="MessageCEO_topTextContainer">
                <p class="<%=SiteStudioStore.AlignClass("copy_MessageCEO_p1")%>"><%=SiteStudioStore.Copy("copy_MessageCEO_p1", "السلام علیکم ورحمة الله وبرکاته لقد مضی علی نشاطات الشرکة حوالي 50 سنة ، نحن سعداء جداً عندما نری ثمار نجاح مشاریعنا وتحقیق أهدافنا علی کافة الأصعدة بسبب الوفاء بإلتزاماتنا ، إن تاريخ وأداء شركة أنهار الإنشائية منذ البداية يظهر مدی الجهد الذي بذله مدراء الشرکة لرفع مستوى الثقافة والتعليم للأجیال الصاعدة من الشباب في بناء المجمعات التعليمية والرياضية . وفي هذا السیاق تم بناء أکثر من مائة مرکز تعليمي وثقافي في مدن کلبایکان وخوانسار وخمین وأریافها لکي لا یشعر الشباب والیافعین في هذه الأریاف النائیة بالعزلة والحرمان والتي یعد سجلاً مشرفاً لما تبذلها في هذا المضمار .")%></p>
            </div>
