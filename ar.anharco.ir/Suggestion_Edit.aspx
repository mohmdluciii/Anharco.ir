<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Suggestion_Edit.aspx.vb" Inherits="W_ISM.Suggestion_Edit" %>
                            ...
                            <td>
                                <table style="width :100%;font-size :9pt;font-family:yekan " dir="rtl" >
                                   <tr>
                                    ...
                                    <tr>
                                        <td>اعلان وضعیت : </td>
                                        <td><asp:TextBox  style="resize:none" ID="result_Suggestion" runat ="server" Width ="300px" TextMode ="MultiLine"  Height ="50px"  Font-Names ="tahoma" Font-Size ="8pt" ></asp:TextBox></td>
                                    </tr>
