<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Upload_Watermark.aspx.vb" Inherits="W_ISM.Upload_Watermark" %>
...
<body style ="margin :0">
    ...
    <div class="memberPanel_TopBox" id="test">
        <div class="memberPanel_WaterMark"></div>
       
        <div class="memberPanel_WaterMarkut" >
            <div class="memberPanel_ContanerLogin"><a href="InputToPanel_Manager.aspx?e=1" ><i class="fa fa-power-off memberPanel_WaterMarkut_Icon"></i></a></div>
            ...
            <%--<%If Session("numberBox") = 0 Then%>
                <div class="memberPanel_ContanerLogin" ><a href="Member_MessageBox.aspx" style="height:60px;width :60px;"><i class="fa fa-bell-o memberPanel_WaterMarkut_Icon"></i></a> </div>
            <%Else%>
                <div class="memberPanel_ContanerLogin" ><a href="Member_MessageBox.aspx"  style="height:60px;width :60px;"><i class="fa fa-bell-o memberPanel_WaterMarkut_Icon"></i></a><div class="boxMeessageAlert"><p><%=Session("numberBox")%></p></div> </div>
            <%End If%>--%>
        </div>
    </div>
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><a href="#">راه اندازی سامانه</a><i class="fa fa-chevron-left arrow"></i><a href="#"><asp:Label ID="lbl_Title" runat ="server"  Text ="مدیریت واترمارک" ></asp:Label></a><i class="fa fa-chevron-left arrow"></i><a>درج</a></div>
                ...
                <div class="InterBoxFormRight" >
                    ...
                    <div class="bodyForm">
                        <div class ="ContainerTextBoxObject" >
                            <div class="ContainerTextBoxCaption">انتخاب فایل  &nbsp;  <asp:Label id="lblname_WaterMark" runat ="server"  class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_name_WaterMark"></div>
    ...
    <script type="text/javascript" src="JS/jquery-scrolltofixed.js"></script>
      ...
      <%--loading click--%>
        ...
        <div style="position:fixed;top:0px;left:0px;width :100%;height:100%;display:none;text-align :center ;background :rgb(0,0,0);background:rgba(0,0,0,0.8);z-index:1000000000000000000;background-repeat :no-repeat ;background-position :center center;justify-content:center;" id="objectPre" onclick="this.style.display='none';">
            <div style="position:relative ; width :400px;height:400px;border:2px dashed #fff;float :none;margin-left :auto ;margin-right :auto ;margin-top :0px;top:24%;"></div>
        </div>
...
<script  type ="text/javascript" >
    document.getElementById("name_WaterMark").onchange = function() {
