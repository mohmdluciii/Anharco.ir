...
<head id="Head1" runat="server">
    <title>التواجد على الساحة الدولية </title>
     ...
     <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" TargetControlID="txt_Search" ServiceMethod="Buscar" ServicePath="AutoCompletar.asmx" MinimumPrefixLength="2" CompletionInterval="1000" EnableCaching="true" CompletionSetCount="12"   CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"></asp:AutoCompleteExtender>  
        ...
        <div class ="backMobileMenu" id="mobileMenu4"  style ="display:none;">
           ...
           <div class ="mainScreenLayer">    
            ...
            <div class ="MessageCEO_HeaderTextContainer"><h1 class="<%=SiteStudioStore.AlignClass("copy_InternationalArena_h1")%>"><%=SiteStudioStore.Copy("copy_InternationalArena_h1", "التواجد على الساحة الدولية")%></h1> </div>
            <div class ="MessageCEO_topTextContainer">
                <p>
                    أعطت شركة أنهار الأولوية للتواجد على الساحة الدولية وإنشاء مكاتب تمثيلية في دول المنطقة في خطتها التنموية.<br />
                    بما في ذلك حضور معارض النفط والغاز والبتروكيماويات التي أقيمت في دول إقليمية ودولية منها باكستان وتركمانستان عام 1401هـ ، بالإضافة الی فتح مکتب تمثیل الشرکة في دولة الإمارات العربیة المتحدة بإسم شرکة NOVOIL TRADING Co. والتي تم تسجیلها بصورة رسمیة هناك ،<br />
                    وبذلك تمكنت الشرکة من التواجد على الساحة الدولية والغرض منها هو كشف قدراتها الإنتاجية والصناعية أمام أصحاب الصنائع والمستثمرین في تلك الدول ، وبالفعل أدت حضورها علی الساحة الدولیة من إبرام عدة عقود وإتفاقیات مشترکة مع المستثمرین الدولیة للقیام بتنفیذ عدد من المشاریع الصناعیة والتنمویة في حقل النفط والغاز والبتروكيماويات خارج البلاد.
                </p>
            </div>
            ...
            <div class ="MessageCEO_Box1Container">
                <div class ="MessageCEO_inner">
                    <div class ="box">
                        <p class="<%=SiteStudioStore.AlignClass("copy_InternationalArena_p3")%>"><%=SiteStudioStore.Copy("copy_InternationalArena_p3", "و في هذا السیاق ومن خلال الإجراءات التي تم إتخاذها أخیراً ، تم تسجیل فرع شركة أنهار الإنشائية في جمهوریة العراق وحصولها علی المؤهلات والکفاءات التقنیة المطلوبة للتعاون مع وزارة النفط العراقیة وبإمکان الشركة أن تلعب دوراً هاماً في مجال تنفيذ مشاريع البنية التحتية في العراق من خلال فتح مكتبها في بغداد وتوظیف إمکانیاتها وخبراتها الصناعیة من أجل نمو وإزدهار هذا البلد الجار والشقیق .")%></p>
                    </div>
                    <div class ="box">
