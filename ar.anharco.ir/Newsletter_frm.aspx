<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Newsletter_frm.aspx.vb" Inherits="W_ISM.Newsletter_frm" %>
   ...
   <script type="text/javascript" src="JS/1.6.2/jquery.min.js"></script>
    ...
    <script>
        $(function() {
        	...
        	$('#sDate').calendarsPicker({ calendar: calendar });
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><a href="#">مدیریت سایت</a><i class="fa fa-chevron-left arrow"></i><a href="#">ارسال خبرنامه</a><i class="fa fa-chevron-left arrow"></i><a>درج</a></div>
                ...
                <div class="InterBoxFormRight" >
                    ...
                    <div class="bodyForm">
                        ...
                        <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption">عنوان &nbsp; *<asp:Label id="lbltitle_Newsletter" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle" >
                                <div class="effectContainerDiv"  id="container_title_Newsletter"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">عنوانی است که باید برای خبرنامه برگزینید</div></li></ul></a></li>
                                    <li> <asp:TextBox   tabindex="1"  onfocus="GraphicalBorder('container_title_Newsletter');" onblur="GraphicalBorderRemove('container_title_Newsletter');" ID="title_Newsletter" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        <div class ="ContainerTextBoxObject nobr"> </div> 
                        <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption">از تاریخ &nbsp; *<asp:Label id="lblsDate" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle" >
                                <div class="effectContainerDiv"  id="container_code_Newsletter"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">تاریخ شروع مطالب درج شده در سایت است که قرار است محتوی خبرنامه باشد</div></li></ul></a></li>
                                    <li> <asp:TextBox   tabindex="2"  onfocus="GraphicalBorder('container_code_Newsletter');" onblur="GraphicalBorderRemove('container_code_Newsletter');" ID="sDate" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        
                        <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption">تا تاریخ &nbsp; *<asp:Label id="lbleDate" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle" >
                                <div class="effectContainerDiv"  id="container_eDate"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">تاریخ پایان مطالب درج شده در سایت است که قرار است محتوی خبرنامه باشد</div></li></ul></a></li>
                                    <li> <asp:TextBox   tabindex="2"  onfocus="GraphicalBorder('container_eDate');" onblur="GraphicalBorderRemove('container_eDate');" ID="eDate" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
