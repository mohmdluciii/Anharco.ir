<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Suggestion_Person.aspx.vb" Inherits="W_ISM.Suggestion_Person" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><i class="fa fa-bar-chart icon"></i><a href="#"> پیشنهادات  </a><i class="fa fa-chevron-left arrow"></i><a href="#"> ارسال پیشنهاد یا انتقاد </a><i class="fa fa-chevron-left arrow"></i><a>درج</a></div>
                ...
                <div class="InterBoxFormRight" >
                    ...
                    <div class="bodyForm">
                        ...
                        <div class ="ContainerTextBoxObject">       
                            <div class="ContainerTextBoxCaption"> عنوان پیشنهاد&nbsp;* <asp:Label id="lbltitle_Suggestion" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle" >
                                <div class="effectContainerDiv"  id="container_title_Suggestion"></div>
                                <ul class="ContainerQuotation" >
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">عنوان پیشنهاد یا انتقادی است که قصد ارسال آنرا دارید</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="1"  onfocus="GraphicalBorder('container_title_Suggestion');" onblur="GraphicalBorderRemove('container_title_Suggestion');" ID="title_Suggestion" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class ="ContainerTextBoxObject" style="width:90%;">       
                            <div class="ContainerTextBoxCaption">متن پیشنهاد&nbsp;* <asp:Label id="lbltext_Suggestion" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle" style="height:190px;">
                                <div class="effectContainerDiv"  id="container_text_Suggestion"></div>
                                <ul class="ContainerQuotation" >
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">متن پیشنهاد یا انتقادی است که قصد دارید آنرا ارسال نمائید</div></li></ul></a></li>
                                    <li> <asp:TextBox TextMode ="MultiLine" style="width:96.5%;height:142px;"  tabindex="1"  onfocus="GraphicalBorder('container_text_Suggestion');" onblur="GraphicalBorderRemove('container_text_Suggestion');" ID="text_Suggestion" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        <div class ="ContainerTextBoxObject">       
