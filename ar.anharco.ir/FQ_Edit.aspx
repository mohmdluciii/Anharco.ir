<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FQ_Edit.aspx.vb" Inherits="W_ISM.FQ_Edit" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
       <div class="titleForm"><a href="#">مدیریت همکار</a><i class="fa fa-chevron-left arrow"></i><a href="#">سوالات</a><i class="fa fa-chevron-left arrow"></i><a>درج</a></div>
            ...
            <div class="containerForm">
                ...
                <div class="DeleteBoxContainer" id="DeleteBoxContainer" onclick="closeDeleteDialog();">
                    <div class ="DeleteBox" id="DeleteBox">
                       <iframe src="FQ_Delete.aspx?RowID_FQ=<%=request.QueryString("RowID_FQ") %>" frameborder="0"></iframe>
                    </div>
                </div>
                <div class="InterBoxFormLeft">
                    <ul>
                        <li>
                            <a class ="LinkIcon" href="FQ_List.aspx?f1=<%=request.QueryString("f1") %>"><i class="fa  fa-pencil"></i></a>
                            <ul>
                ...
                <div class="InterBoxFormRight" >
                    <div class="headForm" >
                        ...
                        <a href="#" title ="اطلاعات جدید" id="btnNew_top" runat ="server" onclick="ShowDelete();"><i class="fa fa-trash-o"></i></a>
                    </div>
            
                    <div class="bodyForm">
                    
                        <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption">گروه&nbsp; *<asp:Label id="lblGroupFQ" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_GroupFQ"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">گروه سوالاتی است که سوالات جدید در آن قرار دارد.</div></li></ul></a></li>
                                    <li><asp:DropDownList  id="cmb_GroupFQ" tabindex="1" runat ="server"  onfocus="GraphicalBorder('container_GroupFQ');" onblur="GraphicalBorderRemove('container_GroupFQ');"></asp:DropDownList></li>
                                </ul>
                            </div>
                        </div>
                        <div class ="ContainerTextBoxObject" style="width :100%;">
                            <div class="ContainerTextBoxCaption"><asp:CheckBox ID="chk_public_FQ" runat ="server" Text ="نمایش در سایت" /></div>
                        </div> 
