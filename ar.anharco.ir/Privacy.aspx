...
<head id="Head1" runat="server">
    <title>خصوصية - شركة أنهار الإنشائية </title>
     ...
     <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" TargetControlID="txt_Search" ServiceMethod="Buscar" ServicePath="AutoCompletar.asmx" MinimumPrefixLength="2" CompletionInterval="1000" EnableCaching="true" CompletionSetCount="12"   CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"></asp:AutoCompleteExtender>  
        ...
        <div class ="backMobileMenu" id="mobileMenu4"  style ="display:none;">
           ...
           <div class ="mainScreenLayer">    
            ...
            <div class ="MessageCEO_HeaderTextContainer"><h1 class="<%=SiteStudioStore.AlignClass("copy_Privacy_h1")%>"><%=SiteStudioStore.Copy("copy_Privacy_h1", "خصوصية")%></h1> </div>
            <div class ="MessageCEO_topTextContainer">
            
                <p style ="text-align :right;">
                     تلتزم شركة أنهار للإنشاءات بحماية خصوصية جميع الزوار، وقد قمنا بإعداد بيان الخصوصية هذا كجزء من التزامنا بخصوصيتك. كعميل لدينا، يمكنك زيارة الموقع الإلكتروني لشركة أنهار للإنشاءات دون إدخال أي معلومات شخصية على شبكة الإنترنت العالمية. تعتمد كمية المعلومات التي نجمعها على المعلومات التي تقدمها لنا
                </p>
                <p style ="text-align :right;">
من خلال التسجيل أو طلب المعلومات على هذا الموقع، فإنك توافق على جمع واستخدام ونقل المعلومات الخاصة بك وفقا لهذه السياسة.
                </p> 
            
                <p style="text-align :right;font-size :16pt;font-weight:700;">
                    <i class ="fa fa-arrow-left" style="font-size :16pt;"></i>
                    المعلومات التي نجمعها منك.
                </p>
                
                <p style ="text-align :right;">
                    عند زيارتك، سيُطلب منك إدخال معلومات مثل اسمك ومعلومات الاتصال بك. قد نقوم أيضًا بجمع معلومات حول استخدامك للموقع بالإضافة إلى المعلومات التي ترسلها إلينا عبر البريد أو البريد الإلكتروني.
                </p> 
                ...
                <p style ="text-align :right;">
                     يتم تخزين المعلومات التي تقدمها لنا على خوادمنا الآمنة. يجوز لنا أيضًا مشاركة المعلومات التي تم جمعها حول استخدامك لموقعنا مع أطراف ثالثة، ولكن هذه المعلومات لا تتضمن المعلومات التي يمكن استخدامها لتحديد هويتك.
                </p>
                <p style ="text-align :right;">
                    أينما يتم تزويدك (أو اختيارك) بكلمة مرور تمكنك من الوصول إلى أجزاء معينة من موقعنا، فأنت مسؤول عن الحفاظ على كلمة المرور هذه والحفاظ عليها. نطلب منك عدم مشاركة كلمة المرور هذه مع أي شخص.
                </p> 
                <p style ="text-align :right;">
                    لسوء الحظ، فإن نقل المعلومات عبر الإنترنت ليس آمنًا تمامًا. على الرغم من أننا نبذل قصارى جهدنا لحماية معلوماتك الشخصية، إلا أنه لا يمكننا ضمان أمان نقل معلوماتك. ولذلك فإن أي نقل سيكون على مسؤوليتك. بمجرد أن نتلقى معلوماتك، سنستخدم إجراءات أمنية صارمة لمنع الوصول غير المصرح به إليها.
                </p> 
                ...
                <p style ="text-align :right;">
                    أخيرًا، إذا دخلت أعمالنا في مشروع مشترك مع كيان آخر أو تم دمجه معه أو بيعه إليه، فسيتم الكشف عن معلوماتك للشركاء أو المالكين الجدد.
                </p> 
                
                <p style="text-align :right;font-size :16pt;font-weight:700;">
                    <i class ="fa fa-arrow-left" style="font-size :16pt;"></i>
                  عناوين IP وملفات تعريف الارتباط
                </p>
                <p style ="text-align :right;">
                    قد نقوم بجمع معلومات حول جهاز الكمبيوتر الخاص بك، بما في ذلك عنوان IP الخاص بك ونظام التشغيل ونوع المتصفح، واستخدامها لأغراض إدارية وتسويقية. فهو يحتوي على بيانات إحصائية حول أنماط وأداء البحث على الإنترنت ولا يمكنه التعرف عليك.
                </p> 
                
                <p style ="text-align :right;">
                    ملفات تعريف الارتباط هي حزم صغيرة من المعلومات التي نقوم بتخزينها على جهاز الكمبيوتر الخاص بك. عندما تزور موقعنا، يقوم نظامنا بتخزين ملفات تعريف الارتباط على جهاز الكمبيوتر الخاص بك. إلا إذا اعترضت عند تقديم معلوماتك إلينا. ستزداد سرعة ملفات تعريف الارتباط في المرة التالية التي تزور فيها الموقع. كما تسمح لنا ملفات تعريف الارتباط بالتحكم في حركة مرور الموقع ومراقبتها وتخصيص محتوى الموقع لك. يمكنك منع تخزين ملفات تعريف الارتباط عن طريق تمكين إعدادات معينة في متصفح جهاز الكمبيوتر الخاص بك، وفي هذه الحالة قد لا تتمكن من استخدام ميزات معينة في موقعنا.
                </p> 
                ...
                <p style ="text-align :right;">
                    نحن نستخدم إجراءات أمنية لحماية معلوماتك من الوصول غير المصرح به والأنشطة غير القانونية والأضرار العرضية والتدمير والخسارة. سنحتفظ بمعلوماتك طالما كان ذلك مطلوبًا بموجب القانون.
                </p> 
                <p style ="text-align :right;">
                    في بعض الحالات، قد يحتوي موقعنا على روابط إلكترونية لمواقع أخرى. إذا اخترت زيارة هذه المواقع، فسيتم تطبيق سياسة الخصوصية وتفضيلات الخصوصية الخاصة بها.
                </p> 
                <p style="text-align :right;font-size :16pt;font-weight:700;">
                    <i class ="fa fa-arrow-left" style="font-size :16pt;"></i>
                   الوصول والتحديث
                ...
                <p style ="text-align :right;">
                    لديك الحق في أن تكون على علم بالمعلومات التي نحتفظ بها عنك وأن تطلب منا إجراء تغييرات عليها حتى تكون دقيقة وحديثة. أخبرنا إذا كنت مهتمًا بهذا الموضوع.
                </p> 
                ...
                <p style ="text-align :right;">
                    سيتم نشر أي تغييرات في سياسة الخصوصية الخاصة بنا على الموقع في المستقبل وسيتم إعلامك بها عبر البريد الإلكتروني إذا لزم الأمر.
                </p> 
                
            </div>
            <div class ="MessageCEO_TopLogoType">
                <img src="<%=SiteStudioStore.Asset("logotype")%>" alt="شركة أنهار الإنشائية " />
            </div>
