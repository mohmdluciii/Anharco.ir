<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GroupServicePM_Edit1.aspx.vb" Inherits="W_ISM.GroupServicePM_Edit1" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><a href="#">تعمیر و نگهداری</a><i class="fa fa-chevron-left arrow"></i><a href="#">گروه سرویس</a><i class="fa fa-chevron-left arrow"></i><a>ویرایش</a></div>
            ...
            <div class="containerForm" style="width:98%">
                <div class="SaveBoxContainer" id="saveContainer">
                    <div class ="SaveBox" id="saveDialog"> 
                        <p><i class='fa fa-floppy-o'></i> &nbsp;<asp:Label ID="lblAlert" runat ="server" Text="تغییرات با موفقیت در سامانه ثبت گردید" ></asp:Label> </p>
                ...
                <div class="DeleteBoxContainer" id="DeleteBoxContainer" onclick="closeDeleteDialog();">
                    <div class ="DeleteBox" id="DeleteBox">
                       <iframe src="GroupServicePM_Delete1.aspx?rowID_GroupServicePM=<%=request.QueryString("rowID_GroupServicePM") %>" frameborder="0"></iframe>
                    </div>
                </div>
                <div class="InterBoxFormLeft">
                    <ul>
                        <li>
                            <a class ="LinkIcon" href="GroupServicePM_List1.aspx"><i class="fa  fa-pencil"></i></a>
                            <ul>
                    ...
                    <ul>
                        <li>
                           <a class ="LinkIcon" href="PDFShow.aspx?file=3.pdf" target ="_blank"  ><i class="fa  fa-question-circle "></i></a>
                            <ul>
                ...
                <div class="InterBoxFormRight" >
                    ...
                    <div class="bodyForm  bodyFormSmall">
                        <div class ="ContainerTextBoxObject">
                           
                            <div class="ContainerTextBoxCaption">نام گروه&nbsp; *<asp:Label id="lblname_GroupServicePM" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_name_GroupServicePM"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">نام گروه سرویس است که باید منحصربفرد باشد</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="1"  onfocus="GraphicalBorder('container_name_GroupServicePM');" onblur="GraphicalBorderRemove('container_name_GroupServicePM');" ID="name_GroupServicePM" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        
                          <div class ="ContainerTextBoxObject" style ="width :100%;height:5px;">
                        </div> 
                        
                        <div class ="ContainerTextBoxObject">
                           
                            <div class="ContainerTextBoxCaption">خدمات مرتبط با گروه سرویس&nbsp; <asp:Label id="lblProblem_GroupServicePM" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle ContainerTextBoxStyleTextEditor" style="height:208px;">
                                <div class="effectContainerDiv"  id="container_Problem_GroupServicePM"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">تعیین کنید گروه سرویس مربوط با رفع کدام مشکلات می باشد</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="2" TextMode ="MultiLine" style="height:200px;" class="ContainerTextBoxObjectTextEditor"  onfocus="GraphicalBorder('container_Problem_GroupServicePM');" onblur="GraphicalBorderRemove('container_Problem_GroupServicePM');" ID="Problem_GroupServicePM" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
