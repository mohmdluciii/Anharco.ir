<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ContactManagement.aspx.vb" Inherits="Safe_ContactManagement" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" lang="ar" dir="rtl">
<head id="Head1" runat="server">
    <title>إدارة الاتصال شركة أنهار الإنشائية </title>
     ...
     <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" TargetControlID="txt_Search" ServiceMethod="Buscar" ServicePath="AutoCompletar.asmx" MinimumPrefixLength="2" CompletionInterval="1000" EnableCaching="true" CompletionSetCount="12"   CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"></asp:AutoCompleteExtender>  
        ...
        <div class ="backMobileMenu" id="mobileMenu4"  style ="display:none;">
             <div class ="topMenuBox">
                ...
                <div class ="boxMenuMobile"><a href="ContactManagement.aspx"   >إدارة الاتصال </a></div>
           ...
           <div class ="mainScreenLayer">    
            ...
            <div class ="MessageCEO_SlideContainer" style="<%=SiteStudioStore.BgStyle("hero_ContactManagement")%>">
                            ...
                            <li><a onmouseover ="showBoxBackMenu();">خدمات</a>
                             ...
                             <li><a onmouseover ="showBoxBackMenu();">التواصل معنا</a>
                                <ul  id="obj-m-4">
                                    ...
                                    <li><a href="ContactManagement.aspx">إدارة الاتصال</a></li>
            ...
            <div class ="MessageCEO_HeaderTextContainer"><h1 class="<%=SiteStudioStore.AlignClass("copy_ContactManagement_h1")%>"><%=SiteStudioStore.Copy("copy_ContactManagement_h1", "إدارة الاتصال")%></h1> </div>
            <div  style="max-width :600px;text-align :center ;position:relative ;float:none;margin-left :auto ;margin-right :auto ;top:-250px;">
               <iframe  src="ContactForm.aspx" frameborder ="0" scrolling ="no" class="frameContact" ></iframe> 
            </div>
  ...
  <div class ="footerMainPage">
    <div class ="footerContainer">
        ...
        <div class ="boxFooterMenu">
            ...
            <ul><li><a href="ContactManagement.aspx">إدارة الاتصال</a></li></ul>
