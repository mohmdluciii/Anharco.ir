<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TopBanner_Edit.aspx.vb" Inherits="Safe_TopBanner_Edit" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><a href="#">صفحه اصلی</a><i class="fa fa-chevron-left arrow"></i><a href="#">مدیریت اسلاید بنر</a><i class="fa fa-chevron-left arrow"></i><a>ویرایش</a></div>
        ...
        <div class="formBox">
            ...
            <div class="containerForm">
                ...
                <div class="DeleteBoxContainer" id="DeleteBoxContainer" onclick="closeDeleteDialog();">
                    <div class ="DeleteBox" id="DeleteBox">
                       <iframe src="TopBanner_Delete.aspx?rowID_TopBanner=<%=request.QueryString("rowID_TopBanner") %>" frameborder="0"></iframe>
                    </div>
                </div>
                ...
                <div class="InterBoxFormLeft">
                    <ul>
                        <li>
                            <a class ="LinkIcon" href="TopBanner_List.aspx"><i class="fa  fa-pencil"></i></a>
                            <ul>
                ...
                <div class="InterBoxFormRight" >
                    ...
                    <div class="bodyForm">
                      ...
                      <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption">عنوان&nbsp; *<asp:Label id="lblName_TopBanner" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_Name_TopBanner"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">عنوان اسلاید بنر می باشد</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="2"  onfocus="GraphicalBorder('container_Name_TopBanner');" onblur="GraphicalBorderRemove('container_Name_TopBanner');" ID="Name_TopBanner" AutoComplete="off" runat ="server"  MaxLength="50"  ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        
                        <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption">متن&nbsp; *<asp:Label id="lbltext_TopBanner" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle" style="height:108px;">
                                <div class="effectContainerDiv"  id="container_text_TopBanner"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">متن اسلاید بنر می باشد</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="2" Height="100" TextMode ="MultiLine" style="resize:none;" onfocus="GraphicalBorder('container_text_TopBanner');" onblur="GraphicalBorderRemove('container_text_TopBanner');" ID="text_TopBanner" AutoComplete="off" runat ="server"   MaxLength="800" ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        
                        <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption">شعار&nbsp; *<asp:Label id="lblsmall_TopBanner" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="Div2"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">شعار اسلاید بنر می باشد</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="2"  onfocus="GraphicalBorder('container_small_TopBanner');" onblur="GraphicalBorderRemove('container_small_TopBanner');" ID="small_TopBanner" AutoComplete="off" runat ="server"  MaxLength="50"  ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                       
                         <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption">اولویت <asp:Label id="lblno_Banner" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_no_Banner"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">اولویت نمایش بنر را مشخص می کند عدد بالاتر زودتر نمایش داده می شود </div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="2"  onfocus="GraphicalBorder('container_link_TopBanner');" onblur="GraphicalBorderRemove('container_no_Banner');" ID="no_Banner" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                       
                        <div class ="ContainerTextBoxObject" >
                            <div class="ContainerTextBoxCaption">تصویر  &nbsp;  <asp:Label id="lblFile_TopBanner" runat ="server"  class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_File_TopBanner"></div>
                                <ul class="ContainerQuotation">
                                    ...
                                    <li><input id="uploadFile" tabindex="7"  placeholder="انتخاب فایل" disabled="disabled" class="fileUpload_Style" /><div class="upload-btn-wrapper"><a href="#"  class="btn" style="height :38px;position:relative ;top:2px;left:0px;margin :0;"><i class="fa  fa-upload"></i></a><asp:FileUpload  type="file" name="myfile" runat ="server"  id="File_TopBanner" /></div> </li>
                                </ul>
                            </div>
                        </div>
                        
                        <div class ="ContainerTextBoxObject" >
                            <div class="ContainerTextBoxCaption">تصویر موبایل  &nbsp;  <asp:Label id="lblmobile_TopBanner" runat ="server"  class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_mobile_TopBanner"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">تصویر است که باید از هارد کامپیوتر انتخاب شود</div></li></ul></a></li>
                                    <li><input id="uploadFile1" tabindex="7"  placeholder="انتخاب فایل" disabled="disabled" class="fileUpload_Style" /><div class="upload-btn-wrapper"><a href="#"  class="btn" style="height :38px;position:relative ;top:2px;left:0px;margin :0;"><i class="fa  fa-upload"></i></a><asp:FileUpload  type="file" name="myfile" runat ="server"  id="mobile_TopBanner" /></div> </li>
                                </ul>
                            </div>
                        </div>
            ...
            <div class="containerForm_Left">
                <asp:Image ID="img_File_TopBanner" runat="server" style="position:relative ;top:0px;left:0px;width :100%;"  />
                <asp:Image ID="img_mobile_TopBanner" runat="server" style="position:relative ;top:0px;left:0px;width :100%;"  />
            </div>
        </div>
...
<script  type ="text/javascript" >
    document.getElementById("File_TopBanner").onchange = function() {
    document.getElementById("uploadFile").value = this.value;
};
document.getElementById("mobile_TopBanner").onchange = function() {
