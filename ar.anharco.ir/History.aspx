<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="History.aspx.vb" Inherits="Safe_History1" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" lang="ar" dir="rtl">
<head id="Head1" runat="server">
    <title>تاریخچه شركة أنهار الإنشائية </title>
     ...
     <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" TargetControlID="txt_Search" ServiceMethod="Buscar" ServicePath="AutoCompletar.asmx" MinimumPrefixLength="2" CompletionInterval="1000" EnableCaching="true" CompletionSetCount="12"   CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"></asp:AutoCompleteExtender>  
        ...
        <div class ="backMobileMenu" id="mobileMenu4"  style ="display:none;">
           ...
           <div class ="mainScreenLayer">    
            ...
            <div class ="MessageCEO_SlideContainer" style="<%=SiteStudioStore.BgStyle("hero_History")%>">
            ...
            <div class ="MessageCEO_HeaderTextContainer"><h1 class="<%=SiteStudioStore.AlignClass("copy_History_h1")%>"><%=SiteStudioStore.Copy("copy_History_h1", "نبذة مختصرة حول شركة أنهار الإنشائية")%></h1> </div>
            <div class ="MessageCEO_topTextContainer">
                <p class="<%=SiteStudioStore.AlignClass("copy_History_p1")%>"><%=SiteStudioStore.Copy("copy_History_p1", "تم تأسیس شركة أنهار الإنشائية (ذ.م.م.) في مدینة کلبایکان في عام 1974 بعون الله سبحانه وتعالی وبفضل جهود أربعة أمناء من المحسنین والمعتمدین في هذه المدینة ، " & Environment.NewLine & "ومن منطلق واجباتهم الإنسانیة ومسؤولیتهم الإجتماعیة دأبوا منذ بدایة تأسیس الشرکة الی بناء مراكز تعليمية وثقافیة في الأوساط الشعبیة من أجل رفع مستوی الوعي الثقافي والتقدم العلمي بین الشباب والیافعین ، حیث ما برح أن تم تطویر هذه النشاطات لتشمل کافة المجالات الثقافیة والعمرانیة والإقتصادیة والتنمویة والبنی التحتیة في البلاد .")%></p>
            </div>
            ...
            <div class ="MessageCEO_Box1Container">
                <div class ="MessageCEO_inner">
                    <div class ="box">
                        <p class="<%=SiteStudioStore.AlignClass("copy_History_p2")%>"><%=SiteStudioStore.Copy("copy_History_p2", "بعد نصف قرن من الخبرة والجهد الدؤوب في تطوير وتقدم بلدنا الحبيب إيران، أصبحت هذه الشركة في الوقت الحاضر شرفاً وفخراً كبيراً لأسرة أنهار الكبيرة . ومن المؤمل وبدعم جهود أفراد هذه الأسرة الكبيرة أن تتحول هذه الشركة من شركة مساهمة خاصة إلى شركة مساهمة عامة عن طریق جلب المزید من المساهمین لعضویة الشرکة .")%></p>
                    </div>
                    <div class ="box">
                        <img src="<%=SiteStudioStore.Asset("pic_History1")%>" />
                    </div>
                </div>
            </div>
            ...
            <div class ="MessageCEO_Box5Container">
                <div class ="MessageCEO_inner">
                    ...
                    <div class ="box">  
                        <p>تتمثل رؤية هذه الشركة في زيادة قدراتها وتطویر خدمات لتصبح شركة موثوقة ورائدة في مجال تصدیر الخدمات الهندسية المتنوعة في حقل صناعة النفط والغاز والبتروكيماويات والمياه خلال السنوات الخمس القادمة . وفي هذا السیاق أنجزت الشرکة الخدمات التالیة :</p>
                        <p><i class ="fa fa-chevron-left" style="font-size:14pt;color:#fff;margin-left :10px;"></i>إدارة وتنفیذ مشاریع البناء</p>
                        <p><i class ="fa fa-chevron-left" style="font-size:14pt;color:#fff;margin-left :10px;"></i>المشارکة في تنفیذ وترکیب وتشغیل المشاریع علی شکل إبرام عقود المقاولة EPC</p>
                        <p><i class ="fa fa-chevron-left" style="font-size:14pt;color:#fff;margin-left :10px;"></i>إدارة وهندسة المشاریع وتوفیر ملزوماتها من الأجهزة والأدوات والمواد الخام</p>
                        <p><i class ="fa fa-chevron-left" style="font-size:14pt;color:#fff;margin-left :10px;"></i>تصدیر الخدمات الفنیة والهندسیة بإعتبارها ضمن أهدافها الإستراتیجیة </p>
                        <p>وقد أنجزت شركة أنهار بإعتبارها شركة تنفيذية وهندسية العدید من المشاریع في حقل النفط والغاز والبتروكيماويات والمياه والمنشآت والبناء والنقل والمواصلات ومحطات تعزيز ضغط الغاز وکذلك ورشات صیانة شبکة أنابیب نقل النفط والغاز في جميع أنحاء البلاد حیث تحظى هذه الشرکة بثقة عالیة من قبل العدید من الشركات العامة والخاصة العاملة في المجالات المذکورة أعلاه . </p>
            ...
            <div class ="MessageCEO_Box2Container">
                <div class ="MessageCEO_inner">
                    ...
                    <div class ="box">
                        <img src="<%=SiteStudioStore.Asset("pic_History2")%>" />
                    </div>
                    <div class ="box">  
                        <p>ومن المؤمل أن يكون الجيل الثالث من مدراء شرکة أنهار في المستقبل کمدراء الجيل الثاني، الذين تمکنوا بفضل أفكارهم وجهودهم الحثیثة من تبدیل هذه الشرکة من شركة إقليمية إلى شركة ذات قوة تنفيذية عالية في جميع أنحاء إيران ، أن یتمکنوا من تجاوز الحدود الجغرافية لنشاطات الشرکة لتشمل خارج الحدود الوطنية والمشارکة في الساحات الدولية .</p>
                    </div>
                </div>
            </div>
