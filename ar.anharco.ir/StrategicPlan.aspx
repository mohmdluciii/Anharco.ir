<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="StrategicPlan.aspx.vb" Inherits="W_ISM.StrategicPlan" %>
    ...
    <form id="form1" runat="server">
     ...
     <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" TargetControlID="txtSearch" ServiceMethod="Buscar" ServicePath="AutoCompletar.asmx" MinimumPrefixLength="2" CompletionInterval="1000" EnableCaching="true" CompletionSetCount="12"   CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"></asp:AutoCompleteExtender>  
       ...
       <div class ="topBannerBox">
            <hr />
            <div class ="TextTitle">سند راهبردی</div>
       </div>
       ...
       <div class ="MainPage_whiteAboutUs">
            <div class ="Container_whiteAboutUs">
                ...
                <div class ="titleBox"><i class ="fa  fa-angle-double-left"></i>سند راهبردی <%=Session("name_website")%></div>
       ...
       <div class ="Mainpage_Mashi">
            <div class ="Container_Mashi">
                ...
                <div class ="titleBox">
                    <div class ="amountText"><hr class ="Line" />خط مشی <%=Session("name_website")%></div>
                    <div class ="contentText" style="margin :0;">
