<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Suggestion_Paygiri.aspx.vb" Inherits="W_ISM.Suggestion_Paygiri" %>
            ...
            <div class="containerForm" style="width:100%;">
                ...
                <div class="SaveBoxContainer" id="saveContainer">
                    <div class ="SaveBox" id="saveDialog" style="top:5%">
                        ...
                        <input type="button" value="تایید" onclick="window.open('Suggestion_Paygiri.aspx','_top');" /> 
                    </div>
                  </div>
