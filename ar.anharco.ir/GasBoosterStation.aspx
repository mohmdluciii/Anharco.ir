     ...
     <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" TargetControlID="txt_Search" ServiceMethod="Buscar" ServicePath="AutoCompletar.asmx" MinimumPrefixLength="2" CompletionInterval="1000" EnableCaching="true" CompletionSetCount="12"   CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"></asp:AutoCompleteExtender>  
        ...
        <div class ="backMobileMenu" id="mobileMenu4"  style ="display:none;">
           ...
           <div class ="mainScreenLayer">    
            ...
            <div class ="MessageCEO_HeaderTextContainer"><h1 class="<%=SiteStudioStore.AlignClass("copy_GasBoosterStation_h1")%>"><%=SiteStudioStore.Copy("copy_GasBoosterStation_h1", "محطات تعزیز ضغط الغاز")%></h1> </div>
            <div class ="MessageCEO_topTextContainer">
                <p style="text-align :right;font-size :22pt;font-weight:700;">
                    <i class ="fa fa-arrow-left" style="font-size :16pt;"></i>
                    مشروع بناء وتشغیل محطة تعزیز وقیاس ضغط الغاز في حقل "هما " للغاز بطریقة EPCC
                </p>
                <p style ="text-align :right ;font-size:18pt;">2021</p>
                
                <p style="text-align :right;font-size :22pt;font-weight:700;">
                    <i class ="fa fa-arrow-left" style="font-size :16pt;"></i>
                    مشروع بناء وتشغیل محطة تعزیز وقیاس ضغط الغاز في "ارسنجان" بطریقة EPC
                </p>
                <p style ="text-align :right ;font-size:18pt;">2017</p>
                
                <p style="text-align :right;font-size :22pt;font-weight:700;">
                    <i class ="fa fa-arrow-left" style="font-size :16pt;"></i>
                    مشروع بناء وتشغیل میکانیکي محطة تعزیز وقیاس ضغط الغاز في "نائین" بطریقة EPC
                </p>
                <p style ="text-align :right ;font-size:18pt;">2014</p>
                ...
                <p style ="text-align :right ;font-size:18pt;">2014</p>
                 ...
                 <p style="text-align :right;font-size :22pt;font-weight:700;">
                    <i class ="fa fa-arrow-left" style="font-size :16pt;"></i>
                    مشروع بناء وتشغیل محطتي تعزیز وقیاس ضغط الغاز في "دهشیر" و "ندوشن" بطریقة EPC
                </p>
                <p style ="text-align :right ;font-size:18pt;">2010</p>
                
                <p style="text-align :right;font-size :22pt;font-weight:700;">
                    <i class ="fa fa-arrow-left" style="font-size :16pt;"></i>
                    مشروع بناء وتشغیل محطة تعزیز وقیاس ضغط الغاز في "قزوین" بطریقة PC 
                </p>
                <p style ="text-align :right ;font-size:18pt;">2005</p>
                
                
                <p style="text-align :right;font-size :22pt;font-weight:700;">
                    <i class ="fa fa-arrow-left" style="font-size :16pt;"></i>
                    مشروع بناء وتشغیل محطة تعزیز وقیاس ضغط الغاز في "بل کله اصفهان" بطریقة PC
                </p>
                <p style ="text-align :right ;font-size:18pt;">2001</p>
