<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="OpenHoghogh_frm.aspx.vb" Inherits="W_ISM.OpenHoghogh_frm" %>
...
<head id="Head1" runat="server">
    <title>فرم درج افتتاح فیش حقوقی</title>
...
<body style ="margin :0">
    ...
    <div class="memberPanel_TopBox" id="test">
        ...
        <div class="memberPanel_Logout" >
            <div class="memberPanel_ContanerLogin"><a style="width:50px;text-align :center ;display:inline-block;" title="خروج" href="InputToPanel_Person.aspx?e=1" ><i class="fa fa-power-off memberPanel_LogOut_Icon"></i></a><a  style="width:50px;text-align :center ;display:inline-block;" href="KartablePerson.aspx" title="کارتابل" ><i class="fa fa-list-alt memberPanel_LogOut_Icon"></i></a></div>
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><a href="#">عملیات پایه</a><i class="fa fa-chevron-left arrow"></i><a href="#">افتتاح فیش حقوقی</a><i class="fa fa-chevron-left arrow"></i><a>درج</a></div>
        ...
        <div class="formBox">
            ...
            <div class="containerForm">
                ...
                <div class="InterBoxFormLeft">
                    <ul>
                        <li>
                            <a class ="LinkIcon" href="OpenHoghogh_List.aspx"><i class="fa  fa-pencil"></i></a>
                            <ul>
                ...
                <div class="InterBoxFormRight" >
                    ...
                    <div class="bodyForm">
                        ...
                        <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption">نام ماه&nbsp; *<asp:Label id="lblmonth_OpenHoghogh" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_month_OpenHoghogh"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">ماهی است که قصد دارید فیش حقوقی آنرا ثبت کنید</div></li></ul></a></li>
                                    <li><asp:DropDownList  id="cmb_month_OpenHoghogh" tabindex="1" runat ="server"  onfocus="GraphicalBorder('container_month_OpenHoghogh');" onblur="GraphicalBorderRemove('container_month_OpenHoghogh');"></asp:DropDownList></li>                 
                                </ul>
                            </div>
                        </div>
                        
                        <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption">سال&nbsp; *<asp:Label id="lblyear_OpenHoghogh" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_year_OpenHoghogh"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">سالی است که قصد دارید فیش حقویق آنرا ثبت کنید</div></li></ul></a></li>
                                    <li><asp:DropDownList  id="cmb_year_OpenHoghogh" tabindex="1" runat ="server"  onfocus="GraphicalBorder('container_year_OpenHoghogh');" onblur="GraphicalBorderRemove('container_year_OpenHoghogh');"></asp:DropDownList></li>                 
                                </ul>
                            </div>
                        </div>
