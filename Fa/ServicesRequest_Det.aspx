<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ServicesRequest_Det.aspx.vb" Inherits="W_ISM.ServicesRequest_Det" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>درخواست مراکز رفاهی</title>
                            ...
                            <td>
                                <table style="width :100%;font-size :9pt;font-family:yekan " dir="rtl" >
                                  <tr>
                                    ...
                                    <tr>
                                        <td>اعلان وضعیت : </td>
                                        <td><asp:TextBox ID="textStatus_Services_Request" runat ="server" Width ="300px" TextMode ="MultiLine"  Height ="50px"  Font-Names ="tahoma" Font-Size ="8pt" ></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                        <td>فایل ضمیمه : </td>
                                        <td>
                                            <asp:FileUpload ID="file_Services_Request" runat ="server" Width ="300px"  Font-Names ="tahoma" Font-Size ="8pt"  />
                                            <br /><asp:Label ID="lblFileName" runat ="server"  ></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td></td>
