<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Pillars.aspx.vb" Inherits="W_ISM.Pillars" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" lang="fa" dir="rtl">
<head id="Head1" runat="server">
    <title>ارکان جهت ساز - شرکت انهار</title>
     ...
     <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" TargetControlID="txt_Search" ServiceMethod="Buscar" ServicePath="AutoCompletar.asmx" MinimumPrefixLength="2" CompletionInterval="1000" EnableCaching="true" CompletionSetCount="12"   CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"></asp:AutoCompleteExtender>  
        ...
        <div class ="backMobileMenu" id="mobileMenu4"  style ="display:none;">
           ...
           <div class ="mainScreenLayer">    
            ...
            <div class ="MessageCEO_SlideContainer" style="<%=SiteStudioStore.BgStyle("hero_Pillars")%>">
            ...
            <div class ="MessageCEO_HeaderTextContainer"><h1 class="<%=SiteStudioStore.AlignClass("copy_Pillars_h1")%>"><%=SiteStudioStore.Copy("copy_Pillars_h1", "ارکان جهت ساز")%></h1> </div>
            <div class ="MessageCEO_topTextContainer">
                <p class="<%=SiteStudioStore.AlignClass("copy_Pillars_h2")%>" style="text-align :right;font-size :16pt;font-weight:700;"><i class ="fa fa-arrow-left" style="font-size :16pt;"></i><%=SiteStudioStore.Copy("copy_Pillars_h2", "چشم انداز")%></p>
                <p class="<%=SiteStudioStore.AlignClass("copy_Pillars_p1")%>" style ="text-align :right;"><%=SiteStudioStore.Copy("copy_Pillars_p1", "یکی از معتبرترین پیمانکاران EPC در صنعت نفت، گاز، پتروشیمی وسایر دوایر کارفرمایی کشور")%></p>
                
                <p class="<%=SiteStudioStore.AlignClass("copy_Pillars_h3")%>" style="text-align :right;font-size :16pt;font-weight:700;"><i class ="fa fa-arrow-left" style="font-size :16pt;"></i><%=SiteStudioStore.Copy("copy_Pillars_h3", "ماموریت")%></p>
                
                <p class="<%=SiteStudioStore.AlignClass("copy_Pillars_p2")%>" style ="text-align :right;"><%=SiteStudioStore.Copy("copy_Pillars_p2", "آبادانی از طریق طراحی ، خرید، اجرا و مدیریت پروژه های نفت، گاز، پتروشیمی و ساختمان")%></p>
            </div>
