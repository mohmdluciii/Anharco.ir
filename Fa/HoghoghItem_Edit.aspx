<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="HoghoghItem_Edit.aspx.vb" Inherits="W_ISM.HoghoghItem_Edit" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
       <div class="titleForm"><a href="#">راه اندازی سامانه</a><i class="fa fa-chevron-left arrow"></i><a href="#">تنظیم فایل حقوق</a><i class="fa fa-chevron-left arrow"></i><a>ویرایش</a></div>
            ...
            <div class="containerForm">
                ...
                <div class="DeleteBoxContainer" id="DeleteBoxContainer" onclick="closeDeleteDialog();">
                    <div class ="DeleteBox" id="DeleteBox">
                       <iframe src="HoghoghItem_Delete.aspx?rowID_HoghoghItem=<%=request.QueryString("rowID_HoghoghItem") %>" frameborder="0"></iframe>
                    </div>
                </div>
                <div class="InterBoxFormLeft">
                    <ul>
                        <li>
                            <a class ="LinkIcon" href="HoghoghItem_List.aspx?f1=<%=request.QueryString("f1") %>"><i class="fa  fa-pencil"></i></a>
                            <ul>
                ...
                <div class="InterBoxFormRight" >
                    ...
                    <div class="bodyForm">
                      ...
                      <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption">نوع ایتم حقوق&nbsp; *<asp:Label id="lblrowID_HoghoghItemType" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_rowID_HoghoghItemType"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">نوع ایتم حقوق است که باید از لیست پایین افتادنی برگزیده شود</div></li></ul></a></li>
                                    <li><asp:DropDownList  id="cmb_rowID_HoghoghItemType" tabindex="1" runat ="server"  onfocus="GraphicalBorder('container_rowID_HoghoghItemType');" onblur="GraphicalBorderRemove('container_rowID_HoghoghItemType');"></asp:DropDownList></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption">عنوان ستون اکسل &nbsp; *<asp:Label id="lblexcel_HoghoghItem" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle" >
                                <div class="effectContainerDiv"  id="container_excel_HoghoghItem"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">عنوان ستون اکسل است که در فایل اسکل درج شده است این عنوان دقیقا منطبق با ردیف اول ستون اکسل باشد </div></li></ul></a></li>
                                    <li> <asp:TextBox   tabindex="1"  onfocus="GraphicalBorder('container_excel_HoghoghItem');" onblur="GraphicalBorderRemove('container_excel_HoghoghItem');" ID="excel_HoghoghItem" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        
                        <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption">متن ایتم &nbsp; *<asp:Label id="lblcaption_HoghoghItem" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle" >
                                <div class="effectContainerDiv"  id="container_caption_HoghoghItem"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">متن عامل یا ایتم حقوق است که در فیش حقوق نمایش داده می شود</div></li></ul></a></li>
                                    <li> <asp:TextBox   tabindex="1"  onfocus="GraphicalBorder('container_caption_HoghoghItem');" onblur="GraphicalBorderRemove('container_caption_HoghoghItem');" ID="caption_HoghoghItem" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
