<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Hoghogh_Show_Det.aspx.vb" Inherits="W_ISM.Hoghogh_Show_Det" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><i class="fa fa-money icon"></i><a href="#">فیش حقوقی</a><i class="fa fa-chevron-left arrow"></i><a href="#"> فیش های حقوقی</a><i class="fa fa-chevron-left arrow"></i><a>جزئیات</a></div>
        ...
        <div class="formBox">
            ...
            <div class="containerForm" style="width:100%;">
                ...
                <div class="InterBoxFormLeft">
                   ...
                   <ul>
                        <li>
                            <a class ="LinkIcon" href="Hoghogh_Show_Print.aspx" target ="_blank" ><i class="fa  fa-print "></i></a>
                            <ul>
                                <li><a  class="bubbleLink1" >چاپ</a></li>
                            </ul>
                        </li>
                    </ul>
                ...
                <div class="SaveBoxContainer" id="saveContainer">
                    ...
                    <div class="bodyForm">
                        ...
                        <iframe style ="position:relative ;top:0px;left:0px;width:100%;min-height:500px;" frameborder ="0" scrolling ="auto" src="Hoghogh_Show.aspx?y=<%=request.QueryString("y") %>&m=<%=request.QueryString("m") %>" ></iframe>
                    </div>
                </div>
            </div>    
