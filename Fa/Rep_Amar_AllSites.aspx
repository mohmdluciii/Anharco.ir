<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Rep_Amar_AllSites.aspx.vb" Inherits="W_ISM.Rep_Amar_AllSites" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><a href="#">اطلاع رسانی</a><i class="fa fa-chevron-left arrow"></i><a href="#">ارزیابی سایت ها</a><i class="fa fa-chevron-left arrow"></i><a>لیست</a></div>
            ...
            <div class="containerForm" style ="width:100%;">
                ...
                <div class="SaveBoxContainer" id="saveContainer">
                    <div class ="SaveBox" id="saveDialog" style="top:5%">
                        ...
                        <input type="button" value="تایید" onclick="window.open('Admin_List1.aspx','_top');" /> 
                    </div>
                  </div>
                    <div class="headForm_List" >
                       <a class="ExcelIcon" href="showExcel.aspx?page=admin_List1" target="_blank" title ="خروجی اکسل"><i class="fa fa-file-excel-o"></i></a>
                       
                    </div>
            
                    <div class="bodyForm">
                        <p style ="width:95%;font-size:9pt;font-family:yekan,arial;direction:rtl;text-align :right ;padding-right :10px;">سال : <asp:DropDownList ID="cmb_Year" runat ="server" style="font-size:9pt;font-family:yekan,arial;text-align :right ;padding :5px 5px 5px 5px;border:1px solid gray;" ></asp:DropDownList></p>
                        <p style ="width:95%;font-size:9pt;font-family:yekan,arial;direction:rtl;text-align :right ;padding-right :10px;">ماه : <asp:DropDownList ID="cmb_Month" runat ="server" style="font-size:9pt;font-family:yekan,arial;text-align :right ;padding :5px 5px 5px 5px;border:1px solid gray;" ></asp:DropDownList>&nbsp;<asp:Button ID="btn_Search" runat ="server" Font-Names ="yekan" style="font-family:byekan,arial;font-size :9pt;cursor:pointer ;border-width:0;background :gray;color:#fff;padding :5px 15px 5px 15px;" Text ="جستجو" /></p>
