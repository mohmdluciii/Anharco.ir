<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="AboutUs.aspx.vb" Inherits="Safe_AboutUs1" %>
    ...
    <form id="form1" runat="server">
     ...
     <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" TargetControlID="txtSearch" ServiceMethod="Buscar" ServicePath="AutoCompletar.asmx" MinimumPrefixLength="2" CompletionInterval="1000" EnableCaching="true" CompletionSetCount="12"   CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"></asp:AutoCompleteExtender>  
       ...
       <div class ="topBannerBox">
            <hr />
            <div class ="TextTitle">درباره ما</div>
       </div>
       ...
       <div class ="MainPage_AboutUs">
            ...
            <div class ="Container_AboutUs">   
                  ...
                  <div class ="whiteBox"><a name="خدمات_شرکت">&nbsp;</a></div>
                  <div class ="MainBoxContent">
                        <div class ="rightBox">
                            
                            <%=Session("fetch_Khadamat")%>
                        </div>  
                        <div class ="leftBox">
                            <img src="images/image_AboutUs1.jpg" />
                            <img src="images/image_AboutUs2.jpg" />
                            <img src="images/image_AboutUs3.jpg" />
                        </div>
                  </div>
            ...
            <div class ="MainPage_MessageManager">
                <div class ="Container_MessageManager">
                    <div class ="rightBox"></div>
                    <div class ="leftBox">
                        <div class ="whiteBox"><a name="پیام_مدیریت">&nbsp;</a></div>
          ...
          <%End If%>
       <%--<div class ="MainPage_whiteAboutUs">
            <div class ="Container_whiteAboutUs">
                <div class ="whiteSpace"><a name="بیانیه_ماموریت">&nbsp;</a><a name="چشم_انداز">&nbsp;</a><a name="ارزش_ها">&nbsp;</a></div>
                <div class ="titleBox"><i class ="fa  fa-angle-double-left"></i>درباره شرکت تامین نیروی انسانی و خدمات پشتیبانی بانک مسکن</div>
                <div class ="ContentBox">
                    <div class ="innerBox">
                        <div class ="titleBox">
                            <div class ="titleText">تاریخچه</div>
                        </div>
                        <div class ="Text">
                                <%=Session("fetch_History")%>
                        </div>
                    </div>
                </div>
                <div class ="ContentBox">
                    <div class ="innerBox">
                        <div class ="titleBox">
                            <div class ="titleText">بیانیه ماموریت</div>
                        </div>
                        <div class ="Text">
                            <%=Session("fetch_Baianieh")%>
                        </div>
                    </div>
                </div> 
                <div class ="ContentBox">
                    <div class ="innerBox">
                        <div class ="titleBox">
                            <div class ="titleText">چشم انداز</div>
                        </div>
                        <div class ="Text">
                        <%=Session("fetch_View") %>                            
                        </div>
                ...
                <div class ="ContentBox">
                    <div class ="innerBox">
                        <div class ="titleBox">
                            <div class ="titleText">ارزش ها</div>
                        </div>
                        <div class ="Text">
                            <%=Session("fetch_Arzesh") %>
       ...
       <div class ="Mainpage_Taghdiname">
            <div class ="Container_Taghdiname">
                <div class ="whiteBox"><a name="تقدیرنامه">&nbsp;</a></div>
                <div class ="TitleBox">تقدیرنامه ها</div>
                <section class="center slider sectionPart"  data-sizes="50vw">
                    <%=Session("fetch_Taghdirnameh") %>
                </section> 
            </div>
       </div>
       <%End If%>
      <%-- <div class ="Mainpage_Mashi">
            <div class ="Container_Mashi">
                <div class ="whiteBox"><a name="خط_مشی">&nbsp;</a></div>
                <div class ="titleBox">
                    <div class ="amountText"><hr class ="Line" />شرکت تامین نیروی انسانی و خدمات پشتیبانی بانک مسکن</div>
                    <div class ="contentText">
                    <%=Session("fetch_Policy")%>
