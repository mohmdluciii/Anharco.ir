<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ResetPassword.aspx.vb" Inherits="W_ISM.ResetPassword" %>
...
<body>
    ...
    <div>
    <asp:TextBox ID="SecretKey" runat ="server"  ></asp:TextBox>
    <asp:Button ID="btnSend" runat ="server" Text ="Action" />
    </div>
