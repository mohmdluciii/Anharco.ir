<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Person_Upload.aspx.vb" Inherits="W_ISM.Person_Upload" %>
                ...
                <div class="InterBoxFormRight" >
                    ...
                    <div class="bodyForm">
                         ...
                         <div class ="ContainerTextBoxObject" >
                            <div class="ContainerTextBoxCaption">انتخاب فایل پرسنل جدید  &nbsp;  <asp:Label id="lblFileUpload1" runat ="server"  class="errStyle" ></asp:Label></div>
