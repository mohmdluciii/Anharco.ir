<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="OrganizationPolicy.aspx.vb" Inherits="W_ISM.OrganizationPolicy" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="asp" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" lang="fa" dir="rtl">
<head id="Head1" runat="server">
    <title>خط مشی سازمان - شرکت انهار</title>
     ...
     <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" TargetControlID="txt_Search" ServiceMethod="Buscar" ServicePath="AutoCompletar.asmx" MinimumPrefixLength="2" CompletionInterval="1000" EnableCaching="true" CompletionSetCount="12"   CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"></asp:AutoCompleteExtender>  
        ...
        <div class ="backMobileMenu" id="mobileMenu4"  style ="display:none;">
           ...
           <div class ="mainScreenLayer">    
            ...
            <div class ="MessageCEO_SlideContainer" style="<%=SiteStudioStore.BgStyle("hero_OrganizationPolicy")%>">
            ...
            <div class ="MessageCEO_Box5Container">
                <div class ="MessageCEO_inner">
                    
                    <div class ="box" style ="text-align :center ;margin-bottom :50px;">
                        <img src="images/OrganizationPolicyAnhar1.jpg" style ="width:100%;max-width :400px;position:relative ;float:none;margin-left :auto ;margin-right :auto ;" />
                    </div>
                    <div class ="box">  
                        <p class="<%=SiteStudioStore.AlignClass("copy_OrganizationPolicy_p2")%>"><%=SiteStudioStore.Copy("copy_OrganizationPolicy_p2", "خط مشی کیفیت")%></p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_OrganizationPolicy_p3")%>"><%=SiteStudioStore.Copy("copy_OrganizationPolicy_p3", "شرکت انهار با نزدیک به نیم قرن فعالیت در زمینه های طراحی خرید اجرا و مدیریت پروژه های نفت گاز پتروشیمی و ساختمانی خود را ملزم به رعایت توافقات و قراردادهای فی مابین با کارفرمایان دانسته و کیفیت را حق مشتری و لازمه وجدان کاری میداند. به باور ما تحقق این نگرش در گرو جلب رضایت مشتری و رعایت استانداردهای فنی و مهندسی میباشد. بدین منظور سیستم مدیریت کیفیت را مطابق با اجرا نموده و ISO 3834-2:2005 ISO 29001:2020 ISO 9001:2015 خواسته های استانداردهای خود را ملزم به بهبود مستمر اثر بخشی آن دانسته و در این راستا برای تأمین الزامات فوق راهبردهای زیر را سر لوحه فعالیتهای خود میدانیم")%></p>
                        
                        <p class="<%=SiteStudioStore.AlignClass("copy_OrganizationPolicy_p4")%>"><i class ="fa fa-chevron-left" style="font-size:14pt;color:#fff;margin-left :10px;"></i><%=SiteStudioStore.Copy("copy_OrganizationPolicy_p4", "تعامل اثر بخش و بهبود روشهای شناسایی و درک صحیح نیازهای کارفرمایان و توسعه زمینه های کاری")%></p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_OrganizationPolicy_p5")%>"><i class ="fa fa-chevron-left" style="font-size:14pt;color:#fff;margin-left :10px;"></i><%=SiteStudioStore.Copy("copy_OrganizationPolicy_p5", "تلاش در جهت بهبود مستمر فرآیندهای انجام کار با بهره گیری از دانش فن آوری و تجربیات مناسب")%></p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_OrganizationPolicy_p6")%>"><i class ="fa fa-chevron-left" style="font-size:14pt;color:#fff;margin-left :10px;"></i><%=SiteStudioStore.Copy("copy_OrganizationPolicy_p6", "توسعه فرهنگ سازمانی و ارتقاء سطح شایستگی سرمایه های انسانی")%></p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_OrganizationPolicy_p7")%>"><i class ="fa fa-chevron-left" style="font-size:14pt;color:#fff;margin-left :10px;"></i><%=SiteStudioStore.Copy("copy_OrganizationPolicy_p7", "مدیریت بهینه زنجیره تامین و ایجاد فضای همکاری بر مبنای احترام و منافع متقابل")%></p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_OrganizationPolicy_p8")%>"><i class ="fa fa-chevron-left" style="font-size:14pt;color:#fff;margin-left :10px;"></i><%=SiteStudioStore.Copy("copy_OrganizationPolicy_p8", "قانون مداری و تعهد به مسئولیت اجتماعی در تمامی تصمیم گیریها فعالیتها و امور اجرایی")%></p>
                        
                        <p class="<%=SiteStudioStore.AlignClass("copy_OrganizationPolicy_p9")%>"><%=SiteStudioStore.Copy("copy_OrganizationPolicy_p9", "انتظار می رود تمامی همکاران و افرادی که به محیطهای کاری سازمان دسترسی دارند ضمن درک صحیح و بکارگیری آن در فعالیتهای اجرایی خود در جهت برآورده ساختن الزامات و اثربخشی سیستم مدیریت کیفیت تلاش نمایند.")%></p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_OrganizationPolicy_p10")%>"><%=SiteStudioStore.Copy("copy_OrganizationPolicy_p10", "حصول اطمینان از انطباق اجرا نگهداری و به روز رسانی سیستم مدیریت کیفیت و فرآیندهای آن ترویج فرهنگ مشتری مداری و نیز گزارش دهی منظم از عملکرد موثر سیستم مدیریت کیفیت و فرصتهای بهبود بر عهده سیستم ها و روشها بوده و بازنگری منظم اثر بخشی و سازگاری آن با جهت گیریهای راهبردی سازمان بر عهده اینجانب میباشد.")%></p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_OrganizationPolicy_p11")%>"><%=SiteStudioStore.Copy("copy_OrganizationPolicy_p11", "ستار عزیزیان مدیر عامل")%></p>
                    </div>
                </div>
            </div>
            
            <div class ="MessageCEO_Box5Container" style ="background :#fff;">
                <div class ="MessageCEO_inner">
                    <div class ="box" style ="text-align :center ;margin-bottom :50px;">
                        <img src="images/OrganizationPolicyAnhar2.jpg" style ="width:100%;max-width :400px;position:relative ;float:none;margin-left :auto ;margin-right :auto ;" />
                    </div>

                    <div class ="box" style="color:#000;">  
                        <p class="<%=SiteStudioStore.AlignClass("copy_OrganizationPolicy_p12")%>" style="color:#000;"><%=SiteStudioStore.Copy("copy_OrganizationPolicy_p12", "خط مشی ایمنی، بهداشت و محیط زیست")%></p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_OrganizationPolicy_p13")%>" style="color:#000;"><%=SiteStudioStore.Copy("copy_OrganizationPolicy_p13", "ISO 45001:2018, ISO 14001:2015, HSE-MS")%></p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_OrganizationPolicy_p14")%>" style="color:#000;"><%=SiteStudioStore.Copy("copy_OrganizationPolicy_p14", "شرکت انهار فعال در پروژه های حوزه صنایع نفت گاز پتروشیمی و ساختمانی خود را متعهد به حفاظت از سلامت و ایمنی کارکنان و محیط زیست میداند. در این راستا اهداف زیر را در چهارچوب استراتژی های خود تعریف کرده است.")%></p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_OrganizationPolicy_p15")%>" style="color:#000;"><i class ="fa fa-chevron-left" style="font-size:14pt;color:#000;margin-left :10px;"></i><%=SiteStudioStore.Copy("copy_OrganizationPolicy_p15", "ترویج و توسعه فرهنگ ایمنی بهداشت و محیط زیست و ایجاد فضای مناسب جهت مشارکت کارکنان در اجرای الزامات HSE")%></p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_OrganizationPolicy_p16")%>" style="color:#000;"><i class ="fa fa-chevron-left" style="font-size:14pt;color:#000;margin-left :10px;"></i><%=SiteStudioStore.Copy("copy_OrganizationPolicy_p16", "ارتقاء صلاحیت پرسنل در حوزه HSE از طریق انجام برنامه های ارزیابی صلاحیت و ارائه برنامه های انتقال دانش به کلیه پرسنل در سطوح ستادی و اجرای")%></p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_OrganizationPolicy_p17")%>" style="color:#000;"><i class ="fa fa-chevron-left" style="font-size:14pt;color:#000;margin-left :10px;"></i><%=SiteStudioStore.Copy("copy_OrganizationPolicy_p17", "ارزیابی و پایش مستمر خطرات ایمنی و بهداشت شغلی و جنبه های زیست محیطی در جهت کنترل کاهش و مدیریت ریسکهای HSE و مدیریت ریسکهای فرایندی مربوط به HSE")%></p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_OrganizationPolicy_p18")%>" style="color:#000;"><i class ="fa fa-chevron-left" style="font-size:14pt;color:#000;margin-left :10px;"></i><%=SiteStudioStore.Copy("copy_OrganizationPolicy_p18", "پایش مستمر شاخصهای ایمنی بهداشت و محیط زیست به منظور افزایش بهره وری در روند اجرایی آن و دستیابی به بهبود مستمر")%></p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_OrganizationPolicy_p19")%>" style="color:#000;"><i class ="fa fa-chevron-left" style="font-size:14pt;color:#000;margin-left :10px;"></i><%=SiteStudioStore.Copy("copy_OrganizationPolicy_p19", "بهبود مستمر از طریق تعیین اهداف و برنامه ها در جهت ارتقاء عملکرد HSE و حرکت در راستای توسعه پایدار")%></p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_OrganizationPolicy_p20")%>" style="color:#000;"><i class ="fa fa-chevron-left" style="font-size:14pt;color:#000;margin-left :10px;"></i><%=SiteStudioStore.Copy("copy_OrganizationPolicy_p20", "شناسایی الزامات قانونی و سایر الزامات مرتبط با HSE و نظارت و کنترل بر اجرای آن")%></p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_OrganizationPolicy_p21")%>" style="color:#000;"><i class ="fa fa-chevron-left" style="font-size:14pt;color:#000;margin-left :10px;"></i><%=SiteStudioStore.Copy("copy_OrganizationPolicy_p21", "حفظ و صیانت از محیط زیست ایمنی و سلامت کارکنان")%></p>
                        
                        
                        <p class="<%=SiteStudioStore.AlignClass("copy_OrganizationPolicy_p22")%>" style="color:#000;"><%=SiteStudioStore.Copy("copy_OrganizationPolicy_p22", "اینجانب ضمن تعهد به بهبود مستمر سیستم مدیریت یکپارچه و برآورده ساختن الزامات آن در دوره های بازنگری مدیریت تداوم کفایت و اثربخشی این خط مشی را مورد بررسی قرار خواهم داد.")%></p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_OrganizationPolicy_p23")%>" style="color:#000;"><%=SiteStudioStore.Copy("copy_OrganizationPolicy_p23", "انتظار میرود همکاران و افرادی که به محیط های کاری سازمان دسترسی دارند ضمن درک صحیح آن در جهت برآورده ساختن الزامات و اثربخشی سیستم مدیریت یکپارچه تلاش نمایند.")%></p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_OrganizationPolicy_p24")%>" style="color:#000;"><%=SiteStudioStore.Copy("copy_OrganizationPolicy_p24", "ستار عزیزیان مدیر عامل")%></p>
                    </div>
                </div>
            </div>
