<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="changePassword_PM1.aspx.vb" Inherits="W_ISM.changePassword_PM1" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><a href="#">مدیریت پنل</a><i class="fa fa-chevron-left arrow"></i><a href="#">تغییر کلمه عبوری</a><i class="fa fa-chevron-left arrow"></i><a>فرم</a></div>
        ...
        <div class="formBox">
            ...
            <div class="containerForm">
                ...
                <div class="InterBoxFormLeft">
                    ...
                    <ul>
                        <li>
                            <a class ="LinkIcon" href="admin_list1.aspx"><i class="fa  fa-trash"></i></a>
                            <ul>
                ...
                <div class="InterBoxFormRight" >
                    ...
                    <div class="bodyForm">
                        ...
                        <div class ="ContainerTextBoxObject">       
                            <div class="ContainerTextBoxCaption">کلمه عبوری فعلی &nbsp;* <asp:Label id="lblCurrentPassword" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_CurrentPassword"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">کلمه  یا رمز عبوری است که در حال حاضر توسط آن وارد پنل شده اید</div></li></ul></a></li>
                                    <li> <asp:TextBox TextMode ="Password"   tabindex="1"  onfocus="GraphicalBorder('container_CurrentPassword');" onblur="GraphicalBorderRemove('container_CurrentPassword');" ID="CurrentPassword" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        <div class ="ContainerTextBoxObject nobr"> </div> 
                        <div class ="ContainerTextBoxObject">       
                            <div class="ContainerTextBoxCaption">کلمه عبوری جدید  &nbsp;* <asp:Label id="lblnewPassword" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_newPassword"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">کلمه یا رمز عبوری جدیدی است که قصد دارید برای ورود به پنل برگزینید </div></li></ul></a></li>
                                    
                                    <li> <asp:TextBox  tabindex="1"  onfocus="GraphicalBorder('container_newPassword');" onblur="GraphicalBorderRemove('container_newPassword');" ID="newPassword" AutoComplete="off" runat ="server"    TextMode="Password"   ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                         <div class ="ContainerTextBoxObject nobr"> </div> 
                        <div class ="ContainerTextBoxObject">       
                            <div class="ContainerTextBoxCaption">تکرار کلمه عبوری جدید  &nbsp;* <asp:Label id="lblrenewPassword" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_renewPassword"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">تکرار کلمه عبوری جدیدی است که باید برگزینید </div></li></ul></a></li>
                                    
                                    <li> <asp:TextBox  tabindex="1"  onfocus="GraphicalBorder('container_renewPassword');" onblur="GraphicalBorderRemove('container_renewPassword');" ID="renewPassword" AutoComplete="off" runat ="server" TextMode="Password"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
