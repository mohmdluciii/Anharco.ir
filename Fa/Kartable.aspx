<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Kartable.aspx.vb" Inherits="W_ISM.Kartable" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm">پنل همکار<i class="fa fa-chevron-left arrow"></i><a href="#">کارتابل</a><i class="fa fa-chevron-left arrow"></i><a>لیست</a></div>
            ...
            <div class="containerForm" style="width:100%;">
                ...
                <div class="SaveBoxContainer" id="saveContainer">
                    <div class ="SaveBox" id="saveDialog" style="top:5%">
                        ...
                        <input type="button" value="تایید" onclick="window.open('Kartable.aspx','_top');" /> 
                    </div>
                  </div>
                    <div class="headForm_List" >
                       <a class="ExcelIcon" href="showExcel.aspx?page=Kartable" target="_blank" title ="خروجی اکسل"><i class="fa fa-file-excel-o"></i></a>
                    </div>
            
                    <div class="bodyForm">
                        <%--<p style ="position:relative ;top:0px;left:0px;width:100%;height:40px;line-height :40px;text-align :center ;font-family :yekan,arial;font-size:12pt;direction:rtl;">فیش حقوقی فروردین جدید</p>--%>
                        <%--<iframe src="Hoghogh_Show.aspx?rowID_OpenHoghogh=11" style="position:relative ;top:0px;left:0px;width:100%;height:350px;" scrolling ="yes" frameborder ="0" ></iframe>--%>
            ...
            <ul class="Myul">
             ...
             <ul class="Myul">
                <div style="position:relative ;top:0px;width :100%;">
                    <iframe src="OnlineUser.aspx" style="width :98%;height:600px;" frameborder="0"></iframe>
                </div>
             </ul>
    ...
    <script type="text/javascript" src="JS/jquery-scrolltofixed.js"></script>
      ...
      <%--loading click--%>
        ...
        <%If Session("check_Pool") <> "" Then%>
        
        <div   id="pollBox" class ="poll_kartable">
            <a  style="position:absolute ;top:5px;left:5px;color:#fff;z-index:10000000;" title ="بستن" onclick="event.returnValue='false';pollBox.style.display='none';"><i class ="fa fa-times" style="color:#fff;font-size:8pt;"></i></a>
            
            <p style="position:relative ;top:0px;float:left ;width :100%;margin :0;padding :0;font-size:11pt;text-align :center ;"><%=Session("check_Pool")%></p>
            <p style="position:relative ;top:0px;float:left ;width :100%;margin :0;padding :0;font-size:12pt;text-align :center ;margin-top :5px;"><input type="button" value ="شرکت در نظر سنجی" id="btnGoPoll" onclick="location.href='Poll_Person.aspx'"></p>
        </div>
        <%End If%>
