<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Report.aspx.vb" Inherits="W_ISM.Report" %>
...
<head runat="server">
    ...
    <link rel="stylesheet" href="Excel/jquery.jexcel.css" type="text/css" />
    <style type ="text/css" >
        #my
        {
        	position :relative ;
...
<body>
    ...
    <div class="container">
        <div class="printContainer"><a href="#" onclick="window.print();"><i class="fa fa-print"></i></a></div>
        <div id="title"><asp:Label id="lblTitle" runat ="server" ></asp:Label></div>
        <div id="my" dir ="rtl"  ></div>
    </div>
        ...
        prepareTable = function () {
            ...
            for (i = 0; i < size; i++) {
                ...
                if (! options.colHeaders[i]) {
                    options.colHeaders[i] = options.colHeader[i];
                }
