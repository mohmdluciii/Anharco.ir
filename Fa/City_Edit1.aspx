<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="City_Edit1.aspx.vb" Inherits="W_ISM.City_Edit1" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><a href="#">تنظیمات</a><i class="fa fa-chevron-left arrow"></i><a href="#">شهر</a><i class="fa fa-chevron-left arrow"></i><a>ویرایش</a></div>
            ...
            <div class="containerForm">
                ...
                <div class="DeleteBoxContainer" id="DeleteBoxContainer" onclick="closeDeleteDialog();">
                    <div class ="DeleteBox" id="DeleteBox">
                       <iframe src="City_Delete1.aspx?rowID_City=<%=request.QueryString("rowID_City") %>" frameborder="0"></iframe>
                    </div>
                </div>
                <div class="InterBoxFormLeft">
                    <ul>
                        <li>
                            <a class ="LinkIcon" href="City_List1.aspx?f1=<%=request.queryString("f1") %>&f2=<%=request.queryString("f2") %>"><i class="fa  fa-pencil"></i></a>
                            <ul>
                                <li><a  class="bubbleLink" href="#">لیست</a></li>
                            </ul>
                        </li>
                    </ul>
                ...
                <div class="InterBoxFormRight" >
                    ...
                    <div class="bodyForm">
                        ...
                        <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption">استان&nbsp; *<asp:Label id="lblrowID_Ostan" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_rowID_Ostan"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">استانی است که شهر در آن قرار دارد</div></li></ul></a></li>
                                    <li><asp:DropDownList  id="cmb_rowID_Ostan" tabindex="1" runat ="server"  onfocus="GraphicalBorder('container_rowID_Ostan');" onblur="GraphicalBorderRemove('container_rowID_Ostan');"></asp:DropDownList></li>                 
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class ="ContainerTextBoxObject" >
                            <div class="ContainerTextBoxCaption">نام شهر&nbsp;*  <asp:Label id="lblName_City" runat ="server"  class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_Name_City"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">نام شهر که قصد ایجاد آنرا دارید نام باید منحصر باشد.</div></li></ul></a></li>
                                    <li> <asp:TextBox tabindex="2"  onfocus="GraphicalBorder('container_Name_City');" onblur="GraphicalBorderRemove('container_Name_City');" ID="Name_City" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
