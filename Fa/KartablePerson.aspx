<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="KartablePerson.aspx.vb" Inherits="Safe_KartablePerson" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm">کارتابل<i class="fa fa-chevron-left arrow"></i><a href="#"><asp:Label ID="lblDateCurrent" runat ="server" style="font-family:byekan;" ></asp:Label></a></div>
            ...
            <div class="containerForm" style="width:100%;">
                ...
                <div class="SaveBoxContainer" id="saveContainer">
                    <div class ="SaveBox" id="saveDialog" style="top:5%">
                        ...
                        <input type="button" value="تایید" onclick="window.open('Gavahi_List.aspx','_top');" /> 
                    </div>
                  </div>
                    <div class="headForm_List" >
                       <a class="ExcelIcon" href="showExcel.aspx?page=Gavahi_List" target="_blank" title ="خروجی اکسل"><i class="fa fa-file-excel-o"></i></a>
                    </div>
            
                    <div class="bodyForm">
                        <div class="boxKartable_mainpage">
                            <%=Session("fetch_current_Kartable")%>
                        </div>
                        
                        <div style="position:relative ;top:0px;left:0px;min-width:600px;margin-top :30px;border-top:1px solid #C1C1C1;">
                            <iframe src="Dashboard/KartablekDaily.aspx" style ="position:relative ;top:0px;left:0px;width :100%;min-height:600px;" frameborder ="0" scrolling ="auto"  ></iframe>
                        </div>
                    </div>
                </div>
            </div>    
