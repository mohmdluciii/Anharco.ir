...
<head id="Head1" runat="server">
    <title>تاریخچه شرکت انهار</title>
           ...
           <div class ="mainScreenLayer">    
            ...
            <div class ="MessageCEO_Box1Container">
                <div class ="MessageCEO_inner">
                    <div class ="box">
                        <p class="<%=SiteStudioStore.AlignClass("copy_History_p2")%>"><%=SiteStudioStore.Copy("copy_History_p2", "در حال حاضر این شرکت پس از نیم قرن تلاش خستگی ناپذیر در راه آبادانی و پیشرفت کشور عزیزمان ایران، به افتخاری عظیم برای خانواده بزرگ شرکت انهار تبدیل گردیده است و امید است به پشتوانه تلاش این خانواده بزرگ از شرکتی به صورت سهامی خاص به شرکتی با سهامداران متعدد و به صورت سهامی عام تبدیل گردد.")%></p>
                    </div>
                    <div class ="box">
            ...
            <div class ="MessageCEO_Box5Container">
                <div class ="MessageCEO_inner">
                    ...
                    <div class ="box">  
                        <p class="<%=SiteStudioStore.AlignClass("copy_History_p3")%>"><%=SiteStudioStore.Copy("copy_History_p3", "چشم انداز این شرکت تبدیل شدن به یک شرکت پیشرو در پروژه های EPC در صنعت نفت، گاز و پتروشیمی را نمایان می سازد و در این راستا طیف گسترده ای از خدمات زیر را ارائه می دهد.")%></p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_History_p4")%>"><i class ="fa fa-chevron-left" style="font-size:14pt;color:#fff;margin-left :10px;"></i><%=SiteStudioStore.Copy("copy_History_p4", "مدیریت و اجرای پروژه های ساخت")%></p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_History_p5")%>"><i class ="fa fa-chevron-left" style="font-size:14pt;color:#fff;margin-left :10px;"></i><%=SiteStudioStore.Copy("copy_History_p5", "مشارکت در اجرا، نصب و راه اندازی پروژه های EPC")%></p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_History_p6")%>"><i class ="fa fa-chevron-left" style="font-size:14pt;color:#fff;margin-left :10px;"></i><%=SiteStudioStore.Copy("copy_History_p6", "مدیریت مهندسی و تأمین و تدارک پروژه ها")%></p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_History_p7")%>"><i class ="fa fa-chevron-left" style="font-size:14pt;color:#fff;margin-left :10px;"></i><%=SiteStudioStore.Copy("copy_History_p7", "صدور خدمات فنی و مهندسی به عنوان یک هدف استراتژیک")%></p>
                        <p class="<%=SiteStudioStore.AlignClass("copy_History_p8")%>"><%=SiteStudioStore.Copy("copy_History_p8", "شرکت انهار به عنوان یک شرکت اجرایی و مهندسی، در زمینه های نفت، گاز و پتروشیمی، آب، ساختمان و ابنیه و راه و باند، پروژه های بسیاری را در اقصی نقاط کشور در زمینه طراحی، اجرا، تأمین کالا و نصب و راه اندازی ایستگاه های تقویت فشار گاز، یاردهای تعمیراتی بین خطوط و خطوط لوله انتقال نفت و گاز به اتمام رسانده است و مورد وثوق و اعتماد بسیاری از کارفرمایان فعال در این حوزه ها می¬باشد.")%></p>
                    </div>
                </div>
            </div>
            ...
            <div class ="MessageCEO_Box2Container">
                <div class ="MessageCEO_inner">
                    ...
                    <div class ="box">  
                        <p class="<%=SiteStudioStore.AlignClass("copy_History_p9")%>"><%=SiteStudioStore.Copy("copy_History_p9", "امید است در ادامه راه، نسل سوم از مدیران شرکت انهار همانند مدیران نسل دوم که با ایده ها و انگیزه های بزرگ آن را از شرکتی منطقه ای به شرکتی با توان اجرایی بالا در سرتاسر ایران سوق دادند، با وسعت بخشیدن به حوزه جغرافیایی فعالیت های خود، فعالیت های این شرکت را به خارج از مرزهای ملی و به سوی حضور در عرصه های بین المللی رهنمون سازند.")%></p>
                    </div>
                </div>
            </div>
