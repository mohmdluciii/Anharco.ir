<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Poll_Report.aspx.vb" Inherits="W_ISM.Poll_Report" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm">آرشیو</a><i class="fa fa-chevron-left arrow"></i><a href="#">نتایج نظرسنجی</a><i class="fa fa-chevron-left arrow"></i><a>لیست</a></div>
            ...
            <div class="containerForm" style="width:100%;">
                ...
                <div class="SaveBoxContainer" id="saveContainer">
                    <div class ="SaveBox" id="saveDialog" style="top:5%">
                        ...
                        <input type="button" value="تایید" onclick="window.open('Poll_Report_List.aspx','_top');" /> 
                    </div>
                  </div>
                    <div class="headForm_List" >
                       <a class="ExcelIcon" href="showExcel.aspx?page=Poll_Report_List" target="_blank" title ="خروجی اکسل"><i class="fa fa-file-excel-o"></i></a>
                    </div>
            
                    <div class="bodyForm">
                        <p style="position :relative ;top:0px;left:0px;width :100%;float:right ;direction:rtl;font-size:10pt;font-family:yekan,arial;text-align :right;padding-right :20px;margin :0;margin-top :10px"><a style ="width :90px;display:inline-block ">عنوان نظرسنجی </a> &nbsp;<asp:DropDownList ID="cmb_NazarSanji" runat ="server" Width ="280" Font-Names ="tahoma" Font-Size ="9pt" AutoPostBack ="true"   class="Combo_InList"></asp:DropDownList> </p>
                        <asp:Label ID="lblList" runat ="server"  ></asp:Label>
                        <p style="position :relative ;top:0px;left:0px;width :100%;float:right ;direction:rtl;font-size:10pt;font-family:yekan,arial;text-align :right;padding-right :20px;margin :0;margin-top :10px"><asp:Label id="lblList1" runat ="server" ></asp:Label></p> 
                    </div>
                </div>
            </div>    
