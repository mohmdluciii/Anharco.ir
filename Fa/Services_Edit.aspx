<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Services_Edit.aspx.vb" Inherits="W_ISM.Services_Edit" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
       <div class="titleForm"><a href="#">اطلاع رسانی</a><i class="fa fa-chevron-left arrow"></i><a href="#">خدمات</a><i class="fa fa-chevron-left arrow"></i><a>درج</a></div>
            ...
            <div class="containerForm">
                ...
                <div class="DeleteBoxContainer" id="DeleteBoxContainer" onclick="closeDeleteDialog();">
                    <div class ="DeleteBox" id="DeleteBox">
                       <iframe src="Services_Delete.aspx?RowID_Services=<%=request.QueryString("RowID_Services") %>" frameborder="0"></iframe>
                    </div>
                </div>
                <div class="InterBoxFormLeft">
                    <ul>
                        <li>
                            <a class ="LinkIcon" href="Services_List.aspx?f1=<%=request.QueryString("f1") %>"><i class="fa  fa-pencil"></i></a>
                            <ul>
                ...
                <div class="InterBoxFormRight" >
                    ...
                    <div class="bodyForm">
                        ...
                        <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption">گروه خدمات&nbsp; *<asp:Label id="lblRowID_GroupServices" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_GroupServices"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">گروه خدماتی است که سرویس جدید در آن قرار دارد.</div></li></ul></a></li>
                                    <li><asp:DropDownList  id="cmb_GroupServices" tabindex="1" runat ="server"  onfocus="GraphicalBorder('container_GroupServices');" onblur="GraphicalBorderRemove('container_GroupServices');"></asp:DropDownList></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption">عنوان&nbsp; *<asp:Label id="lblName_Services" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_Name_Services"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">نام سرویس جدید است که باید منحصر باشد</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="2"  onfocus="GraphicalBorder('container_Name_Services');" onblur="GraphicalBorderRemove('container_Name_Services');" ID="Name_Services" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        
                     <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption">خلاصه&nbsp; *<asp:Label id="lblshort_Service" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle"   style="height:210px;">
                                <div class="effectContainerDiv"  id="container_short_Service"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">خلاصه ای از مشخصات سرویسی است که قصد تعریف آنرا دارید</div></li></ul></a></li>
                                    <li> <asp:TextBox TextMode ="MultiLine"  style="height:200px;"  tabindex="2"   onfocus="GraphicalBorder('container_short_Service');" onblur="GraphicalBorderRemove('container_short_Service');" ID="short_Service" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                       <div class ="ContainerTextBoxObject" style="width :100%;">
                            <div class="ContainerTextBoxCaption"><asp:Label id="lbltext" runat ="server"  class="errStyle" ></asp:Label></div>
                       ...
                       <div class ="ContainerTextBoxObject" >
                            <div class="ContainerTextBoxCaption">تصویر   &nbsp;  <asp:Label id="lblpic_Services" runat ="server"  class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_pic_Services"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">تصویر خدمت است که در صورت وجود باید از هارد کامپیوتر انتخاب شود</div></li></ul></a></li>
                                    <li><input id="uploadFile" tabindex="7"  placeholder="انتخاب فایل" disabled="disabled" class="fileUpload_Style" /><div class="upload-btn-wrapper"><a href="#"  class="btn" style="height :38px;position:relative ;top:2px;left:0px;margin :0;"><i class="fa  fa-upload"></i></a><asp:FileUpload  type="file" name="myfile" runat ="server"  id="pic_Services" /></div> </li>
                                </ul>
                            </div>
                        </div>
...
<script  type ="text/javascript" >
    document.getElementById("pic_Services").onchange = function() {
