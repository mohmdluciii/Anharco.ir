...
<head id="Head1" runat="server">
    <title>گالری تصاویر و فیلم</title>
...
<body style ="background :#fff;margin :0;padding :0;">
    ...
    <div onclick="clodeVideo();" id="saveDialog" style="position:fixed  ;top:0px;left:0px;width:100%;height:100%;display:none;background :rgb(0,0,0);background :rgba(0,0,0,0.5);text-align :center ;z-index:1000000000000000000000000000000000;" >
        ...
        <div class ="backMobileMenu" id="mobileMenu4"  style ="display:none;">
           ...
           <div class ="mainScreenLayer">    
            ...
            <div class ="MessageCEO_HeaderTextContainer"><h1 class="<%=SiteStudioStore.AlignClass("copy_Gallery_h1")%>"><%=SiteStudioStore.Copy("copy_Gallery_h1", "گالری تصاویر و فیلم")%></h1> </div>
