<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Law_Edit.aspx.vb" Inherits="W_ISM.Law_Edit1" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
       <div class="titleForm"><a href="#">اطلاع رسانی</a><i class="fa fa-chevron-left arrow"></i><a href="#">قواعد و مقررات</a><i class="fa fa-chevron-left arrow"></i><a>درج</a></div>
            ...
            <div class="containerForm">
                ...
                <div class="DeleteBoxContainer" id="DeleteBoxContainer" onclick="closeDeleteDialog();">
                    <div class ="DeleteBox" id="DeleteBox">
                       <iframe src="Law_Delete.aspx?RowID_Law=<%=request.QueryString("RowID_Law") %>" frameborder="0"></iframe>
                    </div>
                </div>
                <div class="InterBoxFormLeft">
                    <ul>
                        <li>
                            <a class ="LinkIcon" href="Law_List.aspx?f1=<%=request.QueryString("f1") %>"><i class="fa  fa-pencil"></i></a>
                            <ul>
                ...
                <div class="InterBoxFormRight" >
                    ...
                    <div class="bodyForm">
                       ...
                       <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption">گروه&nbsp; *<asp:Label id="lblGroupLaw" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_GroupLaw"></div>
                                <ul class="ContainerQuotation">
                                    ...
                                    <li><asp:DropDownList  id="cmb_GroupLaw" tabindex="1" runat ="server"  onfocus="GraphicalBorder('container_GroupLaw');" onblur="GraphicalBorderRemove('container_GroupLaw');"></asp:DropDownList></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption">عنوان قانون&nbsp; *<asp:Label id="lbltitle_Law" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_title_Law"></div>
                                <ul class="ContainerQuotation">
                                    ...
                                    <li> <asp:TextBox  tabindex="2"  onfocus="GraphicalBorder('container_title_Law');" onblur="GraphicalBorderRemove('container_title_Law');" ID="title_Law" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
                        
                     <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption">خلاصه&nbsp; *<asp:Label id="lblshort_Law" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                ...
                                <ul class="ContainerQuotation">
                                    ...
                                    <li> <asp:TextBox  tabindex="2"  onfocus="GraphicalBorder('container_short_Law');" onblur="GraphicalBorderRemove('container_short_Law');" ID="short_Law" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
