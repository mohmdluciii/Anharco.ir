<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Ostan_frm1.aspx.vb" Inherits="W_ISM.Ostan_frm1" %>
...
<body style ="margin :0">
    ...
    <p class="buttonBar_menu"><a href="#" id="barMobileMenu" style="position:relative;top:0px;right:0px;float:right;width:35px;height:35px;display:block ;background:#6498FE;"><i class ="fa fa-bars" style="font-size :20pt;color:#fff;margin-left:25%;margin-right :25%;margin-top:10%;margin-bottom :10%;"></i></a></p><div class="memberPanel_rightBox">
        <div class="titleForm"><a href="#">مدیریت سایت</a><i class="fa fa-chevron-left arrow"></i><a href="#">استان</a><i class="fa fa-chevron-left arrow"></i><a>درج</a></div>
        ...
        <div class="formBox">
            ...
            <div class="containerForm">
                ...
                <div class="InterBoxFormLeft">
                    <ul>
                        <li>
                            <a class ="LinkIcon" href="Ostan_List1.aspx"><i class="fa  fa-pencil"></i></a>
                            <ul>
                    ...
                    <ul>
                        <li>
                            <a class ="LinkIcon" href="Ostan_List1.aspx"><i class="fa  fa-trash"></i></a>
                            <ul>
                ...
                <div class="InterBoxFormRight" >
                    ...
                    <div class="bodyForm">
                        ...
                        <div class ="ContainerTextBoxObject" style="display:none;">
                            <div class="ContainerTextBoxCaption" style="display:none;">کشور&nbsp; *<asp:Label Visible ="false"  id="lblrowID_Country" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle"  style="display:none;">
                                <div class="effectContainerDiv"  id="container_rowID_Country"  style="display:none;"></div>
                                <ul class="ContainerQuotation"  style="display:none;">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble"  style="display:none;">نوع دانشگاهی است که قصد تعریف آنرا دارید</div></li></ul></a></li>
                                    <li><asp:DropDownList  id="cmb_rowID_Country" tabindex="1" runat ="server" Visible="false"  onfocus="GraphicalBorder('container_rowID_Country');" onblur="GraphicalBorderRemove('container_rowID_Country');"></asp:DropDownList></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class ="ContainerTextBoxObject">
                            <div class="ContainerTextBoxCaption">نام استان&nbsp; *<asp:Label id="lblName_Ostan" runat ="server" class="errStyle" ></asp:Label></div>
                            <div class="ContainerTextBoxStyle">
                                <div class="effectContainerDiv"  id="container_Name_Ostan"></div>
                                <ul class="ContainerQuotation">
                                    <li><a href ="#"><i class="fa fa-file-text-o"></i><ul  class="quotation"><li><div class="talkbubble">نام دانشگاهی است که قصد تعریف آنرا دارید</div></li></ul></a></li>
                                    <li> <asp:TextBox  tabindex="1"  onfocus="GraphicalBorder('container_Name_Ostan');" onblur="GraphicalBorderRemove('container_Name_Ostan');" ID="Name_Ostan" AutoComplete="off" runat ="server"    ></asp:TextBox></li>
                                </ul>
                            </div>
                        </div>
