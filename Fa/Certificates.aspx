...
<head id="Head1" runat="server">
    <title>گواهینامه ها و استانداردها شرکت انهار</title>
     ...
     <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" TargetControlID="txt_Search" ServiceMethod="Buscar" ServicePath="AutoCompletar.asmx" MinimumPrefixLength="2" CompletionInterval="1000" EnableCaching="true" CompletionSetCount="12"   CompletionListCssClass="autocomplete_completionListElement" CompletionListItemCssClass="autocomplete_listItem" CompletionListHighlightedItemCssClass="autocomplete_highlightedListItem"></asp:AutoCompleteExtender>  
        ...
        <div class ="backMobileMenu" id="mobileMenu4"  style ="display:none;">
           ...
           <div class ="mainScreenLayer">    
            ...
            <div class ="MessageCEO_HeaderTextContainer"><h1 class="<%=SiteStudioStore.AlignClass("copy_Certificates_h1")%>"><%=SiteStudioStore.Copy("copy_Certificates_h1", "گواهینامه ها و استانداردها")%></h1> </div>
            <div class ="MessageCEO_topTextContainer">
                <p class="<%=SiteStudioStore.AlignClass("copy_Certificates_p1")%>"><%=SiteStudioStore.Copy("copy_Certificates_p1", "شرکت انهار در طی سالیان فعالیت خود موفق به کسب گواهینامه صلاحیت پیمانکاری در رشته های نفت و گاز، ساختمان و ابنیه، تأسیسات و تجهیزات، آب ، راه و ترابری و صنعت از سازمان برنامه و بودجه کشور و گواهینامه صلاحیت ایمنی پیمانکاران از وزارت تعاون، کار و رفاه اجتماعی گردیده است. همچنین این شرکت در حال اخذ رتبه طرح و ساخت جهت پیشبرد اهداف خود می باشد. این شرکت دارای گواهینامه های سیستم مدیریت یکپارچه (IMS) از شرکت بین المللی SGS می باشد.همچنین به منظور بهبود کیفیت عملیات اجرایی در پروژه های خطوط لوله اقدام به اخذ گواهینامه مدیریت جوش ISO3834-2:2021 نموده است.")%></p>
            </div>
