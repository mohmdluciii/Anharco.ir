<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Services_Request_Det.aspx.vb" Inherits="W_ISM.Services_Request_Det" %>
                        ...
                        <tr>
                            <td>
                                <table style="width :100%;font-size :9pt;font-family:yekan " dir="rtl" >
                                    ...
                                    <tr>
                                        <td>اعلان وضعیت : </td>
                                        <td><asp:TextBox  style="resize:none" ID="textStatus_Services_Request" runat ="server" Width ="300px" TextMode ="MultiLine"  Height ="50px"  Font-Names ="tahoma" Font-Size ="8pt" ></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                        <td>فایل ضمیمه : </td>
                                        <td><asp:FileUpload ID="file_Services_Request" runat ="server" Width ="300px"  Font-Names ="tahoma" Font-Size ="8pt"  /></td>
                                    </tr>
                                    <tr>
                                        <td></td>
